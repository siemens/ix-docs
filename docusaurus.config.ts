...
function getAnnouncementBarConfig() {
  ...
  if (versionDeployment.currentVersion !== versionDeployment.latestVersion) {
    return {
      announcementBar: {
        content: `<span style="font-size: 1rem">You are viewing the documentation for version ${latestVersion?.label}. To access the documentation for the latest release please visit <a style="font-weight: bold;" href="https://ix.siemens.io">https://ix.siemens.io</a>.</span>`,
        isCloseable: false,
...
try {
  const path =
    require.resolve('@siemens-ix/corporate-theme/dist/css/corporate-theme-hybrid.css');
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/siemens/ix-docs/tree/main',
    ...
    [
      'docusaurus-plugin-llms',
      {
        ignoreFiles: [
          ...
          '**/guidelines/accessibility/index.mdx',
        ],
