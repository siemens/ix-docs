import{g as c,m as u,b as d}from"./generic-render-QLLvfCCW.js";import"./sample-4XlXCCij.js";const m={title:"Example/Input",tags:[],render:a=>d("ix-input",a),argTypes:u("ix-input",{validation:{options:["default","info","warning","invalid","valid"],control:{type:"select"}}}),parameters:{design:{type:"figma",url:"https://www.figma.com/design/r2nqdNNXXZtPmWuVjIlM1Q/iX-Components---Brand-Dark?node-id=225-5535&m=dev"}}},e={args:{label:"Required",value:"",required:!0}},n={args:{label:"Required",value:"Test",required:!0},render:a=>{const s=c("ix-input",a),o=s.querySelector("ix-input"),i=document.createElement("ix-icon-button");return i.icon="search",i.slot="start",o.appendChild(i),s}},r={args:{label:"MinLength",minLength:3,maxLength:5,value:"1234567"}},t={args:{}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Required',
    value: '',
    required: true
