import{g as c,m as p}from"./generic-render-Dxw1XMhM.js";import{Q as d}from"./iframe-CsjqMXiN.js";import"./sample-4XlXCCij.js";import"./preload-helper-PPVm8Dsz.js";const g={title:"Example/Pill",tags:[],render:e=>c("ix-pill",e),argTypes:p("ix-pill",{}),parameters:{}},n={args:{icon:"info",defaultSlot:"Example Text"}},i={args:{icon:"info"}},t={args:{defaultSlot:"Example Text"}},o={args:{icon:"info",defaultSlot:"Example Text"},render:e=>{const r=c("ix-pill",e),l=r.querySelector("ix-pill");return l.style.width="5rem",r}},a={args:{defaultSlot:"Example Text"},render:e=>{const r=c("ix-pill",e),l=r.querySelector("ix-pill");return l.style.width="5rem",r}},s={render:({icon:e})=>d`<ix-pill icon=${e}
