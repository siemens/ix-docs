import{x as n}from"./iframe-LoKmnSQH.js";import{g as u,m as v}from"./generic-render-C55c-khh.js";import"./preload-helper-PPVm8Dsz.js";import"./sample-4XlXCCij.js";const t="print",b=["primary","alarm","critical","warning","info","neutral","success","custom"];function _(e){return e==="custom"?"Custom":e.charAt(0).toUpperCase()+e.slice(1)}function f(e,i){const a="Default";return i?n`
  ...
  `}const S={title:"Example/Chip",tags:[],render:e=>u("ix-chip",e),argTypes:v("ix-chip",{previewWidth:{control:{type:"text"}}}),parameters:{}},l={args:{icon:"info",defaultSlot:"Example Text"}},s={args:{icon:"info"}},p={args:{defaultSlot:"Example Text"}},h={args:{icon:"info",defaultSlot:"Example Text"},render:e=>{const i=u("ix-chip",e),a=i.querySelector("ix-chip");return a.style.width="5rem",i}},m={args:{defaultSlot:"Example Text"},render:e=>{const i=u("ix-chip",e),a=i.querySelector("ix-chip");return a.style.width="5rem",i}},x={render:({icon:e})=>n`<ix-chip icon=${e}
      ><div style="display: flex;">
        <ix-icon name="${e}" size="16"></ix-icon></div
    ></ix-chip>`,args:{icon:"info"}},o={name:"Overview · design reference (all variants)",parameters:{layout:"fullscreen",docs:{description:{story:"Default chip (no `variant`), all predefined variants (filled + outline), closable and icon combinations, tooltips, inactive, centered layout, accessible icon name, custom close label, and long label. Replaces the temporary chip-examples preview routes."}}},args:{icon:t,defaultSlot:" "},render:()=>$()};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    icon: 'info',
...
}`,...o.parameters?.docs?.source},description:{story:"Full variant matrix for UX / QA",...o.parameters?.docs?.description}}};const C=["With_Icon_and_Text","With_Icon_only","With_Text_only","With_Icon_and_Text_Ellipsis","With_Text_only_Ellipsis","With_Icon_and_Element","Overview_design_reference"];export{o as Overview_design_reference,x as With_Icon_and_Element,l as With_Icon_and_Text,h as With_Icon_and_Text_Ellipsis,s as With_Icon_only,p as With_Text_only,m as With_Text_only_Ellipsis,C as __namedExportsOrder,S as default};
