import{m as i,g as c}from"./generic-render-CVM81Yk_.js";import"./sample-DahX5hiH.js";const d={title:"Example/EventList",tags:[],render:n=>{const o=c("ix-event-list",n),m=o.querySelector("ix-event-list"),a=document.createElement("ix-event-list-item");return a.itemColor="--theme-color-alarm",a.textContent="Event List Item 1",m.appendChild(a),o},argTypes:i("ix-event-list",{}),parameters:{}},e={args:{}},t={args:{itemHeight:"S"}},r={args:{itemHeight:"L"}},s={args:{itemHeight:400}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {}
