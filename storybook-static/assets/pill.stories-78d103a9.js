import{g as c,m as w}from"./generic-render-60971499.js";import{x as $}from"./lit-element-f36cbe21.js";import"./sample-cfb362e2.js";const A={title:"Example/Pill",tags:[],render:e=>c("ix-pill",e),argTypes:w("ix-pill",{}),parameters:{}},n={args:{icon:"info",defaultSlot:"Example Text"}},i={args:{icon:"info"}},t={args:{defaultSlot:"Example Text"}},o={args:{icon:"info",defaultSlot:"Example Text"},render:e=>{const r=c("ix-pill",e),l=r.querySelector("ix-pill");return l.style.width="5rem",r}},a={args:{defaultSlot:"Example Text"},render:e=>{const r=c("ix-pill",e),l=r.querySelector("ix-pill");return l.style.width="5rem",r}},s={render:({icon:e})=>$`<ix-pill icon=${e}
