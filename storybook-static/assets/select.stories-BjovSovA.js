import{m as b,g as c}from"./generic-render-CVM81Yk_.js";import{x as u}from"./iframe-BjJrMWKj.js";import"./sample-DahX5hiH.js";import"./preload-helper-PPVm8Dsz.js";const h={title:"Example/Select",tags:[],render:e=>c("ix-select",e),argTypes:b("ix-select"),parameters:{design:{type:"figma",url:"https://www.figma.com/design/r2nqdNNXXZtPmWuVjIlM1Q/iX-Components---Brand-Dark?node-id=42365-175539&m=dev"}}},n={args:{}},i={render:({value:e,editable:l,allowClear:t,disabled:a,mode:d})=>u` <ix-select
      value=${e}
      mode=${d}
      ?editable=${l}
      ?allow-clear=${t}
