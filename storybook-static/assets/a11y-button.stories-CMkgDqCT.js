import{m as c,g as l}from"./generic-render-CVM81Yk_.js";import{x as s}from"./iframe-BjJrMWKj.js";import"./sample-DahX5hiH.js";import"./preload-helper-PPVm8Dsz.js";const b={title:"Example/Button/Accessibility",tags:[],render:d=>l("ix-button",d),argTypes:c("ix-button",{}),parameters:{design:{type:"figma",url:"https://www.figma.com/design/r2nqdNNXXZtPmWuVjIlM1Q/iX-Components---Brand-Dark?node-id=225-5535&m=dev"},a11y:{test:"error"}}},e={args:{defaultSlot:"Add Device",icon:"add-circle",variant:"primary"}},r={render:()=>s`<ix-button
      icon="trash"
