import{g as f,m as I}from"./generic-render-60971499.js";import{x as $}from"./lit-element-f36cbe21.js";import"./sample-cfb362e2.js";const y={title:"Example/Select",tags:[],render:e=>f("ix-select",e),argTypes:I("ix-select"),parameters:{design:{type:"figma",url:"https://www.figma.com/design/r2nqdNNXXZtPmWuVjIlM1Q/iX-Components---Brand-Dark?node-id=42365-175539&m=dev"}}},t={args:{}},l={render:({value:e,editable:r,allowClear:s,disabled:n})=>$` <ix-select
      value=${e}
      ?editable=${r}
      ?allow-clear=${s}
      disabled=${n}
