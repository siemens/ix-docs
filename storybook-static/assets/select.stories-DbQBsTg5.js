import{m as b,g as c}from"./generic-render-q9JIJh1N.js";import{x as u}from"./iframe-CFK36Vl_.js";import"./sample-CrjnuCO3.js";const w={title:"Example/Select",tags:[],render:e=>c("ix-select",e),argTypes:b("ix-select"),parameters:{design:{type:"figma",url:"https://www.figma.com/design/r2nqdNNXXZtPmWuVjIlM1Q/iX-Components---Brand-Dark?node-id=42365-175539&m=dev"}}},n={args:{}},i={render:({value:e,editable:l,allowClear:t,disabled:a,mode:d})=>u` <ix-select
      value=${e}
      mode=${d}
      ?editable=${l}
      ?allow-clear=${t}
...
}`,...o.parameters?.docs?.source}}};const h=["Default","editableSelect","editable_with_dropdown_width","Required","multiSelect"];export{n as Default,s as Required,h as __namedExportsOrder,w as default,i as editableSelect,r as editable_with_dropdown_width,o as multiSelect};
