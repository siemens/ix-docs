import{g as c,m as w}from"./generic-render-DetJ-R3y.js";import{x as $}from"./lit-element-CjWaU8-K.js";import"./sample-BmNXNfc9.js";const A={title:"Example/Pill",tags:[],render:e=>c("ix-pill",e),argTypes:w("ix-pill",{}),parameters:{}},n={args:{icon:"info",defaultSlot:"Example Text"}},i={args:{icon:"info"}},t={args:{defaultSlot:"Example Text"}},o={args:{icon:"info",defaultSlot:"Example Text"},render:e=>{const r=c("ix-pill",e),l=r.querySelector("ix-pill");return l.style.width="5rem",r}},a={args:{defaultSlot:"Example Text"},render:e=>{const r=c("ix-pill",e),l=r.querySelector("ix-pill");return l.style.width="5rem",r}},s={render:({icon:e})=>$`<ix-pill icon=${e}
