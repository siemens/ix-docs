import{m as c,g as l}from"./generic-render-Dxw1XMhM.js";import{Q as s}from"./iframe-CV9U59Xm.js";import"./sample-4XlXCCij.js";import"./preload-helper-PPVm8Dsz.js";const b={title:"Example/Button/Accessibility",tags:[],render:d=>l("ix-button",d),argTypes:c("ix-button",{}),parameters:{design:{type:"figma",url:"https://www.figma.com/design/r2nqdNNXXZtPmWuVjIlM1Q/iX-Components---Brand-Dark?node-id=225-5535&m=dev"},a11y:{test:"error"}}},e={args:{defaultSlot:"Add Device",icon:"add-circle",variant:"primary"}},r={render:()=>s`<ix-button
      icon="trash"
