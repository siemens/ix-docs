...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "1274f32c7a5e24c885191db0cf9b0e58715f4eb1", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "14196e9cedf85157bfeae56d6e6b769a1c9ed791" }));
  }
  get hostElement() {
