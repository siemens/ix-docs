...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "6957b2bb68891be643d1a1271fd550f0ba398b2d", class: {
    ...
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "22d183907d87d7ee59d11606ffc58d6b0f51a52c", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "a7076b2f4940e1c4d83b874eb06889027f3531b9", class: "slider-container" }, h("div", { key: "4d56ffb868ce60f3b7e47d803ec6ecffb493489d", class: "slider" }, h("div", { key: "ba33818b7f9ce81576136f9e95b5fe7ba88467e7", class: "track" }, h("div", { key: "b5ce5c8c334909d11875ab9ae2b36f719c1244a8", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "292823e7581b335cb5e499eddb2ab71c79789c19", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, (_a = this.marker) === null || _a === void 0 ? void 0 : _a.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", Object.assign({ key: "2e642f9cc0b3674b7e553b6e2b74d4f015ea4469", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max }, this.a11yAttributes)), h("ix-tooltip", { key: "d3367c620a0865ef84daaefdc0102ba3a186215c", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "e06b2afd4e3521cf34095a5243671b0d24b59695", class: "label" }, h("div", { key: "653916ebdc36874fb412b1481c13fe7a52eddccf" }, h("slot", { key: "0d73fd36d946b79bb84aa41a5b7973a4d986502c", name: "label-start" })), h("div", { key: "9b0938207951dceab28fa89238bc43d28b5e9e3b" }, h("slot", { key: "fb32e79050fb8aa5eb83cde26971b5cafad4f42f", name: "label-end" }))), this.error ? h("ix-typography", { textColor: "alarm" }, this.error) : null)));
  }
