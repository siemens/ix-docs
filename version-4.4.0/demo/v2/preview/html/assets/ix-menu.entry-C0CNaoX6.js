...
const Menu = class {
  ...
  disconnectedCallback() {
    ...
    (_b = this.themeNameDisposer) === null || _b === void 0 ? void 0 : _b.dispose();
  }
  updateThemeState() {
  ...
  render() {
    ...
    return h(Host, { key: "f110c37a48450f5c2503f7d22aa2ec89ab3e2a2b", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "ba8f5ebdf01e3971944d12bf7559920a30de630b", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "ded53cf75d43d7470b414c9a79470c08e84cdafc", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "affe4bd90b5d89e8bbfe84e0721f47c089f939c1", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && h("ix-icon-button", { key: "eb491ad150526feffc353aa3bc0facad5c022f59", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "c011962c8617669d512a5819d8fdd0426b889597", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "0a2bf780cff17852ebee73236cb9361cda69eae7", class: "tabs-shadow-container" }, h("div", { key: "89e91e3921a72d4fc38fbcfd9bcf7b1dc86b65f3", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "576ea9d478068b06c44fdaa0d0ea85291351f50e", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "93207553be4b6ea5c2ee10e4199dea100c571632", class: "menu-avatar" }, h("slot", { key: "9a10f155385fe009c6af637bd2b21162670df08f", name: "ix-menu-avatar" })), h("slot", { key: "c6ee9852f5c1891f6192654ce0a8b2dc5a6828f7", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "d9ddb5926de8faf8c5bbea2f87e4799c0467884b", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "2bbe5f772c8d634b57a8d5d0e042bca39d85fb34", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings, "aria-expanded": this.showSettings.toString(), "aria-controls": "menu-overlay" }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme, role: "switch", "aria-checked": this.isDarkMode.toString() }) : null, h("div", { key: "cb0c86250320b703ef016097137c3f95cf274163", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "5c22657279384b7fbc82b3728156ec11cc4494e7", name: "bottom" })), h("div", { key: "a34655b9fbfeecadd26ed3b73b340b56c8481c63", id: "popover-area" }), this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null, this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null), h("section", { key: "596600987bd9b245b44d7d725ba06a0266869fc0", id: "menu-overlay", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "13b89027a0240f22981b9e6ae41f3e62dbcdc8c9", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "a9e17821bc23eef2717fff6a3c9514b54b2bf00f", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
