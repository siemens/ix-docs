...
const TabItem = class {
  ...
  render() {
    return h(Host, { key: "71cfed0ab360348500969c2529bc79cab83bdaff", role: "tab", class: this.tabItemClasses({
    ...
    } }, h("div", { key: "fe2bdf6f8daee069486f25fe8e21e53713d856e4", class: {
      circle: this.rounded,
      text: !this.rounded,
      selected: this.selected,
      disabled: this.disabled
    } }, h("slot", { key: "2d978daeed548622c470979f9b1aacd9823f398e" })), h("div", { key: "8ee56a58ba2d1047b7089668b70a176edec0ea00", class: {
      counter: true,
      selected: this.selected,
...
const Tabs = class {
  constructor(hostRef) {
    ...
    this.layout = "auto";
    this.placement = "bottom";
    this.ariaLabelChevronLeftIconButton = "Scroll tabs left";
    this.ariaLabelChevronRightIconButton = "Scroll tabs right";
    this.totalItems = 0;
  ...
  render() {
    return h(Host, { key: "4d60486e9ae8c9b154df97446534697a6b8a52d6" }, this.showArrowPrevious && h("button", { key: "358885efeb578914036d4475377e0e8695937f13", class: "arrow", onClick: () => this.move(this.scrollAmount, true), "aria-label": this.ariaLabelChevronLeftIconButton }, h("ix-icon", { key: "d434ddb5acb03c058af167b7590bdc1018166e58", name: iconChevronLeftSmall, "aria-hidden": "true" })), h("div", { key: "24bc36c48fb9fd1cb2e3181dae47402fe5335bd0", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "a647c41bbd347379a9e7621705024f3182c08827", class: "items-content", role: "tablist" }, h("slot", { key: "92436d5e8b7a867de8e37b68a55600e590de63eb" }))), this.showArrowNext && h("button", { key: "27a519f552b7950cd8b57985110fec983ca675bc", class: "arrow right", onClick: () => this.move(-this.scrollAmount, true), "aria-label": this.ariaLabelChevronRightIconButton }, h("ix-icon", { key: "8c5e55420b51983b85d221708f691f407c8ecbb8", name: iconChevronRightSmall, "aria-hidden": "true" })));
  }
  get hostElement() {
