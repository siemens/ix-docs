...
const Select = class {
  ...
  render() {
    ...
    return h(Host, { key: "44a92192a5bb2243e52b5dedfc6513b75e1762e6", "aria-disabled": a11yBoolean(this.disabled), class: {
    ...
    } }, h("ix-field-wrapper", { key: "51981eecb1437df709600af04d3444e75b7ba33b", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "8f3fe3649221f9b09b009d6624eb096fea5a1cec", class: {
      select: true,
      disabled: this.disabled,
      readonly: this.readonly
    }, ref: (ref) => {
    ...
    } }, h("div", { key: "3d64b588c5bf162777e6c76f7fbd252a6856f968", class: "input-container" }, h("div", { key: "fc187195af89682f29494d779fabbb7fbf53c1d4", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => this.renderChip(item))), h("div", { key: "bf4730e7d19381c632063670ef11178e6998fe21", class: "trigger" }, h("input", { key: "5191e5a69165d1f22a0b807612d5c0eef16e4429", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    }, "aria-label": (_e = this.ariaLabelChevronDownIconButton) !== null && _e !== void 0 ? _e : this.dropdownShow ? "Close select dropdown" : "Open select dropdown" })))))), h("ix-dropdown", { key: "d96aa53fe76fec50dd2b2955be1983f5d2f977a4", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "72bf038496330903b51e0c29491de61035c2ca17", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "06f8ab01910cedaf38c1f6c80a6058189b58b297", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "99acea939a79985d5c26df1b10a498733bf82221", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
