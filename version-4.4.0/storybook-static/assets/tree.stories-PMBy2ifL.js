import{x as r}from"./iframe-DJKWFKy9.js";import{m as s}from"./generic-render-QLLvfCCW.js";import"./preload-helper-PPVm8Dsz.js";import"./sample-4XlXCCij.js";const i={root:{id:"root",data:{name:""},hasChildren:!0,children:["sample"]},sample:{id:"sample",data:{name:"Sample"},hasChildren:!0,children:["sample-child-1","sample-child-2"]},"sample-child-1":{id:"sample-child-1",data:{name:"Sample Child 1"},hasChildren:!0,children:["sample-grandchild-1","sample-grandchild-2"]},"sample-grandchild-1":{id:"sample-grandchild-1",data:{name:"Sample Grandchild 1"},hasChildren:!0,children:["sample-greatgrandchild-1"]},"sample-greatgrandchild-1":{id:"sample-greatgrandchild-1",data:{name:"Sample Great Grandchild 1"},hasChildren:!1,children:[]},"sample-grandchild-2":{id:"sample-grandchild-2",data:{name:"Sample Grandchild 2"},hasChildren:!1,children:[]},"sample-child-2":{id:"sample-child-2",data:{name:"Sample Child 2"},hasChildren:!1,children:[]}},h={title:"Example/Tree",tags:[],render:e=>r`
    <ix-tree
      .model=${e.model}
      .root=${e.root}
      .context=${e.context}
...
}`,...l.parameters?.docs?.source}}};const g=["ExpandOnChevronClick","ExpandOnNodeClick","SelectableExpandOnNode","IntermediateNodeExpandOnClick","IntermediateNodeExpand"];export{n as ExpandOnChevronClick,a as ExpandOnNodeClick,l as IntermediateNodeExpand,d as IntermediateNodeExpandOnClick,t as SelectableExpandOnNode,g as __namedExportsOrder,h as default};
