---
doc-type: 'tab-item'
description: 'Developer-focused accessibility guidance for ix design system, with practical code examples and implementation patterns to meet WCAG requirements and improve usability for everyone.'
---
...
```html
<i class="icon element-physical-input" aria-hidden="true"></i
><span class="visually-hidden">physical input</span>
```
...
Navigation provides a means for the user to get around on the website. Most of the HTML sectioning elements provide default ARIA landmarks.
