...
component-tabs: ['']
no_single_tab: true
description: 'Learn the guidelines for using empty-state messages correctly in your text. This subchapter will help you understand when and how to capitalize names, brands, and other specific terms to maintain consistency and professionalism.'
---
