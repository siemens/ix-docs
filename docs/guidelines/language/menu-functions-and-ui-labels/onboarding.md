...
> Clear onboarding guidance helps users get started quickly, build confidence, and unlock value from day one. Use step-by-step instructions, highlight key features and provide actionable tips to ensure a smooth, engaging experience.
...
Break onboarding into small, manageable steps with bullet points, pagination or short paragraphs.
    ...
    &nbsp;&nbsp;&bull; Select the notifications you want
