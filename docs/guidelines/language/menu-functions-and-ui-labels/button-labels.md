...
<div className="donts">
  <ul aria-label="Practices to avoid">
    <li>Button: Acknowledge the error and prepare for restart</li>
    <li>Button: Edit or delete</li>
  </ul>
</div>
</div>
...
<div className="dos">
  <ul aria-label="Recommended practices">
    <li>Button: Save and close</li>
    <li>Button: Save and restart</li>
    <li>Create and view account</li>
  </ul>
</div>
<div className="donts">
  <ul aria-label="Practices to avoid">
    <li>Button: Click here to save & close</li>
    <li>Button: Save data to drive and restart</li>
    <li>Create / view account</li>
    <li>I'd like to create a new user account and view it</li>
  </ul>
</div>
</div>
...
<div className="dos">
  <ul aria-label="Recommended practices">
    <li>Button: Go back and edit details</li>
    <li>Button: Save and close</li>
    <li>Button: Compare and update</li>
    <li>Button: Start firmware update</li>
  </ul>
</div>
<div className="donts">
  <ul aria-label="Practices to avoid">
    <li>Button: Click here to save and close</li>
    <li>Button: Save data to drive and restart</li>
    <li>Button: I'd like to create a new user account</li>
  </ul>
</div>
</div>

Don't use 'OK' as a button label. If a legacy system requires 'OK', use all caps.
...
<div className="dos">
  <ul aria-label="Recommended practices">
    <li>Button: Save and close</li>
    <li>Button: Add user</li>
    <li>Button: Save</li>
    <li>Button: Delete account</li>
  </ul>
</div>
<div className="donts">
  <ul aria-label="Practices to avoid">
...
Note: This is a classic desktop convention (Windows/macOS). In modern web and mobile apps, ellipses are increasingly being removed to reduce visual noise unless the action is a complex, multi-step wizard. See [Punctuation](#). We recommend' removing them in our Siemens applications.
...
Use aria-labels if the button has no visible label, e.g. icon buttons. See more information on [Text alternatives and labels](../../../guidelines/accessibility/code.md#text-alternatives-and-labels).
...
Make sure that the tooltip and aria-label match. See the [Accessibility](../../accessibility/overview.md) guidelines for more details.
...
- [WCAG: Using aria-label to provide labels for objects](https://www.w3.org/WAI/WCAG22/Techniques/aria/ARIA6)
