...
| --- | --- | --- | --- |
| 1. | Heading | Clearly state aim and purpose for the dialog, such as the theme, date, feature or version. | **Heading**:<br/> What’s new + topic:<br/>What’s new in Version 2.5<br/>What’s new in October<br/>What’s new for 2025<br/>What’s new in dashboards |
