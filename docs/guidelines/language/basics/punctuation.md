...
For unordered lists, use the HTML `` element. In iX applications, unordered lists should be displayed using the standard bullet point style.
 
For ordered lists, use the HTML `` element. Use numbered lists only when the sequence or priority of items matters.
 
Maintain a parallel structure within a list; if one item is a complete sentence, make all items complete sentences.

  
    
      Key features:&nbsp;&nbsp;&bull; Real-time monitoring&nbsp;&nbsp;&bull; Automated alerts&nbsp;&nbsp;&bull; Custom dashboards
      Setup steps:1 Connect device2. Configure settings3. Start monitoring
      Benefits include:&nbsp;&nbsp;&bull; Increased efficiency across all operations.&nbsp;&nbsp;&bull; Reduced downtime through predictive maintenance.&nbsp;&nbsp;&bull; Enhanced visibility into system performance.
...
When creating lists or using bullet points, use full stops for full sentences. If even one item in your list requires a full stop, add full stops to all items to keep punctuation consistent.
      ...
      List items:
      &nbsp;&nbsp;&bull; Quick setup is available.
      &nbsp;&nbsp;&bull; Easy integration with existing systems.
      &nbsp;&nbsp;&bull; 24/7 support for all users.
...
Use semi-colons to separate key application features to enhance and contrast them, and to present steps or sequential information. We prefer using commas or short sentences instead as semi-colons are easily misused and misunderstood. No space before a semicolon. One space after a semicolon when mid-sentence.
      ...
      Our app offers real-time plant updates, personalized dashboards and interactive maps.
      1. Calibrate sensors;2. Set operating parameters;3. Start the process.
