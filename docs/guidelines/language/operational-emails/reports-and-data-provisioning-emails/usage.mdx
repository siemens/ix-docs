...
<div className="dos" markdown="true">
<ul aria-label="Recommended practices">
<li>Your "Predictive maintenance analytics report" is available.<br/>
  Button: [Open report]</li>

<li>The migrated "historical maintenance logs" are now fully accessible within Maintenance history.<br/>
  Button: [Open Maintenance history]</li>
