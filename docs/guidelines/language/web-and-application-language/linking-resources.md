...
<div className="dos-and-donts" markdown>
<div className="dos" markdown>
- <IxLinkButton>Open Assembly Manual</IxLinkButton><br/><IxLinkButton>Open Demonstration Project App</IxLinkButton><br/><IxLinkButton>Explore Manual</IxLinkButton>
</div>
<div className="donts" markdown>
- <IxLinkButton>Click here.</IxLinkButton><br/><IxLinkButton>Click here.</IxLinkButton><br/><IxLinkButton>Click here.</IxLinkButton>
</div>
</div>
...
<div className="dos-and-donts" markdown>
<div className="dos" markdown>
- Link text: Visit our <IxLinkButton>homepage <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon></IxLinkButton><br/>ALT-text: external
- Resource text: <IxLinkButton>Function Manual <IxIcon name={iconPdfDocument} size="16" aria-label="PDF" role="img"></IxIcon></IxLinkButton><br/>ALT-text: external PDF
- Resource text: <IxLinkButton>Industrial Copilots with Agentic AI <IxIcon name={iconVideoFile} size="16" aria-label="video" role="img"></IxIcon></IxLinkButton><br/>ALT-text: external video in new tab
</div>
<div className="donts" markdown>
- Link text: Visit our <IxLinkButton>homepage <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon></IxLinkButton><br/>ALT-text: Visit our homepage.
</div>
</div>
...
<div className="dos-and-donts" markdown>
<div className="dos" markdown>
- <IxLinkButton>Application Function Manual (German) <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon></IxLinkButton>
- <IxLinkButton>German web page (German) <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon></IxLinkButton>
</div>
</div>
...
External resources:<br/> <IxLinkButton>Documentation portal <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon></IxLinkButton><br/>
<IxLinkButton>GitHub repository <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon></IxLinkButton><br/>
<IxLinkButton>Support community <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon></IxLinkButton>
</div>
</div>
