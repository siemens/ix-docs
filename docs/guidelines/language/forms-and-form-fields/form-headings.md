...
component-tabs: ['']
no_single_tab: true
description: 'Forms guide users as they provide information and move through workflows. Precise initial information in headings sets up users for easy form completion.'
---
...
<div class="dos-and-donts">
  ...
  <div class="donts">
    <ul aria-label="Practices to avoid">
      <li>Please fill out the following information to create your new user account with us.</li>
    </ul>
  </div>
</div>
...
<div class="dos-and-donts">
  <div class="dos">
    <ul aria-label="Recommended practices">
      <li>Do ensure subheadings provide beneficial information</li>
    </ul>
  </div>
  <div class="donts">
    <ul aria-label="Practices to avoid">
      <li>Don't overload users with extensive or multiple requirements in subheadings</li>
    </ul>
  </div>
</div>
