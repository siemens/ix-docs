...
:::info
Official Siemens UX writing and brand resources are exclusively available for Siemens AG employees and partners, and can be accessed [here](https://code.siemens.com/siemens-ix/ix-brand-theme/-/merge_requests/55).
:::
...
**Book:** The Business of UX Writing<br/>
**Website:** [yaelbendavid.me/](https://yaelbendavid.me/) <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon><br/>
...
**Book:** Nicely Said: Writing for the Web with Style and Purpose<br/>
...
**Website:** [digital.gov/guides/plain-language/writing](https://digital.gov/guides/plain-language/writing) <IxIcon name={iconOpenExternal} size="16" aria-label="external" role="img"></IxIcon><br/>
