...
Pluralization of the English term "apple":<br>
- 0: I own no apple.
- 1: I own one apple.
- n: I own four apples.

Pluralization of the Polish term "Plik"  (English:file):<br>
- 1 plik
- 2, 3, 4 pliki
- 5-21 plików
- 22-24 pliki
...
<div className="dos">
	<ul aria-label="Recommended practices">
		...
		<li>Use placeholders in text: "Saved on &#123;date&#125;"</li>
	</ul>
</div>
<div className="donts">
	<ul aria-label="Practices to avoid">
