...
The [drag-gripper icon](../icons/icon-library#drag-gripper) is visually similar but is not a menu icon and should be used for drag-and-drop interactions to reorder items.
