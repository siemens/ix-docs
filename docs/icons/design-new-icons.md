...
- Consider using more generic icons instead of creating multiple very specific new ones (e.g., use the generic "add" icon instead of creating an "add-wireless-device" icon)
