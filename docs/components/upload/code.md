...
| --- | --- | --- | --- | --- |
| accept | { "The accept attribute specifies the types of files that the server accepts (that can be submitted through a file upload).\n\nSee [https://www.w3schools.com/tags/att_input_accept.asp](https://www.w3schools.com/tags/att_input_accept.asp)" } | accept | string \| undefined |  |
| directoryUpload | { "If directoryUpload is true the user can drop or select a folder containing one or more files" } | directory-upload | boolean | false |
...
| i18nUploadFile | { "Label for upload file or folder button" } | i18n-upload-file | string \| undefined |  |
