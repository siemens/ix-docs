...
| --- | --- | --- | --- | --- |
| ariaLabelCalendarButton | ARIA label for the calendar icon button Will be set as aria-label on the nested HTML button element | aria-label-calendar-button | string \| undefined |  |
...
| valueChange | Input change event. | valueChange | string \| undefined |
