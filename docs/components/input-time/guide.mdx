...
- **Format**: Specify the time format to ensure that times are entered in a consistent and recognizable format. Default is ‘TT’ which is the localized 24-hour time with seconds  (read more in the <font color="#ff0000">TODO UX Writing guides</font>).
...
- Do provide clear instructions, such as “Enter the time in HH:mm:ss”
