...
| --- | --- | --- | --- | --- |
| ariaLabelTimeToggleButton | { "ARIA label for the time picker toggle button\n\nWill be set as aria-label for the nested HTML button element" } | aria-label-time-toggle-button | string \| undefined | 'Toggle time picker' |
...
| format | { "Format of time string.\n\nSee [https://moment.github.io/luxon/#/formatting?id=table-of-tokens](https://moment.github.io/luxon/#/formatting?id=table-of-tokens) for all available tokens." } | format | string | 'TT' |
