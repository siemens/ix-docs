...
:::info
Use actual [hyperlinks](https://developer.mozilla.org/de/docs/Web/HTML/Reference/Elements/a) for inline links `<a href="...">` instead of link buttons, e.g. within a paragraph. They are styled and ready to use out of the box.
:::
