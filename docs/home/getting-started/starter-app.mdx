...
component-tabs: ['']
no_single_tab: true
description: 'Build faster with the Siemens Industrial Experience starter app for React, Vue or Angular. It comes with ready-to-use pages, components and necessary integrations.'
---
