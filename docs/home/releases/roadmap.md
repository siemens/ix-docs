...
> We’re constantly improving our design system for you by extending the component library, developing our user guidance and ensuring the system is reliable and easy to use. This is what’s happening next so you know what to expect from your Siemens Industrial Experience team.
...
### ✅ Completed
- **🔹 Release 5.0**: Applying reference color tokens aligned with Siemens design language, refactoring keyboard navigation in dropdowns, new [date-time input](../../components/input-date-time) and [range field](../../components/range-field) components, [tabs](../../components/tabs) with overflow menu and style adaptions. [Read more](../../../blog/2026/05/21/release-5)
...
- **Icon size**: For better visual balance we're changing all 24px icons in our components to 20px icons.
...
- **Icon alignment**: Align icons semantically across Siemens design system to ensure icons reliably represent the same actions, states or concepts across the libraries.
