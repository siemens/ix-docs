...
- follows Industrial Experience writing conventions for sentence case, plural voice and present simple tense
...
3. Read the existing `index.mdx`, `guide.md`, `code.mdx`, and any related files to understand what already exists.
...
- Use guidance language such as "Use...", "Do not use...", "As a general rule...", or "Consider..." instead of neutral catalog text.
