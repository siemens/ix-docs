...
const ToggleButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "128350f4501a9f4eb89c6510edafe59c00a0b1e8", class: {
      disabled: this.disabled || this.loading
    } }, h(BaseButton, { key: "9dc929b6fa46e7260b5504b2627c94c794916ad5", ...baseButtonProps }, h("slot", { key: "b98585200dbee6bfdda03aa1d06243e72106c3e7" })));
  }
  static get watchers() {
    return {
      "role": [{
