...
const ToggleButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "22c2548a493307f2efc554a137e4e6ba93d913a4", class: {
      disabled: this.disabled || this.loading
    } }, h(BaseButton, { key: "015a3ad74d231eaf896c29c6ab5fae45e6cf4fb5", ...baseButtonProps }, h("slot", { key: "ad0158fc047212e96f296147b753f6847af768bc" })));
  }
  static get watchers() {
    return {
      "role": [{
