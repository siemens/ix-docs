...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "855ec01de8c175c0248069737dcfa240d3848264", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "ffc4b5117f8bda3710030ee85cdbceed417133c0" }));
  }
  static get watchers() {
    return {
      "model": [{
