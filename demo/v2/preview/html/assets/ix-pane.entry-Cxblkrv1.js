...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "2af275a401925a99c9a47cc5aa58a17c3eb5fcfb", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "1f9feb7d0c080e5f5833f0a5b5154202490b9fa4", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "2bfafc9e2922128eec41210485fec6534f525828", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "8417658fd2c0a70f98bd51c8f0ba2ccc84616167", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "7685fa2b6726c80e861715db078f354ace32b044", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "35faca81de8fc22114b05cc980a22c475cdd87ad", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "27e27879098e31c758924cf3a0b0bd61ecaf3ba3", class: "title-text-overflow" }, h("ix-typography", { key: "f8c15cc21515bb68e0f3ab17c392c716f77c842d", format: "h4" }, this.heading)), this.expanded && h("div", { key: "5f9468a14dcba14a378332fb0f7cb47df06786ef", class: "slot-header" }, h("slot", { key: "563d760c062d11d076040f346343bd980ce53a3b", name: "header" })))), h("div", { key: "4cf43dc7985849d58d7e9314c2c9a3eec2e3262e", class: {
      "side-pane-content": true,
      "no-padding": this.noPadding
    }, hidden: !this.showContent }, h("slot", { key: "551be42a3c3c7ddd86a072da7fe98f8b9c0044ec" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
