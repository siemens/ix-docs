import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-C4tOo1JZ.js";
...
import { O as OnListener } from "./listener-BjluJgvO-Coe1jmv-.js";
...
const Col = class {
  ...
  render() {
    return h(Host, { key: "8f9bb67a9721a22dab39e140b0e180a868839416", style: {
      ...this.getColumnSizeStyling()
    } }, h("slot", { key: "2d34daa2051b168c8b4dd61233d80195be90f3d5" }));
  }
};
Col.style = colCss();
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "799b08194c2dfc38cbf4bd8c0e7d69f4cd42c577", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "8177f73aacd4da3cd8d52cb2cc16f6694e032851" }));
  }
};
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "d82a36e9f2570227537fa27a4613728b14eb7728" }, h("ix-date-time-card", { key: "3176395745458739b9fb9de1b4b1d4f39b1f6d2f", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "9defe01ecd678617fa2ecf70c891e6e257a92d65", class: "header", slot: "header" }, h("ix-typography", { key: "28e6bc8abc536182d3b63d231913316df54058f0", format: "body" }, this.i18nHeader)), h("div", { key: "3aa7571fd61469deadb3ccecb871456926b4f0ca", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "f9fe74b09d9de0a95f2472d49faf5d675f8732ba", class: "flex" }, h("div", { key: "61323b760556dd2de6b55dc92ed4ce1f48d0e184", class: "column-separator" }), h("div", { key: "e4c888487a559ef191dfcf76014251e217a6f00e", class: "columns" }, h("div", { key: "0ef38a3e63f0bff2f5ef6774eea41e07d68fd1f4", class: "column-header", title: "AM/PM" }), h("div", { key: "47cd9041e31b25c6d08ccb0eed005a6b9963eaec", role: "listbox", "aria-label": "AM/PM", class: "element-list", tabindex: -1 }, h("button", { key: "d414632d382a84aa0db2c6f27c18f5b123c0d46a", role: "option", "aria-selected": this.timeRef === "AM" ? "true" : "false", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "1f288055298d5ec21b30137b82c9c729705dd989", role: "option", "aria-selected": this.timeRef === "PM" ? "true" : "false", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "afc8804b5164b9fb2606c03fc6fc518ef6b703ed", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "743e3b4f53dd35e9a4bfd4b11dce8a524c66f581", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
