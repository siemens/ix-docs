import { a as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-j8oXcCx7.js";
...
import { F as FocusVisibleMixin } from "./focus-visible.mixin-CoMZ6z5Z-BtW0Vqi1.js";
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "41ab96fb19faa443d399c320bb1fd0ddfd436afb", ...ariaAttributes, id: this.getHostElementId(), disableAriaSelectHandling: true, class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "b346f53bce7b1294fb31f723b5446f4bcf133d88", "aria-hidden": "true", itemRole: "option", class: {
