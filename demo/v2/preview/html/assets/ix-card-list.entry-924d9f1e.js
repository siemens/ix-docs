...
import { h as iconMoreMenu, j as iconChevronDown } from "./index-C0zeM1D4-b0cf2da8.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "cd30b474bb898b3b5d47ce3aebe6d0c7bce14971" }, h(CardListTitle, { key: "81ad4dc4999bce2d8328067ddff72ef0d65c3f54", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "9e4d4c81876739fa105bf04105d6affd975fe72b", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "c7356fbc40dd754090d9c9de2719752a3b246c11", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "f72374c253baa1c035aa675e838f2da988914a79", onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? h("ix-card", { class: {
