...
import { c as iconSuccess, b as iconError } from "./index-C0zeM1D4-b0cf2da8.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "158982c417b2c3ab4ca998759403c37a55e5971c" }, a11y, { "aria-disabled": disabled }), h("div", { key: "5cb3098336cadb31defe307a0478e967d7a4f733", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "008f5915ddac2eb9d48d2a6b93441473af8e79e6" }, h("input", { key: "913d9d291670bdc55bd59329b872b5cce05548da", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "ab38967374f3c5979c0fb0ccb4fea2841ef101fc", "aria-disabled": disabled, outline: true, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
