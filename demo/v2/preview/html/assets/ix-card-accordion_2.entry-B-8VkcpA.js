...
const CardAccordion = class {
  ...
  render() {
    return h(Host, { key: "99d74bce00deda78eec3e658c6315074bcc6f838", slot: "card-accordion", class: {
      [`variant-${this.variant}`]: true
    } }, h("button", { key: "0388734d427625db6a28c89cd3f854258060924b", tabIndex: 0, class: { "expand-action": true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, h("ix-icon", { key: "30cfd29665e01c6f717546b498a093dfd505c18a", name: iconChevronDownSmall, class: {
      "expand-icon": true,
      show: this.expandContent
    } })), h("div", { key: "55d278b4ff6fff66a0d1daee213c558bc5fa95cc", class: {
      "expand-content": true,
      show: this.expandContent
    } }, h("div", { key: "580b4d462ddab11dabc62222d88b9af585e9ae2e", class: "expand-content-inner" }, h("div", { key: "d5b05b3b7fa03a773d8c6c8256e100a723700be4", class: "expand-content-body" }, h("slot", { key: "baf8f14174f1a79e626ce3e9dc8cb149f6f0cc59" })), h("div", { key: "1be55e44df3a61bf32942fabcdd738d0738f091a", class: "expand-content-footer" }))));
  }
  static get watchers() {
    return {
      "collapse": [{
...
const CardHeader = class {
  ...
  render() {
    return h(Host, { key: "118fc1fabc92827855d151206ee45226d23cd269" }, h("slot", { key: "0b2536768b4509e294d98d117c9a28f3cc5b7a12" }), h("div", { key: "5611dca0fe3debc9c0fbe5ae96e4c221187cc12a", class: "title-actions" }, h("slot", { key: "ffa0ad8bd01bc19cd39ccaf08b67d2d6a7cb5a1c", name: "title-actions" })));
  }
};
