...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "dcc719533d7ebad6ebfc175db7fcce81ca432f6c", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "86cac25e18858e76e535df0c0a66e94dc5ca4c30", class: "wrapper" }, h("div", { key: "63eb080dd311b49c211e57abc8b1b5830a8fb81c", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "a2f46d4412c3f51d93ffe20d9e8e7681c50f2fa8", class: "slider" })), !this.hideText && h("ix-typography", { key: "8ed5848b4641a0152b937e8e3fdb9ce4d45ff1d3", class: "label", "aria-hidden": "true" }, toggleText)));
  }
