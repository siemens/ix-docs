import { a as registerInstance, g as getElement, h, H as Host, M as Mixin } from "./global-DjWMysHf.js";
...
import { r as resolveTextFromValidationState, h as hasAnyText, H as HelperText$1 } from "./helper-text-util-AEl-1QU6-CIzhCYER.js";
...
const FormFieldLabel = class {
  ...
  render() {
    return h(Host, { key: "ad08b7a792dd213a1aca7987b8ab1257a4440c2e", onClick: () => this.focusOnClick(), class: {
      "text-overflow-wrap": this.textOverflow === "wrap",
      "text-overflow-no-wrap": this.textOverflow === "no-wrap"
    } }, h("label", { key: "e26ab143b023ec5ab6e06391ee3fedd51bf71270", htmlFor: this.htmlFor, ...this.a11yAttributes, ref: this.labelRef }, h("ix-typography", { key: "d3b6dba658be6505526efb3041b96799808531e5", textColor: this.isInvalid ? "alarm" : "soft", format: "label" }, h("slot", { key: "4afe1e2663314280cec3de64436ebf94e9921524" }), this.required && h("span", { key: "28e1138de051afea91cf40226d5c3d315e331f8b" }, "*"))));
  }
  static get watchers() {
    return {
      "isInvalid": [{
