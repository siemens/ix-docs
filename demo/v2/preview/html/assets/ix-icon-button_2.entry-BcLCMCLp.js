...
import { B as BaseIconButton } from "./base-icon-button-DufFLJC--oweIQ6Kf.js";
...
import "./base-button-DZdtpLxn-mxC7BreK.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "9272601ded9b34315e5aa297b35661615eccdaf8", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "46bfd8c84d6ee2c0c772877ac5411cb0c8eb24d7", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "4c85678a69f2221a2a896cecbf4ea2a52c63eee3", ...ariaProperties }, h("div", { key: "8f901307a70b082f18e02d536eaac478a086ac3e", class: {
