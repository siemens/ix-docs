import { a as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-j8oXcCx7.js";
...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "848591f6959a970ef5f9aaf19f5536c5339d7110", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "c956793c63354f9da18c454b2c8eff7a87ee7e6b", class: "settings-header" }, h("h2", { key: "9997f069ad979c9e355557e1ae821f6fe9bc2f57", class: "text-h2" }, this.label), h("ix-icon-button", { key: "289a2f65031d5787d4a4ea80a955f2e371e6b0ae", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
