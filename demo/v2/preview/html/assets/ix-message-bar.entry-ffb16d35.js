...
import { q as iconClose, b as iconError, z as iconWarningRhomb, a as iconWarning, c as iconSuccess, i as iconInfo, A as iconNotification } from "./index-C0zeM1D4-b0cf2da8.js";
...
const MessageBar = class {
  ...
  render() {
    return h(Host, { key: "c218f70104f29dc0dfb8d3b4b34d05a1b67854a6" }, h("div", { key: "779ad5197bd01be55aafbc62d8ebb8f9c99dfeec", class: { "message-container": true, [this.type]: true }, role: "alert", ref: (el) => this.divElement = el }, h("ix-icon", { key: "eef724c7c6b97fea1d04f7d3697da04e87d039dd", color: this.color, name: this.icon }), h("div", { key: "4083c354901d400eb2715692f4e77fbaa074f603", class: "message-content" }, h("slot", { key: "169724f9357de0235ed07b569fc3a01c5f115a06" })), this.dismissible ? h("ix-icon-button", { icon: iconClose, size: "24", ghost: true, onClick: () => {
      if (this.divElement) {
