import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-BTgWS9s6.js";
...
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-nCmPujqf-_uKA09Mk.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "a68cdabb69942bd85c2d229ff0de5b0e4870fac8", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "7fea53cccace32e07ca035dcf78382c237d60e4e", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "7961f3198ebd6c876284f624f59f356968f56768", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "51c432b9308c9196ba5dc1c0875a4e081c856589", class: "slot-container" }, h("slot", { key: "1aee2adfc52e1e1ed00d6947bb73fd0f5dcae6ff", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "a1981fe23e2fd8e0655e22bd33474635a51cbef9", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "254faf12d2bacb122eed12f87ba2788ce23b0cf0", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "b93c3250f3f250a62624dd5916f89dcb2827308c", name: this.icon, size: "24" }), h("slot", { key: "027121762879363b90880ed379303bf76d134f67" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "5e1c1665a517e08e61ae434ecbed6e8e46b5c1e5", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "32d9e8603dd0fafa17b6bac61a5c7a8e4065aecd", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "ecda11782eeae556e74f44613b2ac2b697ef6be0" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "01e49113bf0d7be5d08ea97f844e88cda5bb73ca", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "ab9e497662d8574fd7ed8a57686cc7bd4c91c7e9", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "2a81e5282c8dfe6ccb02845264ca23db660b42b1", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const TabSet = class {
  ...
  render() {
    return h(Host, { key: "09c24128f2981d8276e3d63e6067f7b3da7f99a9", onTabChange: () => this.checkPanelsVisibility() }, h("slot", { key: "ac2212c76128277abca943387b93a6d436cebe94" }));
  }
};
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "59be7687531f1e2c2196232dbe2ae5a874481b3a", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "55697ae33bb24e020417996ef311fe1863e87047", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "0e1296872121e4951b16df684877246fa21f6e0f", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "afd9c8c5173ac2030476892b0dd79bcccef46f57", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "73ab7f836156f9eb8e32ef0c0ce1f153e32e2936" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "cae99e1f6e20e6004d853aff98af0032e53730f3", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
