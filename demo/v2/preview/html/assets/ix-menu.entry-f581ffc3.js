...
import { Q as iconNavigationLeft, R as iconNavigationRight, e as iconApps, S as iconCogwheel, i as iconInfo, T as iconLightDark } from "./index-C0zeM1D4-b0cf2da8.js";
...
const Menu = class {
  ...
  render() {
    var _a, _b;
    return h(Host, { key: "cbda505b374a285374741824cbae4de95bde4b1b", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "7d9cd9181fff0f0fd46e81d1b4fa29f10205dfc2", class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "3fac318304f093ca1b203ec372857e2ecda4c3bb", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "f92bc8ed6526291a79e429e122e8fa6ae588bcae", breakpoint: this.breakpoint, expanded: this.expand, pinned: this.pinned, class: "menu-expand-icon", ixAriaLabel: this.i18nExpandSidebar, onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.appSwitchConfig) && h("ix-icon-button", { key: "3ae83734ee0f6c7870e49f4da2be48f7b2df2897", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, ghost: true })), h("div", { key: "c84a91091e724f8b159f1e4da2396d5a965dcbb1", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "06d4c29842cc26d219bb8bbf5173864b008f4309", class: "tabs-shadow-container" }, h("div", { key: "2f238d7795658621284dc89853116e4ff5882b0a", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "ad8de3d5fb4d640bdf146278e7bae0b386cf46d7", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "7f83a070a64dd802a4d811d8b07d45724c95bdbd", class: "menu-avatar" }, h("slot", { key: "86db5d016850cf1be31e8986bb1d41137ae110b0", name: "ix-menu-avatar" })), h("slot", { key: "95cba7cd48b04e99d869f08c6326dec7bf08e51b", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "815c1096aa96cd6982259c808ef8f73945335649", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "7de9ba045801d9829a07a13ef0723f3e5f856606", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings }) : null, h("div", { key: "6e55583f981fd4e8339f608565a4b95d40bdc3c4", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "0f4859c7304baa920cdc06eecefc28cecb778523", name: "bottom" })), h("div", { key: "9c7cfcc1331668a29f9e4ce92d142a0026ea5e85", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme }) : null, this.enableMapExpand || ((_b = this.applicationLayoutContext) === null || _b === void 0 ? void 0 : _b.sidebar) ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}`, label: this.getCollapseText() }) : null), h("div", { key: "5268f5a1b74dbfd693e5446ce5000ecf21ba56fa", class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "29d8553bef1d23319db3903240dbbd18807135f4", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "c97e7a08298dc514fa7ddd8c3dc54ff528bc213a", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  get hostElement() {
