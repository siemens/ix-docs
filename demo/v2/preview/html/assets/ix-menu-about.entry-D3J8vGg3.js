...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "cd2ec8d53634b27f234387f307e04d39533ca6ee", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "68f17954c5f51c37e44b24b154cf58f218149468", class: "about-header" }, h("h2", { key: "1e56a04ed218d37418cf9190f264586883e7f9bf", class: "text-h2" }, this.label), h("ix-icon-button", { key: "54b82a7838d4e1d9413efec58e03aeea3dcf21dd", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
