...
import { C as iconPlus, k as iconClear, r as iconChevronDownSmall } from "./index-C0zeM1D4-b0cf2da8.js";
...
import { O as OnListener } from "./listener-Cu2ljot5-9444d3de.js";
...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "c8600164587d236a2dd1d4ea601eb0abc47b0e03", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "0c1f7644ebc9ef0cef2a71ebf76e5a892c638a30", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "98ac9d75da599c9f1e89ab65788b3d25344e1da6", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "89e5ecb5829c46f02f653038f3688adb15c2108e", class: "input-container" }, h("div", { key: "66c8168b0c864f8a743d8695ac2930d9b350d419", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "70e487b741f48eaae57a485e24c3b6aa08100dc3", class: "trigger" }, h("input", { key: "456ca36b35b69d3a0cc02171b4125d3183a8b614", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    } })))))), h("ix-dropdown", { key: "da9ea1f621ebf6a80d7faa3f4af9d79621b37bf5", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "6a64cb7770f4a9fb0862b185988700236dc03310", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "3732d843a30d04c37d65f68e1d6cf3f175738fe1", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "ef78836a4b33a85cb906004b334a6d0ed5b33f5d", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
