...
const ApplicationSwitchModal = class {
  ...
  render() {
    return h(Host, { key: "d5f90b59051a81a5c9157cf76f181d0dbf3db288" }, h("ix-modal-header", { key: "a56ca3229b08765f10b792b0aaa850e15ab6a233", icon: iconApps }, this.config?.i18nAppSwitch || "Switch to application"), h("ix-modal-content", { key: "4ed63c67ea9a17355d010cd74eb80f9e3d15d26a", class: "content" }, h("div", { key: "1a9cadf4e12af46758b21d3074a97b10e9a00e6c", class: "content-apps" }, (!this.config || this.config?.apps.length === 0) && h("div", { key: "c0dbbd963ecc7afa860b2dc18cd93c8f93ce228a", class: "loading" }, h("ix-spinner", { key: "9da41df87f43a42f2c62019ba48f2eda65c25205", size: "medium", variant: "primary" }), h("span", { key: "1865e305014310653486c4115dca075f8ffc4a92" }, this.config?.i18nLoadingApps || "Loading available applications...")), this.config?.apps.map((appEntry) => h(ApplicationItem, { host: this.hostElement, name: appEntry.name, description: appEntry.description, iconSrc: appEntry.iconSrc, target: appEntry.target, url: appEntry.url, selected: appEntry.id === this.config?.currentAppId })))));
  }
};
