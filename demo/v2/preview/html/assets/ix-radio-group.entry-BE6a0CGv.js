...
const RadiobuttonGroup = class {
  ...
  render() {
    return h(Host, { key: "829b222152a0cfcbdf561425591174ad3bb3716a", onIxBlur: () => this.touched = true, ref: this.groupRef, role: "radiogroup" }, h("ix-field-wrapper", { key: "f9cc7e451c564f554fbe13b9631934b1776f4dc8", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, h("div", { key: "a7a67482251f6ee87f5266959f01fff3c51dda99", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "9a99b6cdced60eb7234e2d28645ba074ef79cb4a" }))));
  }
  get hostElement() {
