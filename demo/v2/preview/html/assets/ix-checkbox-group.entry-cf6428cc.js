...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "9e6c2220c396028cf5631d025fc043a412dcc4cf", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "2846fc8592f110aec2ed1f9c946e76304d0ed279", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "64fb77ea90c28b889fd6652549b3292feb7c6f35", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "522144ac452b86e093c419482851da61eed77022" }))));
  }
  get hostElement() {
