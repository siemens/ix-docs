...
const RangeField = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "a3fe83cc2529f7b415a7c2b7cc6f03685078df51", class: { "hide-arrow": this.hideArrow }, role: "group" }, !this.hideArrow && h("ix-icon", { key: "10503bc358606a043a4cd3f56c399bc500fb4714", "aria-hidden": "true", class: {
      "range-delimiter": true,
      "has-label": this.hasLabel
    }, name: iconArrowRight }), h("slot", { key: "2b97358a113fa98803c17dda0d1202d94d1cdc34" }));
  }
};
