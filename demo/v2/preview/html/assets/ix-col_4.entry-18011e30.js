import { r as registerInstance, f as forceUpdate, h, H as Host, c as createEvent, F as Fragment, g as getElement } from "./global-bbf431ac.js";
...
import { g as iconChevronRightSmall, D as iconChevronLeftSmall, P as iconSingleCheck } from "./index-C0zeM1D4-b0cf2da8.js";
...
const LayoutGrid = class {
  ...
  render() {
    return h(Host, { key: "fe5aa2699254c68eed6c8e5fdc291caf771d4fc3", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "4de7c4965fb2001ae89f3bed9d792e7d2bd41f60" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "1f0990750682b561f067545b1934d84385f46a28" }, h("slot", { key: "5522ee34f8ddeb847e822ce075a182e6c2ee4d5a" }));
  }
};
Row.style = rowCss;
export {
