...
const WorkflowStep = class {
  ...
  render() {
    ...
    return h(Host, { key: "9ce5d93c28b5faeab001bd9210a022b32d2635c3", class: { "host-vertical": this.vertical }, onClick: () => this.onStepClick() }, h("div", { key: "d3e4dc4bfd15f93461193fd1cc88bd666103160f", tabIndex: 0, class: {
      step: true,
      selected: this.selected,
      vertical: this.vertical,
      disabled: this.disabled,
      clickable: this.clickable && !this.disabled
    } }, h("div", { key: "d9e7ed59ca4a16c28ad973c85b09a19044954f08", class: "wrapper" }, h("div", { key: "89d015629ccebbdb8a94d8c9ee276f3abb8c876f", class: {
      line: true,
      selected: this.selected,
      [this.status]: true,
      [this.position]: true
    } }), h("div", { key: "56abb531bee9339a25c540019faef59a406a542a", class: "iconWrapper" }, icons, h("slot", { key: "e903779416603e31faf8cacd15cc85c751e6376a", name: "custom-icon" }))), h("div", { key: "5c93afc3352897a7480e27251590cbb3dce86e9a", class: "text" }, h("slot", { key: "6594f25dccef5bd78bf255839487a9e8fdc7d3ca" }))));
  }
  static get watchers() {
    return {
      "selected": [{
