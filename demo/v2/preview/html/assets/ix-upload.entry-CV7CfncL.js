...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "f6688a85aea9e0d89501ad0228672c3d8e7d1510" }, a11y, { "aria-disabled": disabled }), h("div", { key: "df7497428db60a2b3e67a4363c646cfe6b48ad00", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "2d5be47bf62d7ee550161a9f3144360008a8c15a" }, h("input", { key: "65906ff25aef00a22ba14ca0c9ac06f5ba2f0a14", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "2aa95b1069cf60552bee194095cb2cb6cdc66d65", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
