...
import { H as HookValidationLifecycle } from "./validation-D_dk-JqT-CRNNydA9.js";
...
const Select = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "2113db5b5d04704c2bc60f2bb04c8886d9bc5f4c", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    } }, h("ix-field-wrapper", { key: "d48ae99ecb04db8ffa4a22af08ccf89ce7c080be", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "de5fd6ec7e718893bf763d48032a8ee084cd59a3", class: {
      select: true,
      disabled: this.disabled,
    ...
    } }, h("div", { key: "4128e9c3bae2b348948606783b2d07d427e1e173", class: "input-container" }, h("div", { key: "b36ef6be27a9b23f11517e44551d902389fcba08", class: "chips" }, this.isMultipleMode ? (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
      this.itemClick(item.value);
    } }, item.label)) : "", h("div", { key: "f86b26dab24944a087f1977bc5fbc898002944d4", class: "trigger" }, h("input", { key: "c8237e81cf58258ad73a125e082513bc55da5160", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
      ...
      if (this.editable)
        this.dropdownWrapperRef(ref);
    }, "aria-label": this.ariaLabelChevronDownIconButton })))))), h("ix-dropdown", { key: "1c304ed548a2b2d30e39a53757fff6291417e680", ref: (ref) => this.dropdownElement = ref, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", class: {
    ...
    } }, h("div", { key: "f338a319e31998b5920812726cf92bbca06c85e1", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "d873c28ecd6dbb3343d7473e8318742d36ea3626", onSlotchange: () => {
      this.updateSelection();
    } }), h("div", { key: "91119d208ae834e7c6be27190472258db2d0aebb", ref: (ref) => this.customItemsContainerElement = ref }), this.isAddItemVisible() ? h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
      "add-item": true
