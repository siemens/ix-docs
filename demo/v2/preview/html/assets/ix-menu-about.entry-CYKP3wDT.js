...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "56d35aa6c165dfcd963b3a6dce8721bac885aac5", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "08a23deef054843de85fa1d2a6d97f4f8995e298", class: "about-header" }, h("h2", { key: "9f97df8a9bfb172ebd3b3d549e965570ca20cfc3", class: "text-h2" }, this.label), h("ix-icon-button", { key: "a007fc7f753a7c1f18c2c7a9639b5008810c70c5", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
