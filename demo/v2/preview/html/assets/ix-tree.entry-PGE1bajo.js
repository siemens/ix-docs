...
const Tree = class {
  ...
  render() {
    return h(Host, { key: "2559d80cdc3622837771d6f9484117b5d8ae15db", onClick: (event) => this.onTreeItemClick(event) }, h("slot", { key: "f1b3e2121e4833481dcf91594f38434318de84bc" }));
  }
  static get watchers() {
    return {
      "model": [{
