...
const Group = class {
  ...
  render() {
    return h(Host, { key: "27d311321d22d9017cb1b5ef1c8111ab6c64287a" }, h("div", { key: "12af89da94df847b308aeab2ae17b08706b30186", class: {
      "group-header": true,
      expand: this.expanded,
      selected: this.selected
    }, tabindex: "0" }, h("div", { key: "c591e59143d43a8fae481c7453eaf41340bf57bf", class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, h("div", { key: "84d39c3f502d4a41e1d84f373d5da964bd5986d3", class: {
      "group-header-selection-indicator": true,
      "group-header-selection-indicator-item-selected": this.itemSelected
    } }), h("div", { key: "5f297db1492b8b30a00c59658b9a920a2c353500", class: "btn-expand-header" }, h("ix-icon", { key: "51b5c4f48401a22057af6b4ae3e1c461a51e8374", "data-testid": "expand-collapsed-icon", class: {
      hidden: !this.showExpandCollapsedIcon
    }, name: this.expanded ? iconChevronUpSmall : iconChevronDownSmall, onClick: (event) => this.onExpandClick(event) })), h("div", { key: "ba9fbc5a70927476e1ead817e64862fac6c97767", class: "group-header-content" }, this.header ? h("div", { class: "group-header-props-container" }, h("div", { class: "group-header-title" }, h("span", { title: this.header }, this.header)), h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader)) : null, h("slot", { key: "f760a427586603d9a186d35b0d42abb4b1ab460a", name: "header" }))), this.hasDropdown && h("ix-group-context-menu", { key: "b63443b4daf82bbd185f11965eb9ff4b54932f2b" }, h("slot", { key: "196393e4ae905b26075f4dd99008f71e69f5cdc5", name: "dropdown" }))), h("div", { key: "d7114d36a07d2fe1dd9f71b0502e3cddb9eef8dc", class: {
      "group-content": true
    } }, h("div", { key: "f3ab7295ac0b6e7abf49f76f6b77cd35a234b8cd", style: {
      display: this.expanded ? "contents" : "none"
    } }, h("slot", { key: "765ca882c56cb4153e97bc84c41c7a23fae1f02a", onSlotchange: () => {
      const slot = this.hostElement.shadowRoot?.querySelector("slot:not([name])");
      this.showExpandCollapsedIcon = hasSlottedElements(slot);
    } }), h("ix-group-item", { key: "066f81aefb6cc93a2289640c5b7b076be7752e47", class: {
      footer: true,
      "footer-visible": this.footerVisible
    }, groupFooter: true, suppressSelection: true }, h("slot", { key: "4cd4ad5915dc00a1a723e83d515777343d2033bc", name: "footer", onSlotchange: () => this.onSlotChange() })))));
  }
  static get watchers() {
    return {
      "selected": [{
