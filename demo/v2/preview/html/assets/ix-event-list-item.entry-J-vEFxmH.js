...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "62246c6ecf60106320d54a3cc214b359cd654dc3", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "7c0055e2e67b53d02d5b9cc5b6e769aea1913841", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "b05eb8e2f3b0009c8d3d58a3c27bc0f5b447ef26", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "e64d403714e4627338cc68eda2adacedc8960c2b", class: "event-list-item-container" }, h("div", { key: "fca0440ca4783be7c45ac7b9f52574241e7eca49", class: "event-content" }, h("slot", { key: "1bcdd9678b8e47904f06474a8b507c3eb24c98c8" })), this.chevron && h("ix-icon", { key: "8e71379a54c18b1e491e899da196387a5ab2a208", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
