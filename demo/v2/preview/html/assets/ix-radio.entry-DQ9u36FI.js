...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "f2af88d1133c45be1101d9148f8e00f5428be7a6", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "93f6a862ac81885b247dc499d34e966d56973970" }, h("div", { key: "253b7ae5544c8d8ee3449ea0be187246cbe314d5", class: "radio-button" }, h("div", { key: "2e0d99a793f5ddd3b3d5a5d32732e8cd88d8b1f5", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "7ad24225a37a30e1f002bc07f450a85eb42b7383", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "7790a763f1a329cc3e0595aeddbe7e5a66c8339e", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "ff24cb9646a2a1c4b18236af291d13cd044f3235" }))));
  }
