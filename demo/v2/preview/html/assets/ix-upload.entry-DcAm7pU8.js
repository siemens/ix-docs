import { g as getElement, a as registerInstance, c as createEvent, h, H as Host } from "./global-j8oXcCx7.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "00802250d19d55f8d8740cb853a922eed4c2e4e7", ...a11y, "aria-disabled": disabled }, h("div", { key: "9e6c52a58f0fc474f719b3c383ec36fa5257b7b8", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "4bde0596c742870e3dd2d4e118b564da18fceafd" }, h("input", { key: "6c83ac9e99dbe18bc7b54b5c57c6bef2760f31b0", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "0d92396264d64dcc3edfde432051aa4dfc2420de", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
