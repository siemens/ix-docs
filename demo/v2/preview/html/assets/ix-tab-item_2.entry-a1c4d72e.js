...
import { g as iconChevronRightSmall, D as iconChevronLeftSmall } from "./index-C0zeM1D4-b0cf2da8.js";
...
const TabItem = class {
  ...
  render() {
    return h(Host, { key: "1a806de40cf4e4120679172b820cb91bfc7f3f3b", class: this.tabItemClasses({
    ...
    } }, h("div", { key: "66c9ae8ec0c8d05893aa73616c56187b15742b51", class: {
      circle: this.rounded,
      text: !this.rounded,
      selected: this.selected,
      disabled: this.disabled
    } }, h("slot", { key: "e0cc47e2034c700939d9de17168a1731a3b22b27" })), h("div", { key: "eb9bc5552eb838ad2e8108911300d922db835304", class: {
      counter: true,
      selected: this.selected,
...
const Tabs = class {
  ...
  render() {
    return h(Host, { key: "2e2841f69a5092e26a297d26a4af9dc2d6bc6439" }, this.showArrowPrevious && h("div", { key: "5bb3243568154da51a0efc7d1f36515227c58f90", class: "arrow", onClick: () => this.move(this.scrollAmount, true) }, h("ix-icon", { key: "a53a73edfb4a70d008ebeb24b73ef7acfc21c5c1", name: iconChevronLeftSmall })), h("div", { key: "94cde400dafb04cf30bee4cd873a7db812f2c23c", class: {
      "tab-items": true,
    ...
    } }, h("div", { key: "86d936ada5313c9e62a27b001998b2f1ac977dda", class: "items-content" }, h("slot", { key: "8eeb458d6106f6ee7682261a120cd19578fb2524" }))), this.showArrowNext && h("div", { key: "df86504a761a7779710d7dcca7759d27e3678e03", class: "arrow right", onClick: () => this.move(-this.scrollAmount, true) }, h("ix-icon", { key: "fd8ab6f8668abefa30c087e0158c417805f84917", name: iconChevronRightSmall })));
  }
  get hostElement() {
