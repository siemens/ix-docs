...
const Badge = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "db05c580c07295abde411f0c77ce96e4a83e5550", ...this.hasAnchor ? {} : this.inheritAriaAttributes, class: {
    ...
    } }, h("slot", { key: "77ed2ddd676864a819cdee8136e6a6b7e35028aa", name: BADGE_DESCRIPTION_SLOT }), h("div", { key: "4772bb4b795f23fae60b928354baf6f1c47a50ea", class: "anchor" }, h("slot", { key: "6803baae909f08acbc6b15a6dd673dc63f72e414", ref: this.setSlotRef, onSlotchange: this.onSlotChange })), this.renderIndicator(type, variant, accessibleText, formattedLabel), this.getTooltip(formattedLabel));
  }
  static get watchers() {
    return {
      "label": [{
