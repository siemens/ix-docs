...
const InputGroup = class {
  ...
  render() {
    return h(Host, { key: "8bef7dd0d504b224c01e63f408c53d89ba150a4e", class: { disabled: this.disabled } }, h("div", { key: "aa641576a19c98d4802641f1ef6d651ede664fac", class: "group group-start" }, h("slot", { key: "b2df10f1f20dffe7f30cc218ac6b0cfea1025306", ref: (el) => this.startSlotRef = el, name: "input-start" })), h("slot", { key: "e1a494f9e14fb7bd1214f69b35053e08907a5eff" }), h("div", { key: "ed243b19f1f6da117c39b469c66a485b483ca3c8", class: "group group-end" }, h("slot", { key: "d3188f865101d4279e4ad7eb96beffaf5bacc721", ref: (el) => this.endSlotRef = el, name: "input-end" })));
  }
  get hostElement() {
