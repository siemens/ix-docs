import { r as registerInstance, c as createEvent, g as getElement, h, H as Host } from "./global-DsITLPyL.js";
import { E as iconSearch, D as iconClear } from "./index-BeX6RWvV-CXzUIwMU.js";
import { B as BaseButton } from "./base-button-Oanl-VqF-C3u9Qee0.js";
...
const CategoryFilter = class {
  ...
  getResetButton() {
    ...
    }, variant: "tertiary", icon: iconClear, iconColor: "color-soft-text", size: "16", "aria-label": this.ariaLabelResetButton });
  }
  getIconColor() {
    if (this.disabled) {
  ...
  render() {
    return h(Host, { key: "213c9455760e956792f5d8852799e1329c2aee2c" }, h("form", { key: "fe985e2330a24b77ad5345c6e7667b7be24df66e", ref: (el) => this.formElement = el }, h("div", { key: "2c453e7d5d7d216942b6f389e97b348030c5a099", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "30946f69374b99e3593b9cbe89ff9dd43a6e83af", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "c6da3b3838ac0f8d5ee2e80235b3f9670d34e9b4", class: "token-container" }, h("div", { key: "9748e927c040ccb216dea26abaa48f3aa2535f64", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "e01a1f24f7cd7c514b641532ce25e754e03837fd", class: {
      "text-input": true,
