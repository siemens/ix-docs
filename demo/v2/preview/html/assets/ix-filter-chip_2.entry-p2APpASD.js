import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-C4tOo1JZ.js";
...
import { F as FocusVisibleMixin } from "./focus-visible.mixin-CaRK3Ex_-DkVMFj7j.js";
...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "886715c810d5084905082b8eba5d0e62dabe8b32", class: {
      disabled: this.disabled,
      readonly: this.readonly,
      "hide-close-button": this.hideCloseButton
    }, title: this.hostElement.textContent }, h("div", { key: "531598188ad4a407b9b8c153dcfa9fd7260218c9", class: "slot-container" }, h("slot", { key: "530355ee81b106b9182a62fc8e3432420c0a6fd1" })), !this.disabled && !this.readonly && !this.hideCloseButton ? h("ix-icon-button", { variant: "tertiary", oval: true, icon: iconCloseSmall, size: "16", disabled: this.disabled, onClick: (event) => {
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "adb8da016414dafc839fff44acbe5dd7d254c188", ...ariaAttributes, id: this.getHostElementId(), disableAriaSelectHandling: true, class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "156824791385b920b04cb389553e020cf3f3183b", "aria-hidden": "true", itemRole: "option", class: {
