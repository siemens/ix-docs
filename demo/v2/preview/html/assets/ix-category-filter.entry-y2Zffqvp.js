...
import { B as BaseButton } from "./base-button-TVpiK7pg-CrZ9rI2r.js";
...
const CategoryFilter = class {
  ...
  render() {
    var _a, _b, _c;
    return h(Host, { key: "fe49a215180e62dfb5b88304e08d775f1d6d8151" }, h("form", { key: "075cea4e8c8f681a37e9c9916551d8835878e9a9", ref: (el) => this.formElement = el }, h("div", { key: "efa00f0c5eb73bdcdd96f3f2b314b1db7580a227", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "a889dd34ab269b07c49701d381fa997cf66dcc7d", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, size: "16" }), h("div", { key: "9f7bbd1f655d3e3d92b0f97a7a50c837d721f3ef", class: "token-container" }, h("div", { key: "e130e26ad631aeef22c31c858f4687d40f2272ec", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label), h("input", Object.assign({ key: "10c2f91e57a8ef18bd9dbc53c227a15544d4de28", class: {
      "text-input": true,
