import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-BTgWS9s6.js";
...
import { O as OnListener } from "./listener-BjluJgvO-DSwYM8cR.js";
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "26fc55b40e07bde5fff6a21502925a88aa1eaf14" }, h("ix-date-time-card", { key: "e6d72d2e2762ea0a67e69fcae8d89a49fd6bc6ec", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "de11595ccaeef7d0372d6af2c3e72ded18ed03d9", class: "header", slot: "header" }, h("ix-typography", { key: "b001917ac3090679081c49852b2610adc381403f", format: "body" }, this.i18nHeader)), h("div", { key: "9bf75682fe81bf9a5c8bc668a533083d41776690", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "7d7a125d05231b0dc38d168308210ea6cd0aa5c9", class: "flex" }, h("div", { key: "b3a8870552cbb4b665f63413a97bd5c4a82b1335", class: "column-separator" }), h("div", { key: "33e8cc862740c6348b7056acf33d62636136b4b4", class: "columns" }, h("div", { key: "eb8a24da30e71e94d1a10528a2bc2e4e04529680", class: "column-header", title: "AM/PM" }), h("div", { key: "54ab57b53a21734900b856f6a98f59f8ed7ca789", role: "listbox", "aria-label": "AM/PM", class: "element-list", tabindex: -1 }, h("button", { key: "7dfd20d6f16bc1f5c2ed9c2b72589289b34b7207", role: "option", "aria-selected": this.timeRef === "AM" ? "true" : "false", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "d6fee9560179caa7050fdb1add2d8b558e87d890", role: "option", "aria-selected": this.timeRef === "PM" ? "true" : "false", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "4544617138a6372ac583b62113f5be2a98550f8c", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "21b4ad3eb7e3ad466d1f4e8f1e7975df27bddc6e", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
