import { M as Mixin, r as registerInstance, g as getElement, h, H as Host } from "./global-BTgWS9s6.js";
...
const MenuItem = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "e319ac5c518ad11e6dee70251088c6f327f49827", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "c8e17fa4cb154eff4a2c524bc2118acb694d5d25", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "d747ad50df0926969025d4aaa60d0c47b7ca2602" }))
    ];
    const ariaLabel = this.getAriaLabel();
    return h(Host, { key: "38dbbe9a89ab0a1063063d986c107eb0b4ecb92d", class: {
