import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-C4tOo1JZ.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "9a21dd00faf48cd80ae13e84af47e09135f35ff8", ...a11y, "aria-disabled": disabled }, h("div", { key: "d94f8f4756bc8fc6484adde5928020dd0d024b41", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "9e3ca61924cca20b05afe9a9839be43ff4d4df0c" }, h("input", { key: "5a237001c511dbfd0b7fb21a6b5986e07fab0915", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "0e597ad0b6dbadad5097258e6e5ebf8cca4cd409", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
