...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "b40ae3d2505764659681551aaab811b4c8bfcc6f", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "5985f073d9b74b75838b3e592fe5254dfec3ea11", class: "dialog-backdrop" }, h("dialog", { key: "372dd029f7d41622559568d99fe28608e1806cab", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "405cfdcead12f17c5bc3534d9d160fddd69106a7" }))));
  }
};
