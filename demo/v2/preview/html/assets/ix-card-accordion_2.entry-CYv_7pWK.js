...
const CardAccordion = class {
  ...
  render() {
    return h(Host, { key: "6ab37d107ccca9e0d342653a80b4ebb05f838bf6", slot: "card-accordion", class: {
      [`variant-${this.variant}`]: true
    } }, h("button", { key: "c2d9f8703cd03d006a1f0a10488c65df7f25d07d", tabIndex: 0, class: { "expand-action": true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, h("ix-icon", { key: "e52734bc0d748eb648737af3ecff9c809ec5f7eb", name: iconChevronDownSmall, class: {
      "expand-icon": true,
      show: this.expandContent
    } })), h("div", { key: "0f000ebd3e93623fe4c0cf9c3c322f98bc79c23d", class: {
      "expand-content": true,
      show: this.expandContent
    } }, h("div", { key: "1bdc7c69f1c256e509a4b6c55e99eeb1c2959f40", class: "expand-content-inner" }, h("div", { key: "c9d502bdbb504f220a2c89831ef102916cd2dbcc", class: "expand-content-body" }, h("slot", { key: "647904aa76abd086e3ff80970cdee286c8fb1cf9" })), h("div", { key: "5fdbf86a8769e2cca9f2174eafd4e7e80e6058a3", class: "expand-content-footer" }))));
  }
  static get watchers() {
    return {
      "collapse": [{
