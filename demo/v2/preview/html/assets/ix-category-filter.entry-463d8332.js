...
import { B as BaseButton } from "./base-button-BfH8hAk6-2fab76a5.js";
import { L as LogicalFilterOperator, I as InputState } from "./logical-filter-operator-BH3f5fa3-cf778d91.js";
import { k as iconClear, l as iconSearch } from "./index-C0zeM1D4-b0cf2da8.js";
...
const CategoryFilter = class {
  ...
  render() {
    var _a, _b, _c;
    return h(Host, { key: "47c000efc53f818cff73d6c64132867b1ab755ae" }, h("form", { key: "d296ae211d92cc87a85b5bbc37d1f07d4fd33c55", ref: (el) => this.formElement = el }, h("div", { key: "9202320d5d06623390d4db817fd804ad16dcac15", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "e116cd48676265199c364d457ecc0f4cf2b3d2d0", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, size: "16" }), h("div", { key: "dd4b3d6ad0af7748a08d4e2c4d6c45758e58cc81", class: "token-container" }, h("div", { key: "1153ed14f68eeb76b4f0741b9b488ca2fd9c95ff", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label), h("input", Object.assign({ key: "9ce262967c8b4b2fa6d2d60a9f709c1a85b3db0d", class: {
      "text-input": true,
