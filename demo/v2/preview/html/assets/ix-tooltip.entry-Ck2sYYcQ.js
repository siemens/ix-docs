...
const Tooltip = class {
  ...
  render() {
    return h(Host, { key: "0c5234ef90749fc655fcfe1b207ff07a56542c9a", role: "tooltip", class: { visible: this.visible } }, h("dialog", { key: "0d47ccccc273824891784dea6985f8d465bbb97a", ref: this.dialogRef, id: "tooltip-" + this.instance, class: "dialog", popover: "manual", inert: !this.visible }, h("div", { key: "3c2b83f9d07786a69d8defe6942eb47e2c92bf72", class: "tooltip-container" }, h("div", { key: "799cc98634dcded6644c8b556d5f9dbc58bea809", class: "content-wrapper" }, h("div", { key: "760197461d8959ae1a04f827435f925359f54e04", class: "tooltip-title" }, h("slot", { key: "f5316e309883dac441181c3ffe05594e1a2a9034", name: "title-icon", onSlotchange: (e) => this.handleTitleIconSlotChange(e) }), h("ix-typography", { key: "9e9b3a4390f4e586b91ae2ce1bbd94bc53d432c1", format: "h5" }, this.titleContent, h("slot", { key: "1e05a5984ce3638bdea2bdbea322e505b8211495", name: "title-content" }))), h("slot", { key: "b74f4b6142b68920fc74029d751521b6c4faf706" }), h("div", { key: "26a4a736c0f1dbedaf788472a7232cefc095c8a8", class: "arrow" })))));
  }
  get hostElement() {
