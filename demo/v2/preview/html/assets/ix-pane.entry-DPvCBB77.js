...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "c45ad4fd29e16e5f46c3c70f38de8ab9f0a0d7aa", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "b94f040d8f8b946ccbeee3a82f6b0bc7f91c577a", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "3d51c73e216e3b01180c4e0dfe947877048349e5", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "12deda2f4f2bb152219978ccaaf406053ee41fcd", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "b558daf039f854eb117546b28240d4210be63b7d", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "ab960e6a13501ea183cbf6e895caa09db2f0d9cc", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "758c8e79b43b92d4e6f41cf0b8160c7e88907dd1", class: "title-text-overflow" }, h("ix-typography", { key: "ce44dd43cce7fb87b67a399fca59966f930c5f7b", format: "h4" }, this.heading)), this.expanded && h("div", { key: "7852834d69d61f88dd693735b89cf12a6e84c6fe", class: "slot-header" }, h("slot", { key: "87e48a24d37db1c321551b3baddb72fc0ef84fef", name: "header" })))), h("div", { key: "101c8db07123bb436d272c7d1ed9b1894c153c5d", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "16c6261f2344f650c161dd1afe6f37fa5e3178e8" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
