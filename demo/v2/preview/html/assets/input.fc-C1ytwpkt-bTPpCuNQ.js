import { h } from "./global-7ZbTfMw3.js";
import { a as a11yBoolean } from "./a11y-DAzBNVe7-CO1Uj69l.js";
import { s as shouldSuppressInternalValidation } from "./validation-CTBekLDe-sG9H3Ujv.js";
...
function TextareaElement(props) {
  return h("textarea", Object.assign({ id: props.id, readOnly: props.readonly, disabled: props.disabled, maxLength: props.maxLength, minLength: props.minLength, cols: props.textareaCols, rows: props.textareaRows, ref: props.textAreaRef, class: {
