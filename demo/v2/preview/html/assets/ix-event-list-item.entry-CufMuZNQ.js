...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "e89ec7112eae8f95be0f4b6c8bebe08849c7eeee", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "b13673e69dd5af2704188bace4730f22ffdbf365", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "c8d2a9d3ab952ae71d3d6332053351e2767c1684", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "8907cb8546dd65841019a429f902a8f52001da1d", class: "event-list-item-container" }, h("div", { key: "ab647037d3f2f42f9b2617911b4a57914bf54061", class: "event-content" }, h("slot", { key: "1f02bd2896c932efe66d79219ee9b62e170081b8" })), this.chevron && h("ix-icon", { key: "d70b40c9fd33e2adaa6f4069d54f57ff1a8db500", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
