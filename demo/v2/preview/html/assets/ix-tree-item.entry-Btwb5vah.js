...
const TreeItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "f59b4c0d450339118b34d3b61b340a10ca988930", class: {
      selected: !!this.context?.isSelected,
      disabled: !!isDisabled
    } }, h("div", { key: "d2a671021cc391d53bd120b81a436a84aded80b7", class: "icon-toggle-container" }, this.hasChildren ? h("ix-icon", { name: iconChevronRightSmall, size: "24", class: {
      ...
      e.stopPropagation();
      this.toggle.emit();
    }, "aria-label": this.ariaLabelChevronIcon ?? (this.context?.isExpanded ? "Collapse tree item" : "Expand tree item") }) : null), h("div", { key: "9f8858524c797a1bccc7f282fd916024f660b09b", class: "tree-node-container", onClick: () => {
      if (isDisabled) {
        return;
      }
      this.itemClick.emit();
    } }, h("div", { key: "b0f742b8aeea57c22eefe520e0bff25dabe49b40", class: "tree-node-text" }, this.text), h("slot", { key: "d18611d1682b05902d218993d2733f86be879b74" })));
  }
};
