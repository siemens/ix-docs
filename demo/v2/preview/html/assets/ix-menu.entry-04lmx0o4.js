...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "5f6815b9abd45243d81f776dd85efd9aab656588", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "7015050bc75040e5b8108a69192a1bdcbff57846", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "3a114469dd32955a38cdca3a5e2e03cd5b2471db", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "89f1c89efa15f828a257d275850dd26de4ee36b2", breakpoint: this.breakpoint, expanded: this.expand, "i18n-expand": this.i18nExpand, "i18n-collapse": this.i18nCollapse, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "469adcac94c793d8d23296a97037e33027ef6101", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "d7845606dc164ac287c1eb9fbbbc5182df51b3d6", role: "menubar", "aria-orientation": "vertical", "aria-label": this.i18nAriaLabelMenu, "aria-description": this.i18nNavigationHint, class: {
      "menu-navigation": true,
      "menu-navigation--fill": this.shouldFillMenuNavigation
    }, tabIndex: 0, onKeyDown: (e) => this.handleMenuKeyDown(e), onFocusin: (e) => this.handleMenuFocusIn(e), onFocusout: () => this.resetRovingTabIndex() }, h("div", { key: "a9b2b9fb987fe35e89c79d48084188d352186a5d", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "9873540581ae3a56946aa25df1226f49cd8263dd", class: "tabs-shadow-container" }, h("div", { key: "455bab2823a08e5986b49cddee42f4ab6693fdf5", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "f9bfcef1a3c9da55668a9fcd3d1525eb93027c7a", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "02b8d8fc871e63599af9da6671add34cdb6d44e9", class: "menu-avatar" }, h("slot", { key: "d09ba12af87e88c37ef4191a93cf34e020b81697", name: "ix-menu-avatar" })), h("slot", { key: "a5ba3a6342eb7fed67c335ce3e78827c5177cc00", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "e1a3055be90a4db89191c93fccd7639191864c92", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "47ad3e4151532503b1615f09bd72ce817ac9cf78", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "06f18d87d99292f05df3456f0b6fb51df2635a4d", name: "bottom", onSlotchange: () => this.updateBottomSlotState() })), h("div", { key: "538aa364e048d96ecca787ce0e38e8307af99ef5", class: "bottom-tab-divider" }), h("div", { key: "3452cd5dcea04f81b23fe9ee7d761dcd8f34936f", class: "menu-utility-controls" }, this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
    ...
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-haspopup": "dialog", "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null)), h("div", { key: "b5b1d58232534c81c79591bf0df1c5e508551394", id: "popover-area" })), h("section", { key: "e8b48131b814163ab7c23637e55b6991b7e2a3cb", id: "menu-overlay", role: "dialog", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "10e5137c8069b962c9114033c404f54bb9c60a63", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "975b5fdb40e76a00061e9e9744a53df4ea2055fb", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
