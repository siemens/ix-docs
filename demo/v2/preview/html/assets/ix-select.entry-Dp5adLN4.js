...
const Select = class {
  ...
  render() {
    ...
    } }, h("div", { key: "58d7051c6e884dc714643dcf974f7424b4581dfb", class: "input-container" }, h("div", { key: "be6fec6f27345d8033b9b56ca3760c953951b801", class: "chips" }, this.isMultipleMode && this.items.length !== 0 && (this.shouldDisplayAllChip() ? this.renderAllChip() : (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => this.renderChip(item))), h("div", { key: "a9b0c66c623856ab4b2c34f136bbef89a4b3377f", class: "trigger" }, h("input", { key: "1920a23f38ce924fae991be2b5c4a760031aae1f", autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
