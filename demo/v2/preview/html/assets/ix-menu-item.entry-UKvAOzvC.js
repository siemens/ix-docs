...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "2c1c698aadcb3dd8090c067c3dd746e8a9baaf93", class: "tab-icon", name: this.icon }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "c02f479113a2c1914df317d21561b657acf6af92", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "33f38c81be26d10edc993efd1a7434e04678e2c1" }))
    ];
    return h(Host, Object.assign({ key: "58699b09d27cd2caa4d688378e1bd274b9467ee7", class: {
      disabled: this.disabled,
      "home-tab": this.home,
      "bottom-tab": this.bottom,
      active: this.active,
      "tab-nested": this.isHostedInsideCategory
    } }, extendedAttributes), this.href ? h("a", Object.assign({}, commonAttributes, { href: this.disabled ? void 0 : this.href, target: this.target, rel: this.rel, role: "button", ref: this.buttonRef, onClick: (e) => {
      if (this.disabled) {
        e.preventDefault();
        e.stopPropagation();
      }
    } }), menuContent) : h("button", Object.assign({}, commonAttributes, { ref: this.buttonRef }), menuContent), h("ix-tooltip", { key: "f7d1c226c4cde303427a1b38c85bdf93693807b4", for: this.buttonRef.waitForCurrent(), placement: "right", showDelay: 1e3, interactive: false, "aria-hidden": a11yBoolean(this.ariaHiddenTooltip), "aria-labelledby": this.internalItemId }, this.tooltip));
  }
  get hostElement() {
