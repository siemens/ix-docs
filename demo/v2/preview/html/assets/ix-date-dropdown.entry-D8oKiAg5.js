...
import { B as BaseButton } from "./base-button-hppF0uUM-BayQ2Iat.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "04bd340613c20abbe3b836dab11637d7991fd295", onFocusout: (event) => {
      const relatedTarget = event.relatedTarget;
      if (!relatedTarget) {
        return;
      }
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "a95f89b7d276e96aebd318e2d8ca100d113d599a", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "45614c12ee610cda3ddf8cbc740a0df76ed33cc0", focusTrapOptions: {
    ...
    } }, h("div", { key: "074b28feb93dea7482763f380870b0755a752419", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "25983a11b1ac61f12b4bbd140871bae70b3a813f", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "1090e03e941d7a3914e3d4e3f3850bebe195f2ec", class: "picker-wrapper" }, h("ix-date-picker", { key: "fd864d0454c857db7016e3d2ed9322617fbc79eb", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "bdd9ca166ed48d1e0599e5e9b0da38ac6f3c1b18", class: "pull-right" }, h("ix-button", { key: "3fd556de5401f53c83804665669c0c9f42ce6821", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
