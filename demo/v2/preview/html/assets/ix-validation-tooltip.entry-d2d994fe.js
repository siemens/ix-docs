...
const ValidationTooltip = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return h(Host, { key: "b586c3d1d0276ecd3ead14030e1f78cdad3ead3b" }, h("slot", { key: "862f78201e71d813c28dc4b2ac6c5b55e3999d09" }), h("div", { key: "dc29cfa03fadcf9b89e55b1eff045468dc960cb8", role: "tooltip", style: {
      display: "none",
      position: "fixed",
      top: "0",
      left: "0",
    ...
    }, class: "validation-tooltip text-default" }, this.message, h("slot", { key: "21b01e460ecd9d9e31ef107d122280c3a102fa9d", name: "tooltip-message" }), h("div", { key: "0b65406099e5128c6dc5624029442e53740fdd05", id: "arrow" })));
  }
  get hostElement() {
