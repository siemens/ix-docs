...
const DropdownHeader = class {
  ...
  label;
  render() {
    return h(Host, { key: "63b4eb22a2aab032a71925d57c534d278bdf74c9" }, h("ix-typography", { key: "bae57293ab2bf9a0bf1e3c60edc4df7b8e7ef17d", class: "category-text", format: "h5" }, this.label));
  }
};
