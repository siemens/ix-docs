...
import { F as FocusVisibleMixin } from "./focus-visible.mixin-CaRK3Ex_-aQWDITZS.js";
...
const Dropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "eebc7297596d43ef67c3461ae0a74fbf9e5c3917", ...ariaAttributes, "aria-modal": "true", "data-ix-dropdown": this.dropdownElementId, "data-ix-focus-trap": true, class: {
      "dropdown-menu": true,
      show: this.show,
...
const DropdownItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, FocusVisibleMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "f1c9bb57644764f6787c20fb7fe12e8d2e757d8c", id, role: this.itemRole, "aria-disabled": a11yBoolean(this.disabled), "aria-label": this.hostElement.ariaLabel ?? this.ariaLabelButton, class: {
      hover: this.hover,
    ...
    }, ...submenuAriaAttributes }, h("div", { key: "7b2bba29e4d206d6bcd3698c86a614b7c89040f4", class: {
      "dropdown-item": true,
      "no-checked-field": this.suppressChecked,
      disabled: this.disabled
    } }, !this.suppressChecked ? h("div", { class: "dropdown-item-checked" }, this.checked ? h("ix-icon", { "aria-hidden": "true", class: "checkmark", name: iconSingleCheck, size: "16" }) : null) : null, this.icon ? h("ix-icon", { class: "dropdown-item-icon", name: this.icon, "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "9e7eaec28999e3d461e1cef864de78430e79687e", class: "dropdown-item-text" }, this.label, h("slot", { key: "9995e3e812948823f2d0bcfc81522626d550a0bd" })), h("div", { key: "dd1f0367cf02891353a150b5b93eb7408435a0c9", class: "dropdown-item-end" }, h("slot", { key: "86e9ad8d4950f020309abad73c151038bf3344c2", name: "end" }), this.isSubMenu ? h("ix-icon", { name: iconChevronRightSmall, class: "submenu-icon" }) : null)));
  }
  static get watchers() {
    return {
      "ixFocusVisible": [{
