...
import { m as mapValidationResult, b as addDisposableChangesAndVisibilityObservers, c as adjustPaddingForStartAndEnd, e as checkInternalValidity, h as getAriaAttributesForInput, a as SlotStart, I as InputElement, j as onInputBlurWithChange, o as onEnterKeyChangeEmit, k as onInputFocus, d as checkAllowedKeys, S as SlotEnd } from "./input.fc-DjE-oOZc-B8Pp-tRP.js";
...
const Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "e5c0380187e14c515c1920ff753f02d954b0c468", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "00ae4da738996eb5fb3fceb3fd2f4bf8f293fd5c", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "ed44a7d89133fcb9ce2574346364212ddbe13630", class: "input-wrapper" }, h(SlotStart, { key: "f6e0cf1aaa1bb3a945882d89356efd2e15be20df", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "a0263a3186ba0aed9dc7f873f209e32008571336", id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), onFocus: () => onInputFocus(this, this.value), onEnterKeyChange: (event) => onEnterKeyChangeEmit(event, this, this.value), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
      onInputBlurWithChange(this, this.inputRef.current, this.value);
      this.touched = true;
    }, ariaAttributes: inputAria, form: this.formInternals.form ?? void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "ddaf9b30b725f84934c937711cdd5cc6aa4e564b", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "216ce61735239e8b67f767ec08a37976a03ed74b", color: "color-weak-text", class: {
      "password-eye": true,
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "e90d202b3bd47dfd3056c1140f2cabb6aea4e82a", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, (this.value ?? "").length, "/", this.maxLength)));
  }
