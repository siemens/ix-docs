...
const DropdownButton = class {
  ...
  render() {
    ...
    return h(Host, { key: "2232add1b732f43028df1725baa05a08ce025b69", "aria-disabled": a11yBoolean(this.disabled), class: {
      disabled: this.disabled
    }, ref: this.dropdownAnchor }, h("div", { key: "0bbbbef21fd826b770c8231e449dd5beb9d799e1", class: "dropdown-button" }, this.label ? h("ix-button", { variant: this.variant, disabled: this.disabled, alignment: "start", ariaLabelButton: (_a = this.ariaLabelDropdownButton) !== null && _a !== void 0 ? _a : this.dropdownShow ? "Close dropdown" : "Open dropdown", tabIndex: this.disabled ? -1 : 0 }, h("div", { class: "content" }, this.icon ? h("ix-icon", { name: this.icon, size: "24", class: "dropdown-icon" }) : null, h("div", { class: "button-label" }, this.label), h("ix-icon", { name: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, size: "24" }))) : h("div", null, h("ix-icon-button", { icon: this.icon, variant: this.variant, disabled: this.disabled, tabIndex: this.disabled ? -1 : 0, "aria-label": (_b = this.ariaLabelDropdownButton) !== null && _b !== void 0 ? _b : this.dropdownShow ? "Close dropdown" : "Open dropdown" }), this.getTriangle())), h("ix-dropdown", { key: "656053246dbf11c11da0cd70114b2fdb107cc320", class: "dropdown", trigger: this.dropdownAnchor.waitForCurrent(), placement: this.placement, closeBehavior: this.closeBehavior, enableTopLayer: this.enableTopLayer, onShowChanged: this.onDropdownShowChanged }, h("slot", { key: "feeae55a471643b170804911b9fdf5107a70ec7e" })));
  }
  get hostElement() {
