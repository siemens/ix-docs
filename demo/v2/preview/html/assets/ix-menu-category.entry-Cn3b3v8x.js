...
const MenuCategory = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "e775a045a05963df9bf1cad8af41cde3ba0024fc", class: {
    ...
    } }, h("ix-menu-item", { key: "55481bde3309e80823c3e1efcbd079b4c149607f", "aria-haspopup": "true", "aria-expanded": this.showItems || this.showDropdown ? "true" : "false", ref: this.categoryParentRef, class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onKeyDown: (event) => this.onKeyDown(event), tooltipText: this.tooltipText, isCategory: true }, h("span", { key: "5d12c486d64aa42633db1250016d8471c9f4d63a", class: "category" }, h("span", { key: "3a7b5b3cb0bb27a140ea0d3522aa4b0735aff00b", class: "category-text" }, this.label), h("ix-icon", { key: "2fffdfadde0f86b453746cd785a69bcf72523f92", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "005a89c89004c7cf7a7f6621fbcdcf19f1d98fb6", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    }, role: "menu", onKeyDown: (e) => this.onMenuItemsKeyDown(e) }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "b8fbeea12f40ad51d832be57644672f69a2c61fb", ref: this.dropdownRef, hostRole: "menu", "aria-label": this.label, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail: dropdownShow }) => {
      if (dropdownShow) {
        return;
      }
    ...
    } }, h("ix-dropdown-item", { key: "cec1683aa36e2c5db9abe748e6fcb2f901b61028", class: "category-dropdown-header", tabindex: -1, "aria-hidden": "true" }, h("ix-typography", { key: "ea96b374abdc5e8dd79ac993782749bc217bfd0a", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "aa0cae17e78ddcaa6db6822c3f3e27ca35977e07" }), h("slot", { key: "8fe5b81ea58e6f9ec316c06f002a5ff84552d3ff" })));
  }
