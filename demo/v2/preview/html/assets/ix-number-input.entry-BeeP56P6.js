...
import { m as mapValidationResult, b as addDisposableChangesAndVisibilityObservers, c as adjustPaddingForStartAndEnd, e as checkInternalValidity, j as onInputBlurWithChange, a as SlotStart, I as InputElement, o as onEnterKeyChangeEmit, k as onInputFocus, d as checkAllowedKeys, S as SlotEnd } from "./input.fc-DjE-oOZc-B8Pp-tRP.js";
...
const NumberInput = class {
  ...
  render() {
    ...
    }, onBlur: this.handleBlur, form: this.formInternals.form ?? void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "c0a582046240d94de487cc139d37ac83a511c2bb", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("div", { key: "aa9d15adc8f79e39fbc334d446427f4350f04584", class: {
      "number-stepper-container": true,
      "container-hidden": !showStepperButtons
    } }, h("ix-icon-button", { key: "01fec50d28065398e09d1916c6d46950d76f6376", variant: "subtle-tertiary", icon: iconMinus, size: "16", class: "number-stepper-button step-minus", "aria-label": "decrement number", onClick: () => this.handleStepOperation("down") }), h("ix-icon-button", { key: "bf4ec84bc355505671c9d6938f2d94b4ed2b5cf0", variant: "subtle-tertiary", icon: iconPlus, size: "16", class: "number-stepper-button step-plus", "aria-label": "increment number", onClick: () => this.handleStepOperation("up") }))))));
  }
