...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "38a5132a44f733662ff6b744cb4469595df3d2b9", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "2505290137ef4bf9771119b347c95896afd3bfb2" }, h("div", { key: "774c09d5a0bb29a13cf6fb091e912f81d17e3ea8", class: "radio-button" }, h("div", { key: "1a44e92780fa8fa8ecee253400b23febfa3de481", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "e2e26bd36cbc7c94be84fed124f30dda3aee4086", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "c96621fb5011671d18b32d38bb619585ba2aaa35", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "849c0c96db14348798bb2ca509e3e828dfd40600" }))));
  }
