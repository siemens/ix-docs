import { M as Mixin, a as registerInstance, g as getElement, h, H as Host, c as createEvent, r as readTask } from "./global-DjWMysHf.js";
...
import { B as BaseTabMixin } from "./tab.mixin-2hU1i4Yk-CgX2Dde7.js";
import { q as queryElements } from "./focus-utilities-DnaItyVQ-Degzwldb.js";
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-CBuZQFB--BMwxaZnz.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "7b8f2661c2d2cd4f9d4e71631cfed268167adb5b", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "319eb41667d05e12400f933aa71387476b2e1892", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "34124123e8411fd9eb1ae957dd6b7d70c115c041", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "6b9b25474bfc28109676a60a15d7f13601c5946e", class: "slot-container" }, h("slot", { key: "0d05a9372c9d11ed5cb5f28b618ef3c0b91d31c4", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "38ee3ed8b3819d38144608d31446ba60f32658b3", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "d5273f2315118f712fc4c25d3d286dca1166fb73", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "52cfcee729debba7d264af7ff4d4ea030575925e", name: this.icon, size: "24" }), h("slot", { key: "b5e14c4b4cb69b1bbb4caa5c15c4355db8caf510" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "827b6cd5390799f361f726a455d94c58f9a542c1", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "9be6aeb959a037a951cd7b108eb3d217e1504dc1", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "62f22936b12a97234c2ec3d5210e7d3f2435fa11" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "023ac330510e532464624dd78ea8bf3fd06922f0", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "98ce5d4ee78b06cd252ab0550b3be543d17df4d7", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "c00ea1fc9869cbd4d503b1060b8161812e69c1df", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "693c87dc0f9b96e5a18ddb2d84ddc71c94ef29b0", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "b76d32b5429e62d1d11808901e828c3630685f83", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "cf4ab3c93c03ca431b2b46a24bf767f723691f44", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "9d185cf8802e1b24f14b591ac99087f9a4acdec9", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "8a697543efbf5c125296d5619e820ea2d1fe26b8" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "7403b1b2d55cecc918a4ab32a7e5b680a12226bd", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
