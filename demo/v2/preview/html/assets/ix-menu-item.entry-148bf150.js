...
import { O as iconDocument } from "./index-C0zeM1D4-b0cf2da8.js";
...
const MenuItem = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "3648cc08079e7f11f45ddb2384ce982f7824ba6b", class: {
      disabled: this.disabled,
      "home-tab": this.home,
      "bottom-tab": this.bottom,
      active: this.active,
      "tab-nested": this.isHostedInsideCategory
    } }, extendedAttributes), h("button", { key: "7699603b8ee0b3378f7e9fb9d0d7c2586d3b3395", class: "tab", tabIndex: this.disabled ? -1 : 0, ref: this.buttonRef }, this.icon && h("ix-icon", { key: "3a00dc4582a75c07536b4c378403a2949799eee7", class: "tab-icon", name: this.icon }), this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null, h("span", { key: "0a7b4e3850cad1bbde9c2178bbd19122afc976b6", class: "tab-text text-default" }, this.label, h("slot", { key: "e388c447f912fd9603cd6e341cdd515653d87b10" }))), !this.isCategory && !this.isHostedInsideCategory && !this.menuExpanded && h("ix-tooltip", { key: "407add64b247de7feba7e0b30c9e9f7f3c33d3b3", for: this.buttonRef.waitForCurrent(), placement: "right", showDelay: 1e3 }, this.tooltip));
  }
  get hostElement() {
