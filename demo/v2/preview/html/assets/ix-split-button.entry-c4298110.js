...
const SplitButton = class {
  ...
  render() {
    ...
    return h(Host, { key: "01c697593a2d6f066839ced3c3287cdbdd064caf" }, h("div", { key: "bb3e9858ea89016e6fa805bd7a4503ad907d746e", class: { "btn-group": true, "middle-gap": !this.outline } }, this.label ? h("ix-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e) }), this.label) : h("ix-icon-button", Object.assign({}, buttonAttributes, { icon: this.icon, onClick: (e) => this.buttonClick.emit(e) })), h("ix-icon-button", Object.assign({ key: "c3c698593c7d81d63b59d929b4a92e373f7b81ff" }, buttonAttributes, { ref: (r) => this.triggerElement = r, class: "anchor", icon: (_a = this.splitIcon) !== null && _a !== void 0 ? _a : iconContextMenu }))), h("ix-dropdown", { key: "77c4e9dc56023629bc3543d96ac3fe5a982138ee", ref: (r) => this.dropdownElement = r, closeBehavior: this.closeBehavior }, h("slot", { key: "cd981e09bc72b9c36d2011137ed5e336c61c1d0f" })));
  }
  get hostElement() {
