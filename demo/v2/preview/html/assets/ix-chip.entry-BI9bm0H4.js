...
const Chip = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "fb0bdb2d7e9042b738534485b9a061d02b46ccf2", role: this.getHostRole(needsGroupRole), class: {
      inactive: this.inactive
    } }, h("div", { key: "ac5c890cc499cc2fa835826ec0a6ef615334cc71", ref: this.containerElementRef, class: wrapClasses, style: customWrapStyle }, h("button", { key: "e60254d5485bd02877dd115e07a8591b2ed92df6", type: "button", class: "chip-main", ...this.inheritAriaAttributes, disabled: this.inactive, style: customMainStyle }, h("div", { key: "dd5313f7aab3494be6651eeac948bc3b741f349b", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "cffde7c889b2cf176bd4b663f7d7c818147959ba", class: {
      "with-icon": true
    }, name: this.icon, size: "24", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative), style: this.getIconStyle(variant) }), h("span", { key: "db3887d98ddf485d5763360d3911b04e65bd993b", class: "slot-container" }, h("slot", { key: "ebd75fd75b61b68ae066d3070025ffbc60dccb40" })))), this.closable && h("button", { key: "a635317fbce69bfb8df673f0784618c2203bf4e2", type: "button", class: "chip-close", "aria-label": this.ariaLabelCloseButton, onClick: (event) => {
      this.closeChip.emit(event);
      event.stopPropagation();
    } }, h("ix-icon", { key: "8c82a81006d96f6e67bdb42ef1eb82381660a1bc", class: "chip-close__icon", name: iconCloseSmall, size: "16", "aria-hidden": "true" }))), this.getTooltip());
  }
  static get watchers() {
    return {
      "role": [{
