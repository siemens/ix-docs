...
import { B as BaseIconButton } from "./base-icon-button-DufFLJC--BeX6_6vT.js";
...
import "./base-button-DZdtpLxn-BH2mB44j.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "2e94f45af8e808b3e503ad20704bc3953b923316", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "c1a1a4e8bf780bc8bfb33c039bebda99b15cacfb", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "236bf23ec447ee60e3d328f3b90c8fc53a2a249b", ...ariaProperties }, h("div", { key: "7d6c7fdd2167cf509ef6bb1dfec369b4bedeee14", class: {
