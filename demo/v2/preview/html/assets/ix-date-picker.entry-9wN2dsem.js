...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "7de4a5edbe8988dcae7cd6f640ca4d5db58515f5", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "efae993810b8c99e7093d99afff4585ad157f09d", corners: this.corners, embedded: this.embedded }, h("div", { key: "b242490e8a186d2891c9f03d167ced3814af2be3", class: "header", slot: "header" }, h("ix-icon-button", { key: "23980a73c3296a4346d545c6ef6d34759a228f9f", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "ef74172fffd395ae5dd84b926b6ad6ecd07bfc18", class: "selector" }, h("ix-dropdown-button", { key: "40c5bd62bf2600880a003d90b889c9fd9e54e146", class: "month-selector", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "f1a415a1bef4f302de05582bf053c052bad0505a", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "ce5a5b993fd02564d0104e13764418682a77acc4", class: "year-selector", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "d7d93c944877c170728b0aa41085a0ebdf657eac", class: "infinite-scrolling-spacer" }, h("div", { key: "9bdd838a9750150065141302e1e4a5aeaf8b58cc", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "f7adff586df01462d4e164d14f95f85dedb0e63d", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "1b0db1dd2e77538f2a052272afc10bee207d35b9", class: "infinite-scrolling-spacer" }, h("div", { key: "1a324d048c46a7b7a1320f76255c6f251fa7ffe6", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "622614d0cf6eea4b960a69d40fbaee1558c457e7", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "468b8b1a645c376fee7a33f153fc01c24174a048", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "1aef3ab46c009c831c0a46663490dcac49b3f857", role: "row" }, this.showWeekNumbers && h("div", { key: "179664fef0ad9939184a6b9247931cb311f2cc8f", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "64236c8cacbf0c467b6da51e9540e966076f1d46", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "d0bd805434cbb01e8dbbed9fb539ee647b87ead4", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
