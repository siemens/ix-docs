import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, M as Mixin } from "./global-BTgWS9s6.js";
...
const FilterChip = class {
  ...
  render() {
    return h(Host, { key: "f78c6c14ea22791ba39081cf287e86fed7172ca4", class: {
      disabled: this.disabled,
      readonly: this.readonly,
      "hide-close-button": this.hideCloseButton
    }, title: this.hostElement.textContent }, h("div", { key: "260717a791623fde5d0a597fc3933cba4303f80d", class: "slot-container" }, h("slot", { key: "033d4c695b8ee9022ec4ba061fc2200b723484f4" })), !this.disabled && !this.readonly && !this.hideCloseButton ? h("ix-icon-button", { variant: "tertiary", oval: true, icon: iconCloseSmall, size: "16", disabled: this.disabled, onClick: (event) => {
...
const SelectItem = class extends Mixin(...DefaultMixins, FocusVisibleMixin, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "de5fffd688bd95f90e52834f2fb64bd27ccb058e", ...ariaAttributes, id: this.getHostElementId(), disableAriaSelectHandling: true, class: {
      [IX_FOCUS_VISIBLE]: true
    }, "aria-hidden": "true", role: "presentation" }, h("ix-dropdown-item", { key: "095b16a14ef831cf00021f8078124f3885673891", "aria-hidden": "true", itemRole: "option", class: {
