import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, F as Fragment } from "./global-BTgWS9s6.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "b059c2e39c50301922ad5ed51cc4e246aa3e358d" }, h(CardListTitle, { key: "61a6b0c4fd65257a6754ce34d2564f6513709946", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "5a328de0d50c9e5600cf7183145a372edd9f4305", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "29b54713584c4e904f0dd7cb7240588c66efaddf", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "cf8bc87f8b737a784317993f72a9bcfb45a2db15", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
