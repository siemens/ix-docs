...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "5df489d50a9e459fcf350fcaf20dad2f3c6d09d8", onFocusout: (event) => {
      const relatedTarget = event.relatedTarget;
      if (!relatedTarget) {
        return;
      }
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "9de1225750e827a48370d77b643accbf717b5c90", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, class: { active: this.show }, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "5adea2a62d0f2936c7f414d07e4b215fa46013c7", focusTrapOptions: {
    ...
    } }, h("div", { key: "529789401a81e427362891c8067dceef2d792ccd", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "37357e44ca576b728da92a56b168441660298ad3", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "78ba6a786dd6c0f4eab6158c44bca11d8ee3b8a5", class: "picker-wrapper" }, h("ix-date-picker", { key: "17bd8255602531babe2f71e2db5ffac8bb2b7b2f", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "bedbd4ed054f58030718054a601b0ba9215ded11", class: "pull-right" }, h("ix-button", { key: "05cb78d1a4e407390c00abad740a4516b6fd10fb", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
