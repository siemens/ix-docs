...
import { c as createPickerValidityStateTracker, j as onEnterKeyChangeEmit, h as handleSubmitOnEnterKeydown, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, S as SlotEnd, o as onInputBlurWithChange, d as SlotStart, e as emitPickerValidityState } from "./input.fc-CE3kP-L_-Djevl-Xp.js";
...
import { I as InputPickerMixin, h as handleIconClick, o as openDropdown, c as closeDropdown, a as createValidityState } from "./input-picker.mixin-DudWFH-e-gr3UJgiS.js";
...
import { c as createClassMutationObserver, g as getValidationText, H as HookValidationLifecycle } from "./validation-VVt5EFy0-CDNoT5VG.js";
...
const TimeInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "ad852f1bdf16618d065d1fbab17420c11b3e5915", class: {
      disabled: this.disabled,
      readonly: this.readonly
    }, onFocusout: () => {
      this.closeDropdown();
    } }, h("ix-field-wrapper", { key: "cf0d1f5e6fef2a1391ca1fb9b748eb7c75af3d18", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "51ba0327ea62439e121ffbc1f6aa8a6a69564481", "data-testid": "time-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    }, focusTrapOptions: {
      targetElement: this.timePickerRef,
      trapFocusInShadowDom: true
    } }, h("ix-time-picker", { key: "9d994dfdd9b7d58ba305dcff031397a3486a5d64", ref: this.timePickerRef, format: this.format, time: this.time ?? "", minTime: this.minTime, maxTime: this.maxTime, hourInterval: this.hourInterval, minuteInterval: this.minuteInterval, secondInterval: this.secondInterval, millisecondInterval: this.millisecondInterval, embedded: true, hideHeader: this.hideHeader, i18nConfirmTime: this.i18nSelectTime, i18nHeader: this.i18nTime, i18nHourColumnHeader: this.i18nHourColumnHeader, i18nSecondColumnHeader: this.i18nSecondColumnHeader, i18nMinuteColumnHeader: this.i18nMinuteColumnHeader, i18nMillisecondColumnHeader: this.i18nMillisecondColumnHeader, onTimeSelect: (event) => {
