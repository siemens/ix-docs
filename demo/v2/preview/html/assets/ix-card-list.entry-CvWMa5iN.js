import { a as registerInstance, c as createEvent, g as getElement, h, H as Host, F as Fragment } from "./global-DjWMysHf.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "72dc154668f2a7ff123cc3ebf874cf40858cca51" }, h(CardListTitle, { key: "841d5b5fca34c925707d161de1e70b32d089841c", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "8f0c772fd5282eac63078c8f7c5873ccf81c08c2", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "504f496228535e8cae45ed92631c33b8be7ba2cc", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "f95b698b9662865eabed3adc1ebed999efe342d2", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
