...
const MenuCategory = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "16e92aa31c97226ac110248e58ee4e8cf6e686cb", class: {
    ...
    } }, h("ix-menu-item", { key: "bfce7e95d4e994a53d20016b1108f26248c19de9", ...inheritedA11yWithoutRole, "aria-haspopup": "menu", "aria-expanded": this.showItems || this.showDropdown ? "true" : "false", id: this.categoryId, ref: this.categoryParentRef, class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onKeyDown: (event) => this.onKeyDown(event), tooltipText: this.tooltipText, isCategory: true, menuCategoryLabel: this.label }, h("span", { key: "1700d1f6d3c93e66ede8e96ab6f6ed126b255220", class: "category" }, h("span", { key: "6f56b33cbf5be34051d2466c9b99d012664ad1c9", class: "category-text" }, this.label), h("ix-icon", { key: "b971ca95e49344cc3f60c72430701c6a8c06a21c", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "36f61ae3b2b0e52fa67380216d46b5386c446f30", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    }, role: "menu", "aria-labelledby": this.categoryId, onKeyDown: (e) => this.onMenuItemsKeyDown(e) }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "a89d90584e563751f4e8c5705be94e2e52cd801a", ref: this.dropdownRef, hostRole: "menu", "aria-label": this.label, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail }) => this.onDropdownShowChange(detail), onShowChanged: ({ detail }) => this.onDropdownShowChanged(detail), class: "category-dropdown", anchor: this.hostElement, placement: "right-start", offset: {
      mainAxis: 3
    ...
    }, onFocusout: () => this.onDropdownFocusOut() }, h("ix-dropdown-item", { key: "437c4dfccac1e17d515cc1095b9b2d2ded520ae6", class: "category-dropdown-header", tabindex: -1, "aria-hidden": "true" }, h("ix-typography", { key: "a72c3c3f9db4d7330f7876518f2e0d26b3718f02", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "f743e54cbdbd27b56030f2a8f44073fe12ea1564" }), h("slot", { key: "37394a8edb8a0eeffa8b2ed4aaeb5d913249f2d5" })));
  }
