...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "f04221cc34cc579df99e90487157323b582ffa88", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "4245387d288d1fe68551ab59ac12af32c977ee96", class: "wrapper" }, h("div", { key: "53fb838a752b34fd73947aaee99abbe6700a9654", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "dc000096dd4bccc837b70861b113727b2fa8511e", class: "slider" })), !this.hideText && h("ix-typography", { key: "c869cdc3cc704a35f82146c69e08f2fce7c50149", class: "label", "aria-hidden": "true" }, toggleText)));
  }
