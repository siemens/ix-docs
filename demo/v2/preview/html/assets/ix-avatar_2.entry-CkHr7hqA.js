import { r as registerInstance, a as readTask, h, F as Fragment, H as Host, g as getElement, c as createEvent } from "./global-CTsFSACc.js";
...
const MenuAvatarItem = class {
  ...
  render() {
    return h("ix-dropdown-item", { key: "ce5740229422012fdbda56f2710f96e869142f6e", ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) });
  }
  get hostElement() {
    return getElement(this);
  }
