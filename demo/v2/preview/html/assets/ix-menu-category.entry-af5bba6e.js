...
import { r as iconChevronDownSmall } from "./index-C0zeM1D4-b0cf2da8.js";
...
const MenuCategory = class {
  ...
  render() {
    return h(Host, { key: "7b9f49da8f9000d9a354399ed3b23ce7a77c8d86", class: {
    ...
    } }, h("ix-menu-item", { key: "0449230bef6f0c02ee8a810001db933218c07a2c", class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onFocus: () => this.onPointerEnter(), isCategory: true }, h("div", { key: "628cc5c46df9102391cdd4de4307216b2ac81611", class: "category" }, h("div", { key: "9060c8e68003d61eb95c70c5ca560c956e0fbfa0", class: "category-text" }, this.label), h("ix-icon", { key: "fc556c90e932c832c7b4ffcc875568ca31ebb006", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    } }))), h("div", { key: "31ea66302fc57c951145d9554cfa3d5eaff51e4b", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    } }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "1f14b33fe7cc99046864967cdea2e9d179f4ef55", closeBehavior: "both", show: this.showDropdown, onShowChanged: ({ detail: dropdownShown }) => {
    ...
    } }, h("ix-dropdown-item", { key: "f3d6dba21e49f3f51db097b07608f6beaf609406", class: "category-dropdown-header" }, h("ix-typography", { key: "897a5726bcb12adbed2e41709f434f3ca68521f9", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "e177cdec54ecfb3e169e6fa8cd602a2f717a0dad" }), h("slot", { key: "2482e6b4fdb74ebcbdd0cd688588eb4e260d29c6" })));
  }
  get hostElement() {
