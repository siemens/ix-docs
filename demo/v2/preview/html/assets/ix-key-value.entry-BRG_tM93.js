...
const KeyValue = class {
  ...
  render() {
    return h(Host, { key: "afb00b426d8c1058f0cbb4f1c36c77f879d4fcc2", class: `keyValue keyValue--${this.labelPosition === "top" ? "column" : "row"}` }, this.icon && h("ix-icon", { key: "f965a5b314912431569919f3d12b03e7ecdd7a7f", name: this.icon, size: "24", class: "keyValue__icon", "aria-label": this.ariaLabelIcon }), h("div", { key: "93a20b20f02409e5229d75f9614024771a1e4062", class: "keyValue__content" }, h("div", { key: "86a788b30e518a4fe26c9f266c79faeb71c2a246", class: "content__label" }, this.label), h("div", { key: "9421c0ff618a40335423c624640556b266cb0744", class: {
      content__value: true,
