import { r as registerInstance, c as createEvent, g as getElement, h, H as Host, F as Fragment } from "./global-C4tOo1JZ.js";
...
const CardList = class {
  ...
  render() {
    return h(Host, { key: "4cb1bcba15f7877fc6d6fda2989a321cff75b21e" }, h(CardListTitle, { key: "e8dd21fcc2faf773fc00b78704743e689674cf1a", isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === void 0 ? this.numberOfAllChildElements : this.showAllCount, showLess: this.isShowingAll, labelShowLess: this.i18nShowLess, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: "36fd2e7fb75fd0e4e7ebaadd6f19aa2e26edbc10", class: {
      CardList__Overflow: true
    }, style: this.computeMaskLayer() }, h("div", { key: "24a16d383eb1af5a329c417a868524d8c55fbc0c", class: {
    ...
    }, onScroll: () => this.onCardListScroll() }, h("slot", { key: "9c07172b248331bbf093808e2873ca56daca17aa", onSlotchange: () => {
      this.changeVisibilityOfSlotChildren();
