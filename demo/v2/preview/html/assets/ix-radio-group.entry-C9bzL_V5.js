...
const RadiobuttonGroup = class {
  ...
  render() {
    return h(Host, { key: "25eec92511036bb23386e7ccd58ed9529a8d6723", onIxBlur: () => this.touched = true, ref: this.groupRef, role: "radiogroup" }, h("ix-field-wrapper", { key: "6651bfac925b36a90036e41dc5c0040a8730a8da", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.groupRef }, h("div", { key: "76d7c9f366118f8d056e94cc079fc23a0b21eea5", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "231e640d7a46d5428b0c8a852c41fe08bbfdbe09" }))));
  }
  get hostElement() {
