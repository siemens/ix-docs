...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "41ccd73336c9313b9a5c4aa47715541e2fb1d9de", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "c42d560569ed349e61c7be56b4489ac6c0cb3547", class: "settings-header" }, h("h2", { key: "795f068e78d63e780e1aea8e989996f4b9806758", class: "text-h2" }, this.label), h("ix-icon-button", { key: "0fc5b175f9ca2b9bc5d9ebf022144c9aef29d9c3", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
