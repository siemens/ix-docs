import { g as getElement, r as registerInstance, c as createEvent, h, H as Host } from "./global-BTgWS9s6.js";
...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, { key: "183f8abe7ec5d6fd3427e01b9b03216fa12d41ac", ...a11y, "aria-disabled": disabled }, h("div", { key: "333b66856dcb9e55b2b2658f260cfbcf00b0323c", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave() }, this.renderUploadState(), h("div", { key: "8934a20d5a8ab01a8e18523d1d533eda1ae47bd6" }, h("input", { key: "44e78de7cc78501f559102f9c11e5def89f357c7", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", ...directoryAttributes, tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "2847f32277c81f54a265e02c0ea03f8301527cad", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile ?? (this.directoryUpload ? "Upload folder…" : "Upload file…")))));
  }
};
