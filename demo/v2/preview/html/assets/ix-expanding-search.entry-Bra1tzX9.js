...
const ExpandingSearch = class {
  ...
  constructor(hostRef) {
    ...
    this.ariaLabelClearIconButton = "Clear search";
    this.ariaLabelSearchInput = "Search input";
    this.isFieldChanged = false;
    this.expanded = false;
    this.hasFocus = false;
  ...
  render() {
    var _a, _b;
    return h(Host, { key: "89dd7b99531c8ccd578ff26517ae2959c3e73c66", class: {
      expanded: this.expanded,
      "right-position": this.expanded,
      fullWidth: this.fullWidth
    } }, h("ix-icon-button", { key: "bf53f12935f7026517f1466383ddd38c4fdb5165", size: this.expanded ? "16" : "24", icon: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, variant: this.expanded ? "tertiary" : this.variant, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? "input-search-icon--color--focus" : void 0, class: {
      "btn-search": true,
      "btn-search--expanded": this.expanded
    }, "aria-label": (_b = this.ariaLabelSearchIconButton) !== null && _b !== void 0 ? _b : this.expanded ? "Close search" : "Open search" }), h("div", { key: "84a10a9fa5599e4c15aeed3e10b4523d7d99d373", class: {
      expanded: this.expanded,
      fullWidth: this.fullWidth,
      collapsed: !this.expanded,
      "disable-pointer": !this.expanded,
      "input-container": true
    }, "data-testid": "input-wrapper" }, h("input", { key: "f4e4779e2db00e5c1b2478853e29748cae03452a", class: {
