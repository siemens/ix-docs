...
const Button = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "d1e348cdda5394f93ae75079322849917e1e040e", class: {
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled || this.loading ? -1 : 0 }, h(BaseButton, { key: "eee6a0b44c096b102d9884e17113559e1f1efb8f", ...baseButtonProps }, h("slot", { key: "c67238c777a2eb84d72739f7b7c7274dffc1ca22" })));
  }
