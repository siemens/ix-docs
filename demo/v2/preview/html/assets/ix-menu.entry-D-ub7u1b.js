...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "449ca7a0f94dfaf9394fdeaaa6e56d974fe9aea8", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "bb57a2c2efc023be57d3d0038c60e62ab8eb6b49", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "0fcf66d57abbaad7223bdd9e5feb4b77bafd9431", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "89c12c219b3fb73b0de5dc6ae3d0c6d10bb64758", breakpoint: this.breakpoint, expanded: this.expand, "i18n-expand": this.i18nExpand, "i18n-collapse": this.i18nCollapse, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "51f3c2912ebb9b09c0af23079c66be10affd6960", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "57d9f0e01c35828de9d4fad3cfdcca2fe517b7be", role: "menubar", "aria-orientation": "vertical", "aria-label": this.i18nAriaLabelMenu, "aria-description": this.i18nNavigationHint, class: {
      "menu-navigation": true,
      "menu-navigation--fill": this.shouldFillMenuNavigation
    }, tabIndex: 0, onKeyDown: (e) => this.handleMenuKeyDown(e), onFocusin: (e) => this.handleMenuFocusIn(e), onFocusout: () => this.resetRovingTabIndex() }, h("div", { key: "59e46b324cbd55621602a2181226bc68d90387e0", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "0de02c5ad2c3542e2d151749f03b3fb146bf2af8", class: "tabs-shadow-container" }, h("div", { key: "5e0d14aa34ed1eeb8e73d584736cadeb61bb8470", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "7155a5ce55051a5af41d9d10846dea97c709195f", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "517ce6c97a8849e3b5fe6fa94709961d405d4c31", class: "menu-avatar" }, h("slot", { key: "88390e60feda388e9a8111e79b3a6dc580b5c245", name: "ix-menu-avatar" })), h("slot", { key: "d78f3b4d691725a0a40900f7ea1320ac9559337f", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "148bb19403ce4054bfc9203daecf9170345cfb44", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "39d0cf6c66d182b50f2e557a3b6a90da69d4ee79", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "cb990a09fb2691d7773acf6da632bce51376a93f", name: "bottom", onSlotchange: () => this.updateBottomSlotState() })), h("div", { key: "864ddfdd85e2262151aea546e9c9c8e754d70d58", class: "bottom-tab-divider" }), h("div", { key: "73ee7628abee073af7f8479e4aba31dc7319ba6d", class: "menu-utility-controls" }, this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
    ...
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-haspopup": "dialog", "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null)), h("div", { key: "cb0da1257fdf75a09a878c5be78065f0936238f1", id: "popover-area" })), h("section", { key: "c0baf0bd660819f8039a0ee8dcf4b7866e80f02c", id: "menu-overlay", role: "dialog", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "22297492769c540256fdf4b508ec8fec904886bf", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "271f5f0e12d342e41d439113e69d5820e885522b", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
