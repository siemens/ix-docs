import { r as registerInstance, c as createEvent, h, H as Host } from "./global-DsITLPyL.js";
...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "a9bcbd4a1f0a240324e1e58dbc6489c1b60d9ffd", class: {
      disabled: this.disabled,
      [`event-list-item-${this.variant}`]: true
    } }, h("div", { key: "40d3bcf6be18cd99e0a3f19355d08122eaca8a31", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "7645085fa71963863fffe8c4a7f85288b563ee99", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "22c9414286ea6f5ac0dbf76af542e62cc41ec1fa", class: "event-list-item-container" }, h("div", { key: "ccd04a3054f1285c9bdcdc8a440b2ce8e626b606", class: "event-content" }, h("slot", { key: "19d3223501c51d391cecbd14c79e660b2880d1d4" })), this.chevron && h("ix-icon", { key: "577a5993cc4b428e76c1a0a23ef7848ce8df0fe5", name: iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))));
  }
};
