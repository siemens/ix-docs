...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "c4fc534271973ace749f101e65f59286d9ac2155", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "2bd30dc064e6f611b8ae14c3d11f108f91dfb8d7", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "86a167bd0b683913f7cba7250f64bd93f6c319a5", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "a46e693b49c0f23214fb8dbd5c089e42652b746f" }))));
  }
};
__decorate([
