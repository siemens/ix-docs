...
const Breadcrumb = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "37f2bfb26bb8702d913b0e08e1f9efd9a87302ea", ...this.inheritAriaAttributes, role: "navigation" }, this.items?.length > this.visibleItemCount && h("ix-dropdown-button", { key: "cf27730357a389142d8649e385e6421135a18fb7", "aria-label": this.ariaLabelPreviousButton, label: "...", variant: "tertiary", class: "previous-button", enableTopLayer: this.enableTopLayer }, h("ix-icon", { key: "cf60a8e89ddda0271644cf1e7121f7859cebedc6", slot: "button-label", name: iconChevronRightSmall, size: "16", class: "chevron" }), this.items.slice(0, this.items.length - this.visibleItemCount).map((item) => {
    ...
    })), h("div", { key: "f54124b5a685d6e7cbba1bd2f83e4175ff28a9b2", class: "crumb-items" }, h("slot", { key: "293ff2dc40f01cf55af9ec10367f1daed671c212" })), this.shouldRenderNextDropdown && h("ix-dropdown-button", { key: "dfc9d903801442df97393e02e0e95b710b22e34f", label: labelLastItem.label ?? labelLastItem.innerText, class: "next-button", variant: "tertiary", enableTopLayer: this.enableTopLayer, "aria-current": "page" }, h("ix-icon", { key: "feccea5c466a8239ea5d8be52c004b376adb257b", slot: "button-label", name: iconChevronRightSmall, size: "16", class: "chevron" }), this.nextItems?.map((item) => h("ix-dropdown-item", { label: item.label, onClick: (e) => {
      this.nextClick.emit({
        event: e,
        item
      });
