...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "18a9d8d27e3da2d36681f0681caeee84ed943efd", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "22db33f534a61abca396ce3c05f30b490327e417" }, h("div", { key: "0ad8548b87a63cded792ad6dee63e4ba018a0aa0", class: "radio-button" }, h("div", { key: "9b8fbaa25b7f4307f4a820a99a80dd3a01272604", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "a8e10d030150643478be8e859e47b7654ecdcdba", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "a0c8ddcf036d2ade8ed14813dff4d3ce8fc664ff", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "35fd78b7b432ced026ac0824f64633f64b8b4441" }))));
  }
