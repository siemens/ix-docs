...
const MenuCategory = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "0b54b4b98d9630b70224a566eb6b6abd86f69139", class: {
    ...
    } }, h("ix-menu-item", { key: "50e63e3d3002e6551336d04e608f8c3f7d51ff3d", ...inheritedA11yWithoutRole, "aria-haspopup": "menu", "aria-expanded": this.showItems || this.showDropdown ? "true" : "false", id: this.categoryId, ref: this.categoryParentRef, class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onKeyDown: (event) => this.onKeyDown(event), tooltipText: this.tooltipText, isCategory: true, menuCategoryLabel: this.label }, h("span", { key: "feeb581bf824de38b25d164e9c8ddabb5afbea51", class: "category" }, h("span", { key: "096f4f45fadd93317bc67be9d449c1d610096155", class: "category-text" }, this.label), h("ix-icon", { key: "03c15e2624ed0580e513c2d361af37f02afd9c9c", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "4c2a38f8d7f63cb0d400983a70c2ca0cbc7d7da9", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    }, role: "menu", "aria-labelledby": this.categoryId, onKeyDown: (e) => this.onMenuItemsKeyDown(e) }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "541fc21db5cf52b0854a517525a636a8bd82d436", ref: this.dropdownRef, hostRole: "menu", "aria-label": this.label, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail }) => this.onDropdownShowChange(detail), onShowChanged: ({ detail }) => this.onDropdownShowChanged(detail), class: "category-dropdown", anchor: this.hostElement, placement: "right-start", offset: {
      mainAxis: 3
    ...
    }, onFocusout: () => this.onDropdownFocusOut() }, h("ix-dropdown-item", { key: "b277224530668e11c773ba48ef6a9c16e65a872d", class: "category-dropdown-header", tabindex: -1, "aria-hidden": "true" }, h("ix-typography", { key: "4727fd4f5311c9aacdf5bf6745c625906e0ea6e5", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "e9aef75055efc7168309041d981596a817e21fc9" }), h("slot", { key: "13c5d736008e47b8359877e3efb7d5db3c4b1018" })));
  }
