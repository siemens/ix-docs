...
import { c as createClassMutationObserver } from "./validation-CTBekLDe-sG9H3Ujv.js";
...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "2d239f9247e418efb8cbd9ecd1b56dfb060fcfcd", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "6ce7a29836eb51925a57f7598fe6eabc5174c1b0" }, h("div", { key: "47df681feb5e8ae432f6c9f58a7b90bd3d304c37", class: "radio-button" }, h("div", { key: "16b634e3893281e6f172b16d91adcbf19799a074", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "d26eb4e6ae16eb5c8e2e046f0396f756d0944f15", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "0ff4f2b18b8474dc5f33543ac6874aedafdba1cc", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "f5b48dcabcd1c5d851e2a4055767cf936d86dd93" }))));
  }
