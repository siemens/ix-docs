...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "b8d17f5af7fe134a6244d2ee7c3c630de0b7bc4f", role: "alert", "aria-live": "polite", "aria-atomic": "true", class: "animate__animated animate__fadeIn" }, h("div", { key: "3d72be10db7039191dfc39e48ab4c9525c68b367", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "5f85fcc437199930bf97018d09ce04691d3c295e", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "1aea698221eed9809125a1edd89a73ba080a62f6", class: "toast-message" }, h("slot", { key: "3c6a838dec067a6e88da09433336d64294349b7a" })), h("div", { key: "c0cdccd9a8bf9b08d3cc8dd482533026b62981eb", class: "toast-action" }, h("slot", { key: "c74f4cfb92d867dbe19a189b2040033fe9f26eeb", name: "action" }))), h("div", { key: "1f8316a4368fe7b53a561376f60b414f03563007", class: "toast-close" }, h("ix-icon-button", { key: "b60f578a28bdf1dd939cebda3066527fb4900c3f", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "0b6edfd0fc364f33165be5145ef09f540e03d841", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
