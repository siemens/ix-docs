...
import { O as OnListener } from "./listener-Dk6XGheN-BHTWfIL7.js";
...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "4e158f7b4af6a8786274b094fcbdc26a00ec19ed", class: {
      disabled: this.disabled,
      invalid: this.isInvalid,
      info: this.isInfo,
      valid: this.isValid,
      warning: this.isWarning
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "a18bd3265b8f50d1a3383b59e70efe0bfb829f39", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "e01718c2e79b41df00aff2cafd6c8e5becdba85d", class: "slider-container" }, h("div", { key: "8b83be7e28cac0484b54768c6283d1d37a74e857", class: "slider" }, h("div", { key: "9fa8db2173cd87de771d6a0d5a2ace01820fe128", class: "track" }, h("div", { key: "46b3b6487f23f4a9219420642587813906c53ce8", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "53a69bb9f7e79558323d7558d60655293a467012", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "e92242dc3fa7207e1d86071369e76178c9ae6ddf", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "aff89362b88b37ec1d9b6bd9f6ba59646dd538a0", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "34feab8797c1338f3063e17e145811ea33518f4e", class: "label" }, h("div", { key: "c95ca806e153beab2c91451859b12c82f2e89a65" }, h("slot", { key: "e49498aba11ed8f8711db171308f4979a942a93c", name: "label-start" })), h("div", { key: "ac2e3855bc845f00f3ac8f79022c767befa2c7ea" }, h("slot", { key: "a21bc3e1329c8467762e5b44801fc8db0868ec13", name: "label-end" }))))));
  }
