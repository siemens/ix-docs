...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "1aebc8f8c0ac09e4a0a01f30ba769f1974958cf9", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "b23730df88ec2d76724c4c7920fa6993a24fe91b", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "dc91ac2d007de0e97ed1ba9d3a6d103b5b05868f", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "19aff43787702fd8cdca2a3d51981538f0d36b38", breakpoint: this.breakpoint, expanded: this.expand, "i18n-expand": this.i18nExpand, "i18n-collapse": this.i18nCollapse, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "7adcf4e6a6436022dcfc61c7512a94229fbcc4bb", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "387bac9de2fec8e79fabf6d1130c4d6b22dd9258", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "bec523ac0b17d45d73c007cd7ca82193c8e25668", class: "tabs-shadow-container" }, h("div", { key: "c69d499b1aac3d5ff2ce3cbacaea89f96873f94b", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "1bf7e6500511ee7404101d110161f105e5f43fe9", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "99f9994c254898d82ad98665881531105b298138", class: "menu-avatar" }, h("slot", { key: "180c3410631d5a78132b89b7e11db4f13d238867", name: "ix-menu-avatar" })), h("slot", { key: "38a1e0ea97e9889dc160be815c46ee4558d4078f", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "338d93258911beb1bf3f98a8df7bde1d24b45b60", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "815181e90fd29218e43d04b1ea4dfc5f9c68cec6", class: "bottom-tab-divider" }), this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showSettings
    }, icon: iconCogwheel, onClick: async () => this.toggleSettings(!this.showSettings), label: this.i18nSettings, "aria-expanded": this.showSettings.toString(), "aria-controls": "menu-overlay" }) : null, this.enableToggleTheme ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: iconLightDark, label: this.i18nToggleTheme, role: "switch", "aria-checked": this.isDarkMode.toString() }) : null, h("div", { key: "5f90277b54ee68fa14b41d210eb52bcb04b72dbb", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "f11a76b89e66b2b5d7068011ee3b076b6464a87a", name: "bottom" })), h("div", { key: "737628853dc8a66a8b3b79bfe835efb37f24bb92", id: "popover-area" }), this.about ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
      "internal-tab": true,
      "bottom-tab": true,
      active: this.showAbout
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null), h("section", { key: "756fd1ff3ec02a40f6fd9cfabee6e3b2c9815e7c", id: "menu-overlay", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "472fa2edfcbad244714c8e77ae30a1a3be0e82c8", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "220927c09a1e9f9d280cf096870b89e30a9131c3", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
