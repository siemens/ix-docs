...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "c73d0e566104b724e94d5126d32d6d3dd9020723" }, h("form", { key: "c0ca80946c151d79cc1e7133c6d81722e4edc443", ref: (el) => this.formElement = el }, h("div", { key: "e3279f329d8d75d6927e237927d45b12c61ba902", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "1a674e8c6c2d3a2422007281d3bde814018778d3", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "31860c9a24615800bfef45f36cafeefef9ceca3e", class: "token-container" }, h("div", { key: "a049e7e8b4efdb7ea0e4aa9faa57c95e8d6efe41", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "b27adcc9da01d9a20064c8166d35d66107ba28ac", class: {
      "text-input": true,
