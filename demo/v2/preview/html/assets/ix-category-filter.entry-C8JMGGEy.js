...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "85dbdb78b8e91f24bd024a7f807981c1be021949" }, h("form", { key: "c7bbb49d432f280a07decbe120f73d6c797d8cc7", ref: (el) => this.formElement = el }, h("div", { key: "0564d4922c264f58cdbd27da56913b09fc7ab9a5", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "3807f9bee30d44bcca3a8aefda6889958f5fa781", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "eee8f5b467efe653a186361cd6db76a6a92bdb15", class: "token-container" }, h("div", { key: "d82c1963974f8213fab1b90473d8f0c883306281", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "bb6d42b5691fa761ed9f8196edce521e5e5e04aa", class: {
      "text-input": true,
