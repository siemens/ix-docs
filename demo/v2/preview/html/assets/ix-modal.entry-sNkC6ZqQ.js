...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "2180a5dec01b447918c6a62820ebdebb32bbfb69", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "132b7e41099bf050a6f1fc5a212b836c7be4ac1e", class: "dialog-backdrop" }, h("dialog", { key: "07ade6cf27df03233bd1755f2a7fc427e28c6a78", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "09b7b0f877ce103d4af3f10e1c774b19c1201322" }))));
  }
};
