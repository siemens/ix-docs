...
const Toast = class {
  ...
  render() {
    ...
    return h(Host, { key: "d1d8b347562ec19da710d70d55ae49b6d1a3de72", role: "alert", "aria-live": "polite", "aria-atomic": "true", class: "animate__animated animate__fadeIn" }, h("div", { key: "bef026521215c457e713eb33d5e0b424a5fb5e1a", class: "toast-body", onPointerLeave: () => {
      this.touched = false;
    }, onPointerEnter: () => {
      this.touched = true;
    } }, (this.type || this.icon) && !this.hideIcon ? h("div", { class: "toast-icon" }, this.getIcon()) : null, h("div", { key: "f7c486254ea1e82a1dd3f70424cdc02ea5d6cc08", class: "toast-content" }, this.toastTitle ? h("ix-typography", { class: "toast-title", format: "h5" }, this.toastTitle) : null, h("div", { key: "80b15dbaa38fc4ec0803af9a9a19e45d979ec2fb", class: "toast-message" }, h("slot", { key: "de6bb9039690a987e2b0915ef5430eca6cdda681" })), h("div", { key: "dd88a6baa8fb34e871c2391f9d740dd2c5c64c9b", class: "toast-action" }, h("slot", { key: "47f87d3ba3d6e16bc5367529b1e3ad5102e001de", name: "action" }))), h("div", { key: "6d63eb42fac0c5d05c073071169e574d20627878", class: "toast-close" }, h("ix-icon-button", { key: "3b81c1dd6dc012e46912f6d7356078d90f48f397", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.closeToast.emit(), "aria-label": this.ariaLabelCloseIconButton }))), !this.preventAutoClose && h("div", { key: "9b6712243f444d7d55bdd172b64676b5aba7c2a8", class: progressBarClass.join(" "), style: progressBarStyle, onAnimationEnd: () => {
      this.close();
    }, onTransitionEnd: () => {
      if (this.progress === 0) {
        this.close();
