...
import { P as iconSingleCheck, g as iconChevronRightSmall } from "./index-C0zeM1D4-b0cf2da8.js";
...
const DropdownItem = class {
  ...
  render() {
    return h(Host, { key: "247d2d35b9a30839f53fc359abd0c595004bddae", class: {
      hover: this.hover,
      "icon-only": this.isIconOnly(),
      disabled: this.disabled,
      submenu: this.isSubMenu
    }, role: "listitem" }, h("button", { key: "1e76841f7f9d9aa8f5ffb775b84250c8c6fe5df4", type: "button", tabIndex: 0, class: {
      "dropdown-item": true,
      "no-checked-field": this.suppressChecked
    }, onClick: () => this.emitItemClick() }, !this.suppressChecked ? h("div", { class: "dropdown-item-checked" }, this.checked ? h("ix-icon", { class: "checkmark", name: iconSingleCheck, size: "16" }) : null) : null, this.icon ? h("ix-icon", { class: "dropdown-item-icon", name: this.icon }) : null, h("div", { key: "c72f17ab15358f0a72e6d74637a235537530de1a", class: "dropdown-item-text" }, this.label, h("slot", { key: "54b39f24cbf263a41864a0a307564d7fab4fa12d" })), this.isSubMenu ? h("ix-icon", { name: iconChevronRightSmall, class: "submenu-icon" }) : null));
  }
  get hostElement() {
