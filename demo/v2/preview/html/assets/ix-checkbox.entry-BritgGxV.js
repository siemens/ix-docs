import { r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-C4tOo1JZ.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "9c353db29458af8bf9fff3a1433791dcaedb9e76", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate,
      "label-less": this.isLabelLess
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "d0ed641122caa2175facad671e038b5f6f61926a" }, h("input", { key: "ce50b07c238ecf34096c4294d7795f585b896836", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("div", { key: "81b24e66445a7a79dbf0ee2cfd129b70d74f9b74", class: "checkbox-button" }, h("button", { key: "180a94cca8a27191d0853356e814e94af7d1edc5", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark())), h("ix-typography", { key: "c2eef4e975fcb6fde8a381818896d74af3e6d5a3", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "c3b38ea2eba94a7093fa9d9394cfd197144cdec9", onSlotchange: () => this.updateDefaultSlotElements(), ref: (element) => this.defaultSlotElement = element }))));
  }
