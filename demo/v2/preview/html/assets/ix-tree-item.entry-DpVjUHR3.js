...
const TreeItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "d7bab1c02de111458ef484818bcec12c940f1bc4", class: {
      ...
      e.stopPropagation();
      this.toggle.emit();
    }, "aria-label": (_c = this.ariaLabelChevronIcon) !== null && _c !== void 0 ? _c : ((_d = this.context) === null || _d === void 0 ? void 0 : _d.isExpanded) ? "Collapse tree item" : "Expand tree item" }) : null), h("div", { key: "b738b82fde5fe41ecc72b0cd765b2acdb17a6328", class: "tree-node-container", onClick: () => {
      this.itemClick.emit();
    } }, h("div", { key: "a0deb8a582d9b63c8832d9ad1bec89a5bdd83af8", class: "tree-node-text" }, this.text), h("slot", { key: "8c71cde365667568a7c67448f0588690cd91b9ce" })));
  }
};
