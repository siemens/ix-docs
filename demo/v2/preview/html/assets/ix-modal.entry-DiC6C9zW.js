...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "1b9c4c03e9fad75ac84ab6854f51c4ff9cbf752a", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "d5f089500fae809e0080a262d5a4d54101fee727", class: "dialog-backdrop" }, h("dialog", { key: "1a124dda3c4961c8cdc0c81a5698f5f932145f22", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "d24dd84c8f50b1542b4c992af079b0cdfbc50e15" }))));
  }
};
