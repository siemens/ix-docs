...
const Breadcrumb = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "c8cfb22b370122dea413928ceed2fb8630b53075", ...this.inheritAriaAttributes, role: "navigation" }, this.items?.length > this.visibleItemCount && h("ix-dropdown-button", { key: "c2a90ef26e2969d1e755e6acf328263f4bfbb0b5", "aria-label": this.ariaLabelPreviousButton, label: "...", variant: "tertiary", class: "previous-button", enableTopLayer: this.enableTopLayer }, h("ix-icon", { key: "f0b32d17e31d0023a413a2e16787c2f81091020f", slot: "button-label", name: iconChevronRightSmall, size: "16", class: "chevron" }), this.items.slice(0, this.items.length - this.visibleItemCount).map((item) => {
    ...
    })), h("div", { key: "a52404709581c50965d8ede10819f213eb8b9a91", class: "crumb-items" }, h("slot", { key: "92b3de8dc3ca5c2b2a089d5cca602f3c0c8b540a" })), this.shouldRenderNextDropdown && h("ix-dropdown-button", { key: "1fe42187695d0d4e4e77eae43a92b4821e85e4d5", label: labelLastItem.label ?? labelLastItem.innerText, class: "next-button", variant: "tertiary", enableTopLayer: this.enableTopLayer, "aria-current": "page" }, h("ix-icon", { key: "843588a9497997a6de921b8a6c775d9fa2f02aa5", slot: "button-label", name: iconChevronRightSmall, size: "16", class: "chevron" }), this.nextItems?.map((item) => h("ix-dropdown-item", { label: item.label, onClick: (e) => {
      this.nextClick.emit({
        event: e,
        item
      });
