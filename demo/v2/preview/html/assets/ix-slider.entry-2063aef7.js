...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "c09dea15b54b5af788f2a8260aa18c389f6e72b9", class: {
      disabled: this.disabled,
      error: !!this.error
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("div", { key: "ce7e55f4f4731db64d2fd4b07aaf5e96f8cce595", class: "slider" }, h("div", { key: "ad4e4ffbf6496cde76165b27441ef5d1030b9d84", class: "track" }, h("div", { key: "492a35d1f1a605abf30204d7986dd737a85b1102", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * 100% - 8px)`
    } }), h("div", { key: "0b2377bd101dfff4de6ab26bb2e3a4fddfa1014a", class: "ticks" }, this.marker ? this.marker.map((markerValue) => {
    ...
    }) : null)), h("input", Object.assign({ key: "f7a89521ba166bb603c62cdf0e83d37f798692c4", id: "slider", type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), style: {
      ...
      this.showTooltip = false;
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max }, this.a11yAttributes)), h("ix-tooltip", { key: "093a7079ef99dd29dc821cc5ff100a09eb2e3b78", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), h("div", { key: "66f61cdc823d233b1950df5af56cbe05550bbefd", class: "label" }, h("div", { key: "98fae9c997af49236a943668b541ff5f076c3997", class: "label-start" }, h("slot", { key: "0048d08c79627458a1e3868556bcbddc26afd089", name: "label-start" })), h("div", { key: "2819262caaf5e80cbf697790f5fc01378c0bb75f", class: "label-end" }, h("slot", { key: "9a83997f9574cc8b88e5ff68ba05923bae151497", name: "label-end" }))), this.error ? h("ix-typography", { class: "label-error", textColor: "alarm" }, this.error) : null);
  }
  get hostElement() {
