...
const RangeField = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "39e0e73fb8615f11206cf7e9d296d3ec5c671017", class: { "hide-arrow": this.hideArrow }, role: "group" }, !this.hideArrow && h("ix-icon", { key: "df1a75792a9d184e1e705fd2a93ffbc8068ce8d6", "aria-hidden": "true", class: {
      "range-delimiter": true,
      "has-label": this.hasLabel
    }, name: iconArrowRight }), h("slot", { key: "8019b4ace67118363d86d719e3545419ddbad975" }));
  }
};
