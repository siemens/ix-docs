...
const MenuItem = class {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "ede9e4b1fa44d9e04403a52de0d76d68b2632c1d", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "4a936a1ec12559ea2aad0f18bfffa2c63113377e", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "342c1995e13133c3f359e1d485ac604aea4f49ae" }))
    ];
    return h(Host, { key: "df2f4deb5b013e2d34b971ee532c9d0a10859372", class: {
    ...
    } }, menuContent) : h("button", { ...commonAttributes, ref: this.buttonRef, onKeyDown: (e) => this.handleCategoryKeyDown(e) }, menuContent), h("ix-tooltip", { key: "58a9cc7702130b9a1c023ec55b85bda0cff48ea7", for: this.buttonRef.waitForCurrent(), placement: "right", showDelay: 1e3, interactive: false, "aria-hidden": a11yBoolean(this.ariaHiddenTooltip), "aria-labelledby": this.internalItemId }, this.tooltip));
  }
