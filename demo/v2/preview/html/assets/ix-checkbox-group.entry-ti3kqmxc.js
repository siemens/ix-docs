...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "7f2ab8f11b50445a818721c3c9466189f38c2f61", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "79fe9178363a3f9ed7c44cb59ef3ec6031fcd653", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "b099ba2443912a77775cad96fd007a92e1b312e1", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "828cdaf4ae4295b0c1597987d4ca7f1e9fbe80c7" }))));
  }
};
__decorate([
