import { r as registerInstance, g as getElement, h, H as Host, M as Mixin } from "./global-DsITLPyL.js";
...
import { c as createClassMutationObserver } from "./validation-DXpftrw5-DiHPxf5A.js";
import { r as resolveTextFromValidationState, h as hasAnyText, H as HelperText$1 } from "./helper-text-util-BJ-ZMW2J-BeMTfR1H.js";
...
const FormFieldLabel = class {
  ...
  render() {
    return h(Host, { key: "a228926a776118e196b07787d6a32c2241f60404", onClick: () => this.focusOnClick(), class: {
      "text-overflow-wrap": this.textOverflow === "wrap",
      "text-overflow-no-wrap": this.textOverflow === "no-wrap"
    } }, h("label", { key: "9e30a5944eed06c87108bb95dc18fd8965a7830e", htmlFor: this.htmlFor, ...this.a11yAttributes, ref: this.labelRef }, h("ix-typography", { key: "efe6d7b8de49a4ed5ba305d0d3f125fe6b1d3658", textColor: this.isInvalid ? "alarm" : "soft", format: "label" }, h("slot", { key: "189e87c98f4c77a11a9bfb3a2b5d397f2993d241" }), this.required && h("span", { key: "d0c29240d16c2e98b1d21b0ae21518c886be5643" }, "*"))));
  }
  static get watchers() {
    return {
      "isInvalid": [{
...
const FieldWrapper = class extends Mixin(...DefaultMixins, ComponentIdMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "fd7a223ad75c9c2073031d63f60783fb56fd7b09", ...additionalAriaAttributes }, this.label && h("div", { key: "3c435387e8297bb8b2e97436df054012ab2f801d", class: "field-top" }, h("ix-field-label", { key: "a5526dca7376ca80a982d955b38c32b053018428", required: this.required, controlRef: this.controlRef, isInvalid: this.isInvalid, ariaHidden: true }, this.label)), h("div", { key: "c76fcf98ad31b6c89b5e6aae4c2e44a27f7ae7df", class: {
      "slot-wrapper": true
    }, ref: this.slotRef }, h("slot", { key: "77c50384c3098490c1cb55b130645a244fbe884a" })), h("div", { key: "36ce0a8d7a15a2eeee189caf304983a80fbc2bc2", class: "field-bottom" }, !this.showTextAsTooltip && h(HelperText$1, { key: "7f0d5cf73307cdd236a11e381695f22c58bdf50c", ...textOptions }), h("div", { key: "c1cd0ff7edbd167e03517810fb4b3b5aa423f22e", class: "bottom-right" }, h("slot", { key: "3acb46dffa748d54a7cc05e44f993927cac412f5", name: "bottom-right" }))), this.showTextAsTooltip === true && hasAnyText(textOptions) && h("ix-tooltip", { key: "0bb08975464a35c0a22f8e0f276d11c650ea6eb3", for: this.slotRef.waitForCurrent(), showDelay: 500, placement: "bottom" }, h(HelperText$1, { key: "f1658860c1245ebb708d79f0c9c9717b960718d0", ...textOptions })));
  }
  static get watchers() {
    return {
      "label": [{
