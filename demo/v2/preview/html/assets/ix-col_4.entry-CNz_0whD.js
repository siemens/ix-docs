import { r as registerInstance, f as forceUpdate, h, H as Host, M as Mixin, c as createEvent, g as getElement } from "./global-DsITLPyL.js";
...
import { O as OnListener } from "./listener-BjluJgvO-BnMf4beS.js";
...
const Col = class {
  ...
  render() {
    return h(Host, { key: "4100338d123bd8bb83087547168f7b5949c203ff", style: {
      ...this.getColumnSizeStyling()
    } }, h("slot", { key: "90c209c3c011c132a654fb0a546ef149992def3c" }));
  }
};
Col.style = colCss();
...
const LayoutGrid = class {
  ...
  columns = 12;
  render() {
    return h(Host, { key: "bbbb190067242d1af34db168445410d8dc223288", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "efe37496334ae57f28e90d612e3598f606c66036" }));
  }
};
...
const Row = class {
  ...
  render() {
    return h(Host, { key: "dc089e8a0a641e78f237510b27c5198fe23915a4" }, h("slot", { key: "92cb22bde2c9b89a4dc57d0a8fc2434886cabc72" }));
  }
};
Row.style = rowCss();
...
const TimePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    const { bounds } = this.getUnitSelectionContext();
    return h(Host, { key: "843508f1f761b09aa9f804d8508f073fc4e456c2" }, h("ix-date-time-card", { key: "5bd462965737df20d1bfaafb6fe909f9072e172f", embedded: this.embedded, timePickerAppearance: true, corners: this.corners, hasFooter: !this.dateTimePickerAppearance, hideHeader: this.hideHeader }, h("div", { key: "0a4753c97c668bbea0bf08fbc6ede9be9c7fec00", class: "header", slot: "header" }, h("ix-typography", { key: "f16526b69e956e416f7cb71192ce59f8cacf757c", format: "body" }, this.i18nHeader)), h("div", { key: "18c828b4355fd21ad48bf0fccc485437eb99bcec", class: "clock" }, this.timePickerDescriptors.map((descriptor, index) => {
    ...
    }), this.timeRef && h("div", { key: "7ad04e4572dd11cc77509e5782364052811089d0", class: "flex" }, h("div", { key: "d6b423fd2cd5c3b238504f951374d0b9b6435909", class: "column-separator" }), h("div", { key: "f74cab2bcf22852af1b2f7a705ef8726bb779040", class: "columns" }, h("div", { key: "9e8f74e738d9dd95df814329a0e09b49633d2343", class: "column-header", title: "AM/PM" }), h("div", { key: "57cd6b520883953a66cddf6ab9ba486e0b32512a", role: "listbox", "aria-label": "AM/PM", class: "element-list", tabindex: -1 }, h("button", { key: "9486d0c81c91a235e1c9204afcbc794db7f063fe", role: "option", "aria-selected": this.timeRef === "AM" ? "true" : "false", "data-am-pm-id": "AM", class: {
      selected: this.timeRef === "AM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("AM"), tabindex: "0", "aria-label": "AM" }, "AM"), h("button", { key: "90602f7ec60c50c8d4edec394de2d205f506ed6d", role: "option", "aria-selected": this.timeRef === "PM" ? "true" : "false", "data-am-pm-id": "PM", class: {
      selected: this.timeRef === "PM",
      "element-container": true
    }, onClick: () => this.changeTimeReference("PM"), tabindex: "0", "aria-label": "PM" }, "PM"))))), h("div", { key: "73907cc1c7cdf44a249ea2557d14e1a61f4f66ea", class: {
      footer: true,
      "footer--compact": this.timePickerDescriptors.length <= 2
    }, slot: "footer" }, h("ix-button", { key: "b2c32715f3a41323314f0da0f0b89c5e98f81dd4", class: "confirm-button", disabled: this.isConfirmDisabled(), onClick: () => {
