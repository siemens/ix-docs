...
const EventListItem = class {
  ...
  render() {
    ...
    return h(Host, { key: "480183082e033d54e08db8f291d9cc2aafe3713d", class: {
      disabled: this.disabled
    } }, h("div", { key: "11c967de69aea8bfcf35dac104cf8bf9aa75ae35", role: "listitem", "aria-disabled": a11yBoolean(this.disabled), class: {
      "event-list-item": true,
      selected: this.selected,
      disabled: this.disabled
    } }, h("div", { key: "586af37337d2d6d32f045bd182373a45b8bd7f5f", class: `indicator ${!this.itemColor ? "indicator-empty" : ""}`, style: {
      "background-color": this.itemColor ? color : "inherit",
      opacity: `${this.disabled ? 0.4 : 1}`
    } }), h("div", { key: "1a4de3981d98b39205dea9263fb9139af30f6cb7", class: "event-list-item-container" }, h("div", { key: "fe113d0d8c675e71117edbfdb7222023329966e0", class: "event-content" }, h("slot", { key: "f1cceb2f4ae97e055e5fde70ed189e849a780b4d" })), this.chevron && h("ix-icon", { key: "b68202d82b66cc253e528803a90f32c867c4fa43", name: iconChevronRight, size: "16", class: "chevron-icon" }))));
  }
};
