...
const Button = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "0eb555f606e1fb774004c7ab8d950076baaa0284", class: {
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled || this.loading ? -1 : 0 }, h(BaseButton, { key: "a9ead157a199a3575627f4af70a0355687d4e990", ...baseButtonProps }, h("slot", { key: "de07260fc4785b2c30e6fdace31005435f273a93" })));
  }
