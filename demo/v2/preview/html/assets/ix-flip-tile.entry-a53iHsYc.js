...
const FlipTile = class {
  ...
  render() {
    return h(Host, { key: "98de348c3952a6ae9cf13fb4fe1dc515ad6b0504", class: {
    ...
    } }, h("div", { key: "7ae391851db6469b7821137851ac0c49056779bf", class: "flip-tile-container" }, h("div", { key: "573dd82522af32eb4775a7f4d0cdec162f03d14b", class: "flip-tile-header" }, h("div", { key: "d5cc22f464ec436bdfb52861d05035759f91c37c", class: "header-slot-container text-l-title" }, h("slot", { key: "54037b21d669285e02b5a7b0d2e112fb6bf84f3e", name: "header" })), h("ix-icon-button", { key: "9360ba83ed398c0409b04a5e9777d6d83f2f0655", icon: iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), h("div", { key: "4a2b1fcb2849622f91b4d29132c62160975be619", class: "content-container" }, h("slot", { key: "c239f64f477e7fe17e1f9747031185b073481697" })), h("div", { key: "6ef464693fc873180707a93d886f34710624e32f", class: {
      footer: true,
      "show-footer": this.hasFooterSlot
    } }, h("slot", { key: "501d0bf61543a291236d9e7983f541aeb980a8ae", name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) }))));
  }
  static get watchers() {
    return {
      "index": [{
