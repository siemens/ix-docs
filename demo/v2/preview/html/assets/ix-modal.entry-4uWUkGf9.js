...
const Modal = class {
  ...
  render() {
    return h(Host, { key: "0a2ab5326fb5cbadf863bd8e3a38cce5be19c0df", class: {
      visible: this.modalVisible,
      "no-backdrop": this.hideBackdrop,
      "align-center": this.centered,
      "non-blocking": this.isNonBlocking
    } }, h("div", { key: "2e433b7bdb5aac5e38e96e725742868ca94f11be", class: "dialog-backdrop" }, h("dialog", { key: "39497dada9d70730da3b25f8693945c0daf3592f", "aria-modal": a11yBoolean(!this.isNonBlocking), "aria-describedby": this.ariaAttributes["aria-describedby"], "aria-labelledby": this.ariaAttributes["aria-labelledby"], class: {
      modal: true,
      ...
      e.preventDefault();
      void this.dismissModal();
    } }, h("slot", { key: "c8523949dec6428eb1c840240f5ac49e240c80c4" }))));
  }
};
