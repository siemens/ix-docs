...
const Menu = class {
  ...
  render() {
    ...
    return h(Host, { key: "47a4fe953c394a65c515c69eb164fae9921241d0", class: {
      expanded: this.expand,
      [`breakpoint-${this.breakpoint}`]: true
    }, slot: "menu" }, h("nav", { key: "befa847fe411183d14f2618eae42f11892bd53e3", "aria-label": this.applicationName, class: {
      menu: true,
      expanded: this.expand
    } }, h("div", { key: "d648ef9cf9525f858b25dbf8b396ab6faceadd4e", class: "menu-buttons" }, this.breakpoint !== "sm" && h("ix-menu-expand-icon", { key: "b9092de8f71df6ec8b78cc356f5fcc83902b75cd", breakpoint: this.breakpoint, expanded: this.expand, "i18n-expand": this.i18nExpand, "i18n-collapse": this.i18nCollapse, pinned: this.pinned, class: "menu-expand-icon", onClick: async () => this.toggleMenu(), "data-testid": "expand-collapse-menu" }), this.breakpoint === "sm" && this.applicationLayoutContext?.appSwitchConfig && h("ix-icon-button", { key: "4ce5e027869a3fe66290e9447c1da57ea827cdde", onClick: () => {
      this.showAppSwitch();
    }, icon: iconApps, variant: "subtle-tertiary" })), h("div", { key: "088f955c6ab52008a6cd1aa6e75ef5d97211cb5b", role: "menubar", "aria-orientation": "vertical", "aria-label": this.i18nAriaLabelMenu, "aria-description": this.i18nNavigationHint, class: {
      "menu-navigation": true,
      "menu-navigation--fill": this.shouldFillMenuNavigation
    }, tabIndex: 0, onKeyDown: (e) => this.handleMenuKeyDown(e), onFocusin: (e) => this.handleMenuFocusIn(e), onFocusout: () => this.resetRovingTabIndex() }, h("div", { key: "b1ec4b72b2a1d791429a97617184065e1d47b260", id: "menu-tabs", style: {
      display: "contents"
    }, onClick: (e) => this.onMenuItemsClick(e) }, h("div", { key: "80712fd2a17029394ca4355cc0ca22a61ff7b4ef", class: "tabs-shadow-container" }, h("div", { key: "3fc0eca7419f73746525f4881dea0cbc27398d87", class: {
      "tabs--shadow": true,
      "tabs--shadow-top": true,
      "tabs--shadow--show": this.itemsScrollShadowTop
    } }), h("div", { key: "f6d8d4716a1b3e15ac7c48a80fd7878ec7003d63", class: {
      tabs: true,
      "show-scrollbar": this.expand
    }, onScroll: () => this.handleOverflowIndicator() }, h("div", { key: "53ebf16042ac81b94cfceedf4efff1d4eaf74d08", class: "menu-avatar" }, h("slot", { key: "1cbebf98bb6bb2ba9545a153d45390fe6e7effb0", name: "ix-menu-avatar" })), h("slot", { key: "28941eced5a431a5610859c187db19d0f0a17437", name: "home" }), this.breakpoint !== "sm" || !this.isHiddenFromViewport() ? h("slot", null) : null), h("div", { key: "e67916be1c943d25ae37b7b97c08b0cc1dd72bdf", class: {
      "tabs--shadow": true,
      "tabs--shadow-bottom": true,
      "tabs--shadow--show": this.itemsScrollShadowBottom
    } }))), h("div", { key: "0d5aed4213390ac89cb1906e52528fe0451a250f", onClick: (e) => this.onMenuItemsClick(e) }, h("slot", { key: "95514a4b070d7e8c9f73869acf59c78169a524ac", name: "bottom", onSlotchange: () => this.updateBottomSlotState() })), h("div", { key: "24b2a88b7eb24c2a33cf94313a2f6736249d0cd5", class: "bottom-tab-divider" }), h("div", { key: "6900b0226aeed36a3b643b790a4db230a0635eb6", class: "menu-utility-controls" }, this.settings ? h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
      "internal-tab": true,
      "bottom-tab": true,
    ...
    }, icon: iconInfo, onClick: async () => this.toggleAbout(!this.showAbout), label: this.i18nLegal, "aria-haspopup": "dialog", "aria-expanded": this.showAbout.toString(), "aria-controls": "menu-overlay" }) : null)), h("div", { key: "4d1cfd95a64cd7b51eadb71131284ed7404af601", id: "popover-area" })), h("section", { key: "730576b8b7214a6aee310c05f67109fe6911b0c5", id: "menu-overlay", role: "dialog", "aria-label": overlayLabel, class: {
      "menu-overlay": true,
      ...
      this.checkTransition();
    } }, h("div", { key: "f2c7e8b61608398eead0080b0b7e9f40702e3eab", class: "menu-overlay-container" }, this.showSettings ? h("slot", { name: "ix-menu-settings" }) : null), h("div", { key: "e77e005e8a36e3b243b310254f230d90539fec94", class: "menu-overlay-container" }, this.showAbout ? h("slot", { name: "ix-menu-about" }) : null)));
  }
  static get watchers() {
    return {
      "expand": [{
