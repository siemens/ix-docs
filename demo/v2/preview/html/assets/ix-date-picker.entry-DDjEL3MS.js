...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "3a758d5378cce782272d54ed210f854e1be9bee4", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "fcdc8c2d76a536bd25328bae925cfbff49dd5e0f", corners: this.corners, embedded: this.embedded }, h("div", { key: "93a206ed565efbce5401e10a8f23aa6ac3a61f69", class: "header", slot: "header" }, h("ix-icon-button", { key: "f05099c413c1c0c9537aec0bcd8aaddbdd6cad51", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "f1b99b9ac1efc8048caab32a1d47873e04075f57", class: "selector" }, h("ix-dropdown-button", { key: "260c713c94550e0e0b61abf9920d20f61881342c", class: "month-selector", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "793f53297fe36421acfddfa5a863eacdfe6d9cfb", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "110d9b7237d5a99e30fd740f2d5113a80b5662e8", class: "year-selector", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "1ef79a11c880ceda187e4275af1921cb230f1716", class: "infinite-scrolling-spacer" }, h("div", { key: "2d9fc10794f8efe1a8aef837008fb3a0ebe2ca29", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "152c681624d375241d55c641b8013a2ce8b9874d", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "a8770b507077d201df514f35a46d71f3771289df", class: "infinite-scrolling-spacer" }, h("div", { key: "e14c2e5bec16bab3d08268ae6bc61303e26355da", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "16b7fd43d4d514b628a4ac90f54c0dcd54380fd3", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "869b001d286f35e721e31afa4546865f3ed02d1c", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "b95a4e9f19c16ae42ac8e1396f43cedcc829893d", role: "row" }, this.showWeekNumbers && h("div", { key: "5552fb1ecbfb5f71c07b29e838f146662edf9e9e", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "fddd1c1fc28e5f285551bc7a197c3ddc022e7bcb", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "636a74b44e1e626b618d2c86bb1c5093c82e82e3", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
