import { M as Mixin, r as registerInstance, c as createEvent, g as getElement, h, f as forceUpdate, H as Host } from "./global-BTgWS9s6.js";
...
import { P as PROXY_LISTITEM_ID_SUFFIX, a as PROXY_LIST_ID_SUFFIX, u as updateFocusProxyList, F as FocusProxy } from "./focus-proxy-BQyoX-Kl-DedJ_HBd.js";
...
import { N as NativeInputNotFoundError, H as HookValidationLifecycle } from "./validation-DXpftrw5-Bqchz5q3.js";
...
const Select = class extends Mixin(...DefaultMixins, ComponentIdMixin, AriaActiveDescendantMixin) {
  ...
  render() {
    return h(Host, { key: "12f066e4fcda30b4df4420847adfed06fa6eb51e", id: this.getHostElementId(), class: {
      readonly: this.readonly,
      disabled: this.disabled,
      "show-focus-outline": this.hasInputFocus && !this.dropdownItemsVisualFocused
    }, tabIndex: this.disabled ? -1 : 0 }, h("ix-field-wrapper", { key: "ef30284c6d2bfe8c67bd61222aa4908b4533f6eb", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "c28253243a825e85ef9ff8cc863ce407191f462d", class: {
      select: true,
      disabled: this.disabled,
      readonly: this.readonly
    }, ref: (ref) => {
    ...
    } }, h("div", { key: "841ae12c0dfbc999374644a4ec777f3de2c8e414", class: "input-container" }, h("div", { key: "46e892e8f13331dfb840f3f789dff9e0e94f7bf3", class: "chips", ref: this.chipsContainerRef }, this.isMultipleMode && this.renderMultipleModeChips(), h("div", { key: "3bf138f72a341dba37b522697ba357d8d735f0e2", class: "trigger" }, h("input", { key: "7630af0620fe089e9289794340a5a9a3571d877a", id: `${this.hostId}-input`, role: "combobox", "aria-controls": `${this.hostId}-proxy-listbox`, "aria-expanded": a11yBoolean(this.dropdownShow), "aria-autocomplete": "list", "aria-disabled": a11yBoolean(this.disabled), autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
    ...
    }, "data-select-dropdown": true, key: "dropdown", class: { "dropdown-visible": this.dropdownShow }, icon: this.dropdownShow ? iconChevronUpSmall : iconChevronDownSmall, variant: "subtle-tertiary" })))))), h("ix-dropdown", { key: "98815c0cc3ab87dea8cbba41b0285eef62ae3e50", id: `${this.hostId}-listbox`, keyboardActivationKeys: ["ArrowUp", "ArrowDown"], keyboardItemTriggerKeys: ["Enter"], disableFocusTrap: true, focusHost: this.hostElement, ref: this.dropdownRef, show: this.dropdownShow, closeBehavior: this.isMultipleMode ? "outside" : "both", hidden: this.disabled || this.readonly, anchor: this.dropdownAnchorRef.waitForCurrent(), trigger: this.dropdownWrapperRef.waitForCurrent(), onShowChange: (event) => {
    ...
    } }, h("div", { key: "99bce854b460b54621001ae07fc9f36d10684df8", "aria-hidden": "true", class: {
      "select-list-header": true,
      hidden: this.hideListHeader || this.isDropdownEmpty
    }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: "49916fd0b14b1ff8a0b8f00cf2133c6f08c94a80", onSlotchange: () => {
      this.updateSelection();
    } }), h(FocusProxy, { key: "f09bdadcc1c886ef78299322f3318eaf2ca0ccd2", hostId: this.hostId, otherProps: {
    ...
    } }), this.isDropdownEmpty && !this.editable && h("div", { key: "70c18c30db4dc6af1c84b6a4a81fbb133cf02a1b", class: "select-list-header" }, this.i18nNoMatches)), this.isMultipleMode && !this.shouldDisplayAllChip() && this.hiddenChipValues.length > 0 && this.renderOverflowDropdown());
  }
