...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    } }, h("div", { key: "6bff1627c2ae988c2cec43c0fab19301afe0d4b2", class: "infinite-scrolling-spacer" }, h("div", { key: "65649d41658fea52c472ae4a7be9b2049324012a", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "845eaf9a759948f682bea5ac32cbff69a7911db9", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "4b8886f3383301fce14c4c82a36a322a16bab48d", class: "infinite-scrolling-spacer" }, h("div", { key: "2ed935b2f11cb117b6ed10f4458ecc4d7b3466aa", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "6744bb35c08d528c1455c737823443f786739b87", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "65e864e3df6b3f4c725337c13c302ae4f4d29904", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "061afbad3742cbeba3564b06667414ac05c37461", role: "row" }, this.showWeekNumbers && h("div", { key: "9f223211778fcef3281a0fc11ab2ddfb40c66670", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "f4e2619893fdf4d3c4a6ba2b514a03285a9a145f", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "a907377384cc521a7302a4adc7a4076a9befbc38", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
