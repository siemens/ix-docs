import { r as registerInstance, g as getElement, h, H as Host, c as createEvent } from "./global-BTgWS9s6.js";
...
const GroupContextMenu = class {
  ...
  render() {
    return h(Host, { key: "8d5cde7a5aeadb2bb73d56e23481b592e408c211" }, h("ix-icon-button", { key: "91701da1319aed49a3ced6debf9e136d65bb4f9f", class: { hide: !this.showContextMenu }, size: "24", variant: "subtle-tertiary", icon: iconContextMenu }), h("slot", { key: "12b2df94d37c16da0e9db898b67f470f383dec8e", onSlotchange: () => this.onSlotChange() }));
  }
};
