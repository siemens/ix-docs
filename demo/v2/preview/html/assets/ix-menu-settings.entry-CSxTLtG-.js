import { r as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-C4tOo1JZ.js";
...
const MenuSettings = class {
  ...
  render() {
    return h(Host, { key: "05f98cf864c61b155446992713cd31408c3182fa", slot: "ix-menu-settings", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "a119043ecdf9710d73186650b91ee67677000e5b", class: "settings-header" }, h("h2", { key: "289bef2c46bf0856677dd810b589048db3a4161c", class: "text-h2" }, this.label), h("ix-icon-button", { key: "9c38c31c8f46b777de1dba7a48e27e03870c11bb", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
