...
import { H as HookValidationLifecycle } from "./validation-LJh16vt2-B43A6Q4g.js";
import { m as makeRef } from "./make-ref-bcj7UEIC-BX_OSyqv.js";
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, g as getAriaAttributesForInput, c as SlotStart, I as InputElement, d as checkAllowedKeys, o as onInputBlur, S as SlotEnd } from "./input.fc-KJF8Z9iJ-DqMDEETn.js";
...
const Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "07337a899a3b73d3cb37b1fc84da266d95cff84a", class: {
      ...
      this.touched = true;
    }, ariaAttributes: inputAria, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "c8f10373d93bba50d0c633b77fd7ec548e4590d5", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "169c36e6719204de19756a1cf8c0a7c141119417", color: "color-weak-text", class: {
      "password-eye": true,
