...
const DatetimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "74103cbb608cda32c6ce7792b2c0a3638b04c02b" }, h("ix-date-time-card", { key: "f9b1c284b74416ee9f84633ed1fd6fed292a341a", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "3ec94694fb618b94535c799c31a711f73f577b02", class: "no-padding" }, h("ix-row", { key: "d45083e8d657c9dc08c3a43150051ca4abf39593", class: "row-separator" }, h("ix-col", { key: "3688c2ee4e7dabf91953a3e685c7b8d10f087925", class: "col-separator" }, h("ix-date-picker", {
      key: "9f3bcce5cedd9d5bb449030c7c4cab16522c95f7",
    ...
    })), h("ix-col", { key: "8d9e526e746b316e558144f0bf5a630168ddde6a" }, h("ix-time-picker", {
      key: "1d726de042a1b1b1d8b61870f028e4cd46b6a72e",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "923cd8d5baad08e240c32c7ecaa33177afe4b12a", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "552314657eb3bf326e15b098561cff1cad0fc0d9", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
  static get watchers() {
    return {
      "from": [{
