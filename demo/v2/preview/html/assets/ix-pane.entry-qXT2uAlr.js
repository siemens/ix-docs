...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "660f2e8dc07c9e850c0e3a5519aa2bdf3c8c5fac", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "d2b0ae9751cda7f718e4d1364e3d3753e57cbefe", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "0b5918ac95f84b670be321fc53dafd181b097dc4", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "13c826047f5f354ae359a587250e77c64121fde8", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "6d78cb728e3a4e6d9c45847af1df55db363c1931", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "061797c039a5e9a2e00b11a309ee590c1c63ae88", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "694a060e147b5512b190ac579251c1b7443946e9", class: "title-text-overflow" }, h("ix-typography", { key: "47ccd30e3da94259c7b679c97c680792bb13a7d3", format: "h4" }, this.heading)), this.expanded && h("div", { key: "96e096bac94baa46ac24fe95e2924c04e5c7ee46", class: "slot-header" }, h("slot", { key: "d9e4abdaa29161ddf00317a845fe64b215eacbd4", name: "header" })))), h("div", { key: "810c3551402bb7292c8996d3efeb095a5b2cee8d", class: {
      "side-pane-content": true,
      "no-padding": this.noPadding
    }, hidden: !this.showContent }, h("slot", { key: "224834ef4d3eb117b0fe9284ba7b76905cb23473" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
