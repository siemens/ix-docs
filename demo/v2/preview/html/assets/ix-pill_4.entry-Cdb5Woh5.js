import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-C4tOo1JZ.js";
...
import { I as InheritAriaAttributesMixin } from "./inherit-aria-attributes.mixin-nCmPujqf-C9iioMUb.js";
...
const Pill = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "67338905de82719c9a01fe022487ed706b35d8e6", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    }, role: hostRole }, h("div", { key: "673b20609f91ffd09d80564d6aa709fe4d9303ad", ref: this.containerElementRef, style: { ...customStyle }, class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "76b1e2d1b248f13f68417f91c72130f40f4e2755", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative) }), h("span", { key: "215af7f202cfd01c6f2f5dc43fbc9b2a6d296ed2", class: "slot-container" }, h("slot", { key: "0e2082d82c6c6be68a7107692c6162080178f601", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
};
Pill.style = pillCss();
...
const TabItem = class extends Mixin(...DefaultMixins, ComponentIdMixin, BaseTabMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "cbb2004638023c1beeb4af192ba6219380c8f0e6", id: this.getHostElementId(), role: "tab", "aria-selected": a11yBoolean(this.selected), tabIndex: this.selected && !this.disabled ? 0 : -1, class: {
    ...
    } }, variant === "rounded" && h("div", { key: "1f98b9019ba76864d03c491435a60e913f566584", class: {
      circle: true
    } }, this.icon && h("ix-icon", { key: "6849def7bdb3dba05f4a1b84f9067777bede78c5", name: this.icon, size: "24" }), h("slot", { key: "41b3464f6fc45ad5b853223c5a8819a00dcca841" })), this.icon && variant !== "rounded" && h("ix-icon", { key: "b9af7159f9306c2b841066a726008afdee58e472", name: this.icon, size: "16", class: "tab-icon" }), variant === "normal" && h("div", { key: "87d1993bfa9bf76dff49f15b9a1e5e4f7dfe9a56", class: {
      text: !!this.label,
      selected: this.selected,
      disabled: this.disabled
    } }, this.label, h("slot", { key: "328e393a77d1c24b487ef874e07bf7772cc24820" })), variant === "rounded" && this.counter !== void 0 && h("div", { key: "2758fc1447296c9c2cc04ce92905e5ba4fca9a1b", class: {
      counter: true,
      selected: this.selected,
      disabled: this.disabled
    } }, this.counter), this.counter && variant !== "rounded" && h("ix-pill", { key: "6a749ea40148e1d5ca319b7cfa52176e1303d1bd", variant: "primary", outline: true, class: "tab-counter" }, this.counter), this.closable && variant !== "rounded" && h("ix-icon-button", { key: "35fdcd1095f49cb083e10ce3aeb33e54458968d9", "aria-label": this.ariaLabelCloseButton, class: "close-tab", size: "12", variant: "subtle-tertiary", icon: iconClose, onClick: (event) => {
      event.stopPropagation();
      event.preventDefault();
      this.tabClose.emit({
        tabKey: this.tabKey,
...
const TabSet = class {
  ...
  render() {
    return h(Host, { key: "90be74d89acb43edb6eec575f07a3877ec90ac45", onTabChange: () => this.checkPanelsVisibility() }, h("slot", { key: "047c26c15f8b43312a25a35dddadd364a5b9f839" }));
  }
};
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "2e8b5f9f4d3658bd219e6ca5d5a829d16f0c1977", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "8e45e2d46485c6e3147b2237f6109d63cd02758c", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "69b6177b0c8c7c20d039a434866f93135e168155", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "97d6ccbe5e623cbedf6be21de05005599b9a2bcd", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "2ceb8d8dc886c9784e244172750192297f077360" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "a7041a35c2dcac4f86eefbfbae5ac36ba9c45436", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
