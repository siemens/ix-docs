...
const Upload = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({ key: "f6688a85aea9e0d89501ad0228672c3d8e7d1510" }, a11y, { "aria-disabled": disabled }), h("div", { key: "34819f8df44d0f8e6a2a98023d4e76304b4cd39d", class: {
    ...
    }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), h("div", { key: "0a39205aa746298de01a45a97da901970cd1a0c5" }, h("input", { key: "2863ace496c2d9be2cfa0e752d7bae6d96dcaee5", "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
      this.fileChangeEvent(e);
    }, accept: this.accept, disabled }), h("ix-button", { key: "14adc816fc90016197a3112222e6752bdd115538", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
