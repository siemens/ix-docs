...
const Popover = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin, ComponentIdMixin) {
  ...
  render() {
    return h(Host, { key: "5056bfaf705bbc83271b31181ba1d3187dd62d60", class: { visible: this.show }, "data-ix-popover": this.popoverPanelId }, h("dialog", { key: "464d57af0ebb424975704e63c0eef5373be6c502", ref: this.dialogRef, id: this.popoverPanelId, class: "dialog", popover: "manual", inert: !this.show, ...this.inheritAriaAttributes, role: this.inheritAriaAttributes["role"] ?? "dialog", onMouseEnter: () => this.onDialogMouseEnter(), onMouseLeave: () => this.onDialogMouseLeave() }, h("div", { key: "414e84e36191a3e43e7ef68006e06f87a7a2fd06", class: "popover-container" }, h("div", { key: "dd676856983f4dfbaf7e052e81d61bfab6d042dd", class: "popover-body" }, h("slot", { key: "dcbfceaf19576233123bbf411e5a9e84c464c079" })), this.hasSpike ? h("div", { class: "spike" }) : null)));
  }
  static get watchers() {
    return {
      "role": [{
