...
const Chip = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "9f724c90d7b7b50436fd53dac1c9e473b568f8f6", role: this.getHostRole(needsGroupRole), class: {
      inactive: this.inactive
    } }, h("div", { key: "5fe02566c2d6b0a5ef6c6bc5c75aa8a1c9eae41c", ref: this.containerElementRef, class: wrapClasses, style: customWrapStyle }, h("button", { key: "9fe4c5a27535af0dc8bff42cc2d4e7277e91e7bd", type: "button", class: "chip-main", ...this.inheritAriaAttributes, disabled: this.inactive, style: customMainStyle }, h("div", { key: "fa78760c9912d9642d95b60e401f599de00bc26c", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "34307f0a33c01af655f4d37498a6fc98dfc499c5", class: {
      "with-icon": true
    }, name: this.icon, size: "24", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative), style: this.getIconStyle(variant) }), h("span", { key: "c2093240153933547f8c1e6e5cbe80d664c5aafa", class: "slot-container" }, h("slot", { key: "c08bf6660d91b77e9d640583a9e2eb5cc4de7365" })))), showClose && h("button", { key: "233aaa96d9650b9b357b7bae028f9baafd312517", type: "button", class: "chip-close", "aria-label": this.ariaLabelCloseButton, onClick: (event) => {
      this.closeChip.emit(event);
      event.stopPropagation();
    } }, h("ix-icon", { key: "f095e50123273af0a21f3321e6b81358f1cfe8b3", class: "chip-close__icon", name: iconCloseSmall, size: "16", "aria-hidden": "true" }))), this.getTooltip());
  }
  static get watchers() {
    return {
      "role": [{
