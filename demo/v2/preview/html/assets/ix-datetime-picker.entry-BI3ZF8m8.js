...
const DatetimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "4a7b3d01b9001bd34b6c8cf357d5de34f7b326c7" }, h("ix-date-time-card", { key: "c54fffa1efadf7fedf270a5d29a241cb244ae35b", hideHeader: true, hasFooter: true, embedded: this.embedded, corners: "rounded", noPadding: true }, h("ix-layout-grid", { key: "3d5496ac783718cec38643defe04ea9cf296714a", class: "no-padding" }, h("ix-row", { key: "61b4864d048b3c0e79218d892a2810a7673f4c75", class: "row-separator" }, h("ix-col", { key: "92844a4c2caa6837c50e29207495a5f51c236056", class: "col-separator" }, h("ix-date-picker", {
      key: "88611176a321e3cd369e2b4b6e4c594806c299ec",
    ...
    })), h("ix-col", { key: "acc965fc6992fb5afd79e9174cbc1ed30f09fb22" }, h("ix-time-picker", {
      key: "042cd14c98a3f7ea2c330ef55889f4cfc6c7017c",
      class: "min-width",
      ...
      tabIndex: this.embedded ? -1 : 0,
      [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: this.embedded
    })))), h("div", { key: "f625f88c84a0d294fe94836b11e46f17018c4228", slot: "footer", class: "btn-select-date-container" }, h("ix-button", { key: "b4f1d140c91a3f2a46724fc9a5fcb601c263f8af", class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone))));
  }
  static get watchers() {
    return {
      "from": [{
