...
const Toggle = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "41d91ada6ad7f8f0000ff5c636274df99b5bcec3", ...this.inheritAriaAttributes, role: "switch", tabindex: this.disabled ? -1 : 0, "aria-label": ariaLabel, "aria-checked": ariaChecked, "aria-disabled": a11yBoolean(this.disabled), "aria-required": a11yBoolean(this.required), class: {
    ...
    } }, h("div", { key: "d712114dae9e0316346e6fb20b3ae28678308788", class: "wrapper" }, h("div", { key: "433f2624d9b2b619961a893c5ca4c13f628fa3a6", class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, "aria-hidden": "true" }, h("div", { key: "02272dc7dad538380fe15e57835ac470e1327c4e", class: "slider" })), !this.hideText && h("ix-typography", { key: "1917d18ba54dbcacb7995dafa45082d3ce7bc36d", class: "label", "aria-hidden": "true" }, toggleText)));
  }
