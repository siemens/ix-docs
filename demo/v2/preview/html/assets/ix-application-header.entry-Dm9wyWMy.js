import { r as registerInstance, c as createEvent, g as getElement, a as readTask, h, H as Host } from "./global-BTgWS9s6.js";
...
const ApplicationHeader = class {
  ...
  render() {
    ...
    return h(Host, { key: "e748601f8379536c62fe20edf48634ec7373fdbe", class: {
      [`breakpoint-${this.breakpoint}`]: true,
      "hide-bottom-border": this.hideBottomBorder
    }, slot: "application-header", role: "banner" }, h("div", { key: "0153872edf217449e8b7ac4eaad0b7304e44f171", class: "left-side" }, this.appIcon && this.breakpoint !== "sm" && h("div", { key: "4934436922dca879c5ecbd8fd19379000fcea7be", class: {
      "app-icon": true,
      "app-icon-outline": this.appIconOutline
    } }, h("img", { key: "c253d49a3a37507daace6db886c33e899c3de9be", src: this.appIcon, alt: this.appIconAlt })), (this.showMenu || showMenuByApplicationFrame) && h("ix-menu-expand-icon", { key: "e4bcdb607e5f50873f0f90bc6a1bad167d8b6cbf", onClick: () => this.onMenuClick(), expanded: this.menuExpanded }), showApplicationSwitch && h("ix-icon-button", { key: "6de3d4401ecd71c97b0008bb8bf4142ee68aa3ac", onClick: () => this.showAppSwitch(), icon: iconApps, variant: "subtle-tertiary", class: {
      "app-switch": true,
      "without-app-icon": !this.appIcon
    }, "aria-label": this.ariaLabelAppSwitchIconButton }), showCompanyLogoByProperty && h("div", { key: "549e18052627c090a6ac795276cbb5ca3d44d3a4", class: "logo" }, h("img", { key: "89a662b47ae47e1e2a59065bf67f9abae02aa337", src: this.companyLogo, alt: this.companyLogoAlt })), h("div", { key: "a1f5332a2abc48f3e33fff59d3b1d512b1babab7", class: {
      logo: true,
      "hide-logo": !this.hasSlottedLogo
    } }, h("slot", { key: "d7961a13bcd1939607fc164f38b8a037838c3546", name: "logo", onSlotchange: () => this.hasSlottedLogo = this.checkLogoSlot() })), h("div", { key: "d8824ebba9f3e8c938581d8bc4e822383a014cd4", class: "name" }, h("ix-typography", { key: "e9add4d68d6fb7748d3f660cafea9651512c06b0", format: "body-lg", class: "application-name" }, this.name), this.nameSuffix && this.breakpoint !== "sm" && h("ix-typography", { key: "a4ff0de3510e4466b03818f4cf486e2cf6cf81fa", format: "body-xs", class: "application-name-suffix" }, this.nameSuffix))), h("div", { key: "bace1c6516c55779fb03b24fa17f951d5fbd3380", class: { "right-side": true, sm: this.breakpoint === "sm" } }, this.breakpoint !== "sm" && h("div", { key: "a16cd7e3894c90e3914f1914b4f01b755f86e8f2", class: "secondary" }, h("slot", { key: "46dab9c71d01179bab155b26d74318f5aeac914d", name: "secondary" })), h("div", { key: "5bb2ff0dc16081eb95ad3d2261215b9c91c44591", class: "content" }, this.breakpoint !== "sm" && h("slot", { key: "652934ebe4966258b5574275f130c8ff3c108320" }), h("ix-icon-button", { key: "e43e93204884512375a5e3aa58f8942d5ffadabd", class: {
      "context-menu": true,
      "context-menu-visible": this.hasOverflowContextMenu
    }, "data-context-menu": true, "data-testid": "show-more", icon: iconMoreMenu, variant: "subtle-tertiary", "aria-label": this.ariaLabelMoreMenuIconButton, "aria-hidden": a11yBoolean(!this.hasOverflowContextMenu) }), h("ix-dropdown", { key: "40504c3b1da650adfac72d3b599dc76826f87db3", "data-overflow-dropdown": true, class: "dropdown", discoverAllSubmenus: true, trigger: this.resolveContextMenuButton(), "aria-hidden": a11yBoolean(!this.hasOverflowContextMenu), enableTopLayer: this.enableTopLayer }, h("div", { key: "32354b88745e7d3abc82092508d7e239dc7cdd08", class: "dropdown-content", onClick: (e) => this.onContentBgClick(e) }, this.breakpoint === "sm" && h("div", { key: "fbb40a8a3fc271d790e777e14bd0d761a2ffa9c2", class: {
      "slot-content": true,
      "slot-content-active": this.hasSecondarySlotElements
    } }, h("slot", { key: "8810899a0a8af80c84cbd9ea850571f851133dd1", name: "secondary", onSlotchange: () => this.updateHasSlotAssignedElementsStates() })), this.breakpoint === "sm" && h("div", { key: "29ab95c0abfae49bfcef966e8d886989c5913667", class: {
      "slot-content": true,
      "slot-content-active": this.hasDefaultSlotElements
    } }, h("slot", { key: "1ba46d784afe0ec5cdc13dee3a428b78c8d8ad45", onSlotchange: () => this.updateHasSlotAssignedElementsStates() })), h("div", { key: "426357c44559b9f8e262d327f3f9e9293c3dfdee", class: {
      "slot-content": true,
      "slot-content-active": this.hasOverflowSlotElements
    } }, h("slot", { key: "caa7b3ba3108478d3b50c2a67d33f844f66b9891", name: "overflow", onSlotchange: () => this.updateHasSlotAssignedElementsStates() })))), h("slot", { key: "3816f891d0c7980680d61acd9828e90e01b84e33", name: "ix-application-header-avatar" }))));
  }
  static get watchers() {
    return {
      "applicationLayoutContext": [{
