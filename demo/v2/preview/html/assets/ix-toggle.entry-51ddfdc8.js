...
const Toggle = class {
  ...
  render() {
    ...
    return h(Host, { key: "086b3d227afe02cb008df411da7078153a5a72a2", class: {
      disabled: this.disabled
    }, onBlur: () => this.ixBlur.emit(), onFocus: () => this.touched = true }, h("label", { key: "5b59f409902f09e3858bb9f9c03fd5e8b3cd6674", class: "wrapper" }, h("button", { key: "34117f9eea4e12e5fc1317ed479746a7db1a0b50", role: "switch", "aria-checked": a11yBoolean(this.checked), class: {
      switch: true,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, onClick: () => this.onCheckedChange(!this.checked) }, h("div", { key: "333d358403caef57aaed86dbded7be022dee07fa", class: "slider" })), h("input", { key: "6292b5ac72236b4c03f872675c15d124024735fc", type: "checkbox", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, tabindex: 0, "aria-hidden": a11yBoolean(true), "aria-checked": a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), !this.hideText && h("ix-typography", { key: "0e044447b18d950b84b8a21dceaaf2e89e071737", class: "label" }, toggleText)));
  }
