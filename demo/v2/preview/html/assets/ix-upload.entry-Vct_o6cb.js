...
const Upload = class {
  ...
  render() {
    ...
    }, accept: this.accept, disabled }), h("ix-button", { key: "807022699c0ba9ac3d81557e88cf1ae498a36cca", variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled }, this.i18nUploadFile))));
  }
  get hostElement() {
