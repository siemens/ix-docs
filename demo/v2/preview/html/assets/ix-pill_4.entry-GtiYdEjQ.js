import { M as Mixin, r as registerInstance, g as getElement, h, H as Host, c as createEvent, a as readTask } from "./global-DsITLPyL.js";
...
import { B as BaseTabMixin } from "./tab.mixin-BjAM99yM-DjgIAj3T.js";
...
const Tabs = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    return h(Host, { key: "5554f09b7834c47e4c1890100ed750b15d6858d8", onTabClick: (event) => this.onTabClick(event), class: {
      small: this.small
    } }, h("div", { key: "b076db8284d73f8659cdf2932594133c655d695d", ref: this.tabsContainerRef, class: {
      "tabs-container": true,
      top: this.placement === "top",
      bottom: this.placement === "bottom"
    } }, h("div", { key: "73fa1a3e4ad9b30b6a8a47f8a74a7b44267ae328", class: {
      "overflow-shadow-container": true,
      "overflow-shadow": this.isTabsOverflow
    } }, h("div", { key: "2defca0131e7c714e619f70265d5775d8aebf553", role: "tablist", ...this.inheritAriaAttributes, ref: this.tabsRef, class: {
      tabs: true,
      "tabs-stretched": this.layout === "stretched"
    }, tabIndex: this.isTabsOverflow ? 0 : -1, onKeyDown: (event) => this.onTabsNavigate(event) }, h("slot", { key: "3684ddc5023e0553ab0175150692256fc3109006" }))), this.isTabsOverflow && this.layout !== "stretched" && h("ix-dropdown-button", { key: "6827cbb9086793efd0f496f8ba81f81eba5266e9", ariaLabel: this.ariaLabelMoreTabs, icon: iconMoreMenu, class: {
