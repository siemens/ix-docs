import { g as getElement, a as registerInstance, c as createEvent, h, F as Fragment, H as Host } from "./global-DjWMysHf.js";
...
const Blind = class {
  ...
  render() {
    return h(Host, { key: "08686a07866cce941b0d3fee3c59acda57fd9697", class: {
      [`blind-${this.variant}`]: true
    } }, h("div", { key: "37c3d29dfa4113fa51971c8487158c30dcac0cf6", class: "blind-header-wrapper" }, h("button", { key: "1a725a4d9991ef417fdcd06d83565a994d20bc10", class: {
      "blind-header": true,
      [`blind-${this.variant}`]: true,
      closed: this.collapsed
    }, type: "button", "aria-labelledby": `ix-blind-header-title-${this.blindId}`, "aria-controls": `ix-blind-content-section-${this.blindId}`, "aria-expanded": a11yBoolean(!this.collapsed), onClick: () => this.onHeaderClick() }, h("slot", { key: "acae9cd5182dcfb6003a18713709ef5c5f5ba5c9", name: "custom-header" })), h("div", { key: "c183148b712d24ce5416f704496af3982c5f063c", class: "blind-header-content" }, h("ix-icon", { key: "679080e49ed99d10528d6b44f483349794880e9f", class: "collapse-icon", name: iconChevronDownSmall, color: this.variant === "filled" || this.variant === "outline" ? "color-std-text" : `color-${this.variant}--contrast`, ref: (ref) => this.chevronRef = ref }), h("div", { key: "790921a5077d08519a86e53da114615c62ab3520", class: "blind-header-title", id: `ix-blind-header-title-${this.blindId}` }, this.label !== void 0 ? h(Fragment, null, this.icon && h("ix-icon", { class: "blind-header-title-icon", name: this.icon, color: this.variant === "filled" || this.variant === "outline" ? "color-std-text" : `color-${this.variant}--contrast` }), h("div", { class: "blind-header-title-row" }, h("div", { class: "blind-header-title-col" }, h("ix-typography", { title: this.label, format: "label-lg", bold: true }, h("div", { class: "blind-header-title-label", title: this.label }, this.label))), this.sublabel && h("div", { class: "blind-header-title-col" }, h("ix-typography", { title: this.sublabel }, h("div", { class: "blind-header-title-sublabel" }, this.sublabel)))), h("div", { class: "header-actions" }, h("slot", { name: "header-actions" }))) : null))), h("section", { key: "e009be22aca2af68a71115cd828695ab6f16d230", id: `ix-blind-content-section-${this.blindId}`, "aria-labelledby": `ix-blind-header-title-${this.blindId}` }, h("div", { key: "482ac28924b2edd0b5b6a751a07434764fcb64f8", class: {
      "blind-content": true,
      hide: this.collapsed
