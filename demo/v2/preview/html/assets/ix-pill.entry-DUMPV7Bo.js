...
const Pill = class {
  ...
  render() {
    ...
    return h(Host, { key: "d64b7e45e9f690b80b59564736333c613ffd786e", style: this.variant === "custom" ? {
      "--ix-icon-button-color": this.pillColor
    } : {}, class: {
      "align-left": this.alignLeft
    } }, h("div", { key: "cd9093442c7177383e0796d5158fa52f795db5e9", ref: this.containerElementRef, style: Object.assign({}, customStyle), class: {
      container: true,
    ...
    } }, this.icon && h("ix-icon", { key: "a6432d7c46e88eff87d2242365f671ae87763c85", class: {
      "with-icon": true
    }, name: this.icon, size: "16", "aria-label": this.ariaLabelIcon }), h("span", { key: "c39e4e53da038bdb84952460d9e7892eff4878ce", class: "slot-container" }, h("slot", { key: "78d71f68580f57baf9ba4458ede78c65a5f9cb2c", onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip());
  }
  get hostElement() {
