...
const MenuItem = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    const menuContent = [
      this.icon && h("ix-icon", { key: "64307467f954284272278cca78a80ae4f9c3b95a", class: "tab-icon", name: this.icon, "aria-hidden": "true" }),
      this.notifications ? h("div", { class: "notification" }, h("div", { class: "pill" }, this.notifications)) : null,
      h("span", { key: "1fd2d64f4f8487cb81ad7b981d4f8a0c5ebfb312", id: this.internalItemId, class: "tab-text text-default" }, this.label, h("slot", { key: "571294f967aae798c6a63f3fbcd46aa4453e1263" }))
    ];
    const ariaLabel = this.getAriaLabel();
    return h(Host, { key: "b3583fa356cc996792724ff03627f1a2fc6f9abd", class: {
