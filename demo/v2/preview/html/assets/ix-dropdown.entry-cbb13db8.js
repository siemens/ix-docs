...
const Dropdown = class {
  ...
  render() {
    return h(Host, { key: "13eb6b944c4f6a55bf0a297520476619619cd4d2", "data-ix-dropdown": this.localUId, class: {
      "dropdown-menu": true,
      show: this.show,
    ...
    }, role: "list", onClick: (event) => this.onDropdownClick(event) }, h("div", { key: "3f7278ea90c675638be2719ecb2bcf688e0127b4", style: { display: "contents" } }, this.header && h("div", { key: "05d5e076e236c0ee1eadd55ce7caf8a416e54111", class: "dropdown-header" }, this.header), this.show && h("slot", { key: "9c5c464ff38b241a1167b2d6d3cfff3541dc45b3" })));
  }
  get hostElement() {
