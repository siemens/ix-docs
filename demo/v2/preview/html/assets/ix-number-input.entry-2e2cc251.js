...
import { B as iconMinus, C as iconPlus } from "./index-C0zeM1D4-b0cf2da8.js";
...
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, c as SlotStart, I as InputElement, d as checkAllowedKeys, o as onInputBlur, S as SlotEnd, e as checkInternalValidity } from "./input.util-DORL_qfP-99e0120b.js";
...
const NumberInput = class {
  ...
  render() {
    ...
    return h(Host, { key: "c83ade9e64252b8c223674b7e61b1e7aff877022", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "f7995a0de1bbc41d555f6a98f3a525cc2b62d8b8", id: this.numberInputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "13a504c9c26fd728b5fb18b554a7cbc8dbba0ac1", class: {
      "input-wrapper": true,
      "show-stepper-buttons": !!this.showStepperButtons
    } }, h(SlotStart, { key: "fcdb85b70b032573b3635591504fde8ae2159226", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "5bc5ce8c0797362a5a5a14944df781397aff3767", id: this.numberInputId, readonly: this.readonly, disabled: this.disabled, step: this.step, min: this.min, max: this.max, pattern: this.pattern, type: "number", isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), valueChange: (value) => this.valueChange.emit(Number(value)), updateFormInternalValue: (value) => this.updateFormInternalValue(Number(value)), onBlur: () => {
      onInputBlur(this, this.inputRef.current);
      this.touched = true;
    } }), h(SlotEnd, { key: "74975ab5b2edffeee92d52226409ffae5939f509", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("div", { key: "cea4f57874564d8ff04ccd6cb1c6af498ea02255", class: {
      "number-stepper-container": true,
      "container-hidden": !showStepperButtons
    } }, h("ix-icon-button", { key: "c71acb99b651abe3ff495550b25dabfa1a17efaf", ghost: true, icon: iconMinus, size: "16", class: "number-stepper-button step-minus", "aria-label": "decrement number", onClick: () => {
    ...
    } }), h("ix-icon-button", { key: "c8b2026f7b54b6e0fcba91f7c0019a67032d135d", ghost: true, icon: iconPlus, size: "16", class: "number-stepper-button step-plus", "aria-label": "increment number", onClick: () => {
      if (!this.inputRef.current) {
        return;
      }
