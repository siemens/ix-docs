...
const CardAccordion = class {
  ...
  render() {
    return h(Host, { key: "cdd4feba2b9ae022141114a75d9ae13910c35915", slot: "card-accordion", class: {
      [`variant-${this.variant}`]: true
    } }, h("button", { key: "9357ac651cef1c1d1f570faf906ba08e403652ff", tabIndex: 0, class: { "expand-action": true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, h("ix-icon", { key: "9d55b5013a6f4aff50d9f904e4e0730713c8dcf4", name: iconChevronDownSmall, class: {
      "expand-icon": true,
      show: this.expandContent
    } })), h("div", { key: "57ddf6374b94637e674e1c061344cec87a20addc", class: {
      "expand-content": true,
      show: this.expandContent
    } }, h("div", { key: "bfacd0c7e4202aeba7058bc563b79357dd2d589e", class: "expand-content-inner" }, h("div", { key: "ed870153b656930325a35b0921e8f23f7dcee97e", class: "expand-content-body" }, h("slot", { key: "893b6669078807112cf23c6b17f94eab7697fa34" })), h("div", { key: "d41b94230091bcfedb81305656eb0101e7afb952", class: "expand-content-footer" }))));
  }
  static get watchers() {
    return {
      "collapse": [{
...
const CardHeader = class {
  ...
  render() {
    return h(Host, { key: "e9eaf85f867d2f86338ef00978b70186aa045b72" }, h("slot", { key: "8bbdbd5a707b20d794dbac5e3e3186a954c6d1e0" }), h("div", { key: "767409c623fa8b77edd53c51a9640c41cd76625e", class: "title-actions" }, h("slot", { key: "c9a81e18169fbafa8797f5f9d0ec2dd8926e0259", name: "title-actions" })));
  }
};
