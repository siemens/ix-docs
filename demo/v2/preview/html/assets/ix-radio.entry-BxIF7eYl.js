...
import { a as createClassMutationObserver } from "./validation-BT5aAuSO-Dt-rLTTN.js";
...
const Radio = class {
  ...
  render() {
    ...
    return h(Host, { key: "5e76cfa3be05a7b0354e987f2ec3f3e5df152c4c", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
      ...
      if (this.disabled)
        return;
      this.setCheckedState(true);
    }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, h("label", { key: "78ed2a34ead25c7f1836be8e1588a2cb70c107c0" }, h("div", { key: "a06de9d6645e89b86daa35ff7b495bdf77d72377", class: "radio-button" }, h("div", { key: "bb4e8c6cea96503bc6211c43464ce0ea14923048", "aria-hidden": "true", class: {
      ["radio-checkmark"]: true,
      checked: this.checked
    } }, h("div", { key: "eca09b300d52b090f83e7e6bffa6b08b6bbad30d", class: "checkmark", style: { visibility: this.checked ? "visible" : "hidden" } }))), this.label && h("ix-typography", { key: "e80c0237090a0b5069f6a33ea0aaa831f197da59", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "9a0db47b61423675b443a0e7bb5fa36f99f141ba" }))));
  }
