...
import { f as createPickerValidityStateTracker, b as addDisposableChangesAndVisibilityObservers, c as adjustPaddingForStartAndEnd, i as handleSubmitOnEnterKeydown, S as SlotEnd, j as onInputBlurWithChange, a as SlotStart, g as emitPickerValidityState } from "./input.fc-DjE-oOZc-BEHk-Hap.js";
import { I as InputPickerMixin, h as handleIconClick, o as openDropdown, c as closeDropdown, a as createValidityState } from "./input-picker.mixin-Bo_sZpC4-D9zv-eWY.js";
import { m as makeRef } from "./make-ref-Djkc69iv-BpP6uHEs.js";
import { D as DefaultMixins, h as hasKeyboardMode } from "./component-Chfbghog-DFMCI9TH.js";
import { a as createClassMutationObserver, g as getValidationText, H as HookValidationLifecycle } from "./validation-BT5aAuSO-CbQmWD6n.js";
...
const DateInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "af47e79c993c4001a8c697b4bfa3b71ddf9203c5", class: {
      ...
      this.closeDropdown();
    } }, h("ix-field-wrapper", { key: "f0dae49752dcad20893c2a5bbfc1adf3f4b5cf0d", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "835e7a2a80089aaf8c1837640750984433213ae9", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      ...
      return true;
    }, keyboardActivationKeys: ["ArrowUp", "ArrowDown"] }, h("ix-date-picker", { key: "07e0853b98afa498819fe3b4c8a87915368f0be6", ref: this.datepickerRef, format: this.format, locale: this.locale, singleSelection: true, from: this.from ?? "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
