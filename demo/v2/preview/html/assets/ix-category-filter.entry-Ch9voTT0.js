...
const CategoryFilter = class {
  ...
  render() {
    return h(Host, { key: "6ae51946907b11bab602d5ffd6da9bbdbc07747c" }, h("form", { key: "e0a2200a1a6779b8317269384e9e075bdb6769eb", ref: (el) => this.formElement = el }, h("div", { key: "3889ea9b0cc83ec856105984732fcb0ca0919d57", "read-only": this.readonly, class: {
      "input-container": true,
      disabled: this.disabled,
      focus: this.hasFocus,
      readonly: this.readonly,
      "no-icon": this.hideIcon
    } }, h("ix-icon", { key: "0529e9e8f8b0bd23ecf205f0cc4ac3a42d72adf6", color: this.getIconColor(), class: { "display-none": this.hideIcon }, name: this.icon ?? iconSearch, size: "16" }), h("div", { key: "c7dc47f6e906b9a0cd245fbd7468b61fed49e0e0", class: "token-container" }, h("div", { key: "df8071f216314251b9f6c58ca115591734548ff9", class: "list-unstyled" }, this.filterTokens.map((value, index) => h("span", { key: value.toString(), class: {
    ...
    } }, this.categories[this.category]?.label), h("input", { key: "5a27624a1f2e967caa57b18fdf7145da9dfbf4f9", class: {
      "text-input": true,
