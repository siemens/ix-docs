...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "5eed909b2857b9bfbea41402736fe01d7ad9a434", class: {
      disabled: this.disabled,
      invalid: this.isInvalid,
      info: this.isInfo,
      valid: this.isValid,
      warning: this.isWarning
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "6f5ef62c132260787b91ea5b5f08faf21153735f", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "c67536334750605b342859dbf6c38abcc730c6a6", class: "slider-container" }, h("div", { key: "33649db602e05ea4f2496c6b7b5a3620eca81a49", class: "slider" }, h("div", { key: "f282b195ad420d036e90b4cc45c59fe9232b5919", class: "track" }, h("div", { key: "f68211f2d377f2741eaedcdc4ca7fcbcd0f1bbfb", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "50576c072bbd33c8689017d7f67b83694d73516c", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "3ee47514d9a51488410c2b0984f05f39e74153a7", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "740ea0d7cf7a200c7db7ea8ac70fd2537b84b4a5", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "d5264eaabacd9f667600df1f0cdf8e89b24d7730", class: "label" }, h("div", { key: "4ac2ebda49543e04e619452bd59c3f30a0404879" }, h("slot", { key: "dcc9ecd173f1d49133e1070b72b34b8485cc9860", name: "label-start" })), h("div", { key: "022869a430a0644e24932553a321da5fa8dd4df2" }, h("slot", { key: "4da9fdcb1d570657a3796a32d0925025e16dc4b7", name: "label-end" }))))));
  }
