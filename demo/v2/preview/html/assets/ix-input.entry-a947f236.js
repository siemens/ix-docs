import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from "./global-9b2308da.js";
import { t as iconEye, u as iconEyeCancelled } from "./index-v48bcPT9-71a9ba2b.js";
import { H as HookValidationLifecycle } from "./validation-CS0nhfz1-5a0b6c27.js";
import { m as makeRef } from "./make-ref-bcj7UEIC-1c3883ca.js";
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, g as getAriaAttributesForInput, c as SlotStart, I as InputElement, d as checkAllowedKeys, o as onInputBlur, S as SlotEnd } from "./input.util-DORL_qfP-5a1e25e1.js";
...
const Input = class {
  ...
  render() {
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "531e06087e92d7f37bcf0db3a9d6848aca652042", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, (_a = this.value) === null || _a === void 0 ? void 0 : _a.length, "/", this.maxLength)));
  }
