...
import { B as BaseButton } from "./base-button-DZdtpLxn-mxC7BreK.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "5df489d50a9e459fcf350fcaf20dad2f3c6d09d8", onFocusout: (event) => {
      ...
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "a457c4586b7d426cb3177b13ada395cd142c554c", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "4843647a409bf919d4221187eeb4fb9285a53f0e", focusTrapOptions: {
    ...
    } }, h("div", { key: "b56022ada38073e8f0eb41e45fe77ff9e7266619", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "08899447b48dbb8e0a9afd9869611694f859de8c", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "8c61f1698346dcbd76f6ac011c54c0034b19db70", class: "picker-wrapper" }, h("ix-date-picker", { key: "d9f6d28e64a07aedd2f66a5edbb8c470e908b87e", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "1dc08213a7637d97a129484b84206f9c030448fd", class: "pull-right" }, h("ix-button", { key: "fcdcc6e21a4aad47466ce6354d75286eed642081", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
