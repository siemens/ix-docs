...
import { B as BaseButton } from "./base-button-DZdtpLxn-BH2mB44j.js";
...
const DateDropdown = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    ...
    return h(Host, { key: "22f023b7eebe6aeb1d1fb43e6fd9fca761fbb654", onFocusout: (event) => {
      const relatedTarget = event.relatedTarget;
      if (!relatedTarget) {
        return;
      }
      this.closeDropdown();
    }, role: "presentation" }, h("ix-button", { key: "79990d758b39d7f8438d7333f1c148f94665f157", "data-testid": "date-dropdown-trigger", "data-date-dropdown-trigger": true, variant: this.variant, loading: this.loading, icon: iconHistory, ref: this.triggerRef, disabled: this.disabled, ...this.inheritAriaAttributes, "aria-haspopup": "true", "aria-expanded": a11yBoolean(this.show), "aria-controls": "date-dropdown", "aria-label": ariaLabel, [TRAP_FOCUS_EXCLUDE_ATTRIBUTE]: true }, this.getButtonLabel()), h("ix-dropdown", { key: "04df9639b41dc3084e0a035e39441a64fb5398aa", focusTrapOptions: {
    ...
    } }, h("div", { key: "23f80678526a96c98c84130b820932ac449bfdb6", class: "container" }, this.dateRangeOptions?.length > 1 && h("div", { key: "e0ca957c06b3bf7ab910687958d9744e1bccba5e", class: {
    ...
    } }, dateRangeOption.label))), h("div", { key: "47498278df33744c548709315f7e4f88b946c1cb", class: "picker-wrapper" }, h("ix-date-picker", { key: "7d2f12fcc2cd5018edfec3aa387f5ede6704bd04", ref: this.datePickerRef, embedded: true, locale: this.locale, onDateChange: (e) => {
      e.stopPropagation();
      this.currentRangeValue = {
        ...e.detail,
        id: "custom"
      };
    }, onDateRangeChange: (e) => e.stopPropagation(), format: this.format, singleSelection: this.singleSelection, from: this.from || this.currentRangeValue?.from, to: this.to || this.currentRangeValue?.to, minDate: this.minDate, maxDate: this.maxDate, today: this.today, weekStartIndex: this.weekStartIndex, showWeekNumbers: this.showWeekNumbers }), h("div", { key: "b1b223d1116fdd455887e985aa8906c24de5b990", class: "pull-right" }, h("ix-button", { key: "f788cee56c6aefaa3de91cabad89c01499d1b036", onClick: () => {
      if (this.currentRangeValue) {
        this.onDateSelect(this.currentRangeValue);
        this.closeDropdown();
      }
