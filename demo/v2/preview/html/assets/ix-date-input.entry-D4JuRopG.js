...
import { c as createPickerValidityStateTracker, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, o as onEnterKeyChangeEmit, h as handleSubmitOnEnterKeydown, S as SlotEnd, d as onInputBlurWithChange, e as SlotStart, f as emitPickerValidityState } from "./input.fc-C1ytwpkt-bTPpCuNQ.js";
...
const DateInput = class {
  constructor(hostRef) {
    ...
    this.ariaLabelCalendarButton = "Open calendar";
    this.readonly = false;
    this.disabled = false;
  ...
  renderInput() {
    ...
    } }), h(SlotEnd, { slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { "data-testid": "open-calendar", class: { "calendar-hidden": this.disabled || this.readonly }, variant: "subtle-tertiary", size: "16", icon: iconCalendar, onClick: (event) => this.onCalenderClick(event), "aria-label": this.ariaLabelCalendarButton })));
  }
  ...
  render() {
    ...
    return h(Host, { key: "a188d09b1e24447e3fbc5a7a09c6e34042548a8c", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "c50fde9b3aee7a2645a70fd3bb090471f633d6a9", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "7a95a993e629b158905a32c1538e96a2d6275799", "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    } }, h("ix-date-picker", { key: "7375826a1d3df9751f387422db39206bc4fd4837", ref: this.datepickerRef, format: this.format, locale: this.locale, singleSelection: true, from: (_a = this.from) !== null && _a !== void 0 ? _a : "", minDate: this.minDate, maxDate: this.maxDate, onDateChange: (event) => {
