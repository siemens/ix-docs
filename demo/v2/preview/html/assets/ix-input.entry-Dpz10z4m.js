...
import { m as mapValidationResult, a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, g as checkInternalValidity, i as getAriaAttributesForInput, e as SlotStart, I as InputElement, d as onInputBlurWithChange, o as onEnterKeyChangeEmit, j as onInputFocus, k as checkAllowedKeys, S as SlotEnd } from "./input.fc-C1ytwpkt-bTPpCuNQ.js";
...
const Input = class {
  ...
  render() {
    ...
    return h(Host, { key: "966efdac8aabf6e8eda4c70a70d996b66406e426", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "565c9cf09e3de197bdc6aab9038f05c13eddc311", htmlForLabel: this.inputId, required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: "73f3a4eb7eeec903148afc9ab0e03409808773ce", class: "input-wrapper" }, h(SlotStart, { key: "5610b1d97825d73045a3d5b20cd0b4da1e323a34", slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h(InputElement, { key: "aea0aeb380fac786174a380531143ee08ca94e48", id: this.inputId, readonly: this.readonly, disabled: this.disabled, maxLength: this.maxLength, minLength: this.minLength, pattern: this.pattern, type: this.inputType, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, inputRef: this.inputRef, onKeyPress: (event) => checkAllowedKeys(this, event), onFocus: () => onInputFocus(this, this.value), onEnterKeyChange: (event) => onEnterKeyChangeEmit(event, this, this.value), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
      onInputBlurWithChange(this, this.inputRef.current, this.value);
      this.touched = true;
    }, ariaAttributes: inputAria, form: (_a = this.formInternals.form) !== null && _a !== void 0 ? _a : void 0, suppressSubmitOnEnter: this.suppressSubmitOnEnter, textAlignment: this.textAlignment }), h(SlotEnd, { key: "3615ad5161239494a9a252ed9aeb3ea493d7d817", slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { key: "0b0837ae35a5d110794ce32ba3c28db4dce0083a", color: "color-weak-text", class: {
      "password-eye": true,
    ...
    } }))), !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "0f3ed7f624fe620793cdd7a8fb2695d54dbcea33", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, ((_b = this.value) !== null && _b !== void 0 ? _b : "").length, "/", this.maxLength)));
  }
