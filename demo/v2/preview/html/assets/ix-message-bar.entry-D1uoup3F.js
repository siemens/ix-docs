...
const MessageBar = class {
  ...
  render() {
    return h(Host, { key: "958c28d0bae524a1041a8118d9313972139f1f4a" }, h("div", { key: "8e619088864f0475559795ac309e1fbfc8bc1bb3", class: { "message-container": true, [this.type]: true }, role: "alert", ref: (el) => this.divElement = el }, h("ix-icon", { key: "e21c8715adb8ec071aebb393896b20ae41f0cab5", color: this.color, name: this.icon }), h("div", { key: "060da1ce54e588666ec3c8be27b322bef8cbc85d", class: "message-content" }, h("slot", { key: "0d7485fcf2b06989e6a385050622236ad71d96e3" })), !this.persistent && h("ix-icon-button", { key: "dab714f06d4f20c379c661f638bffe809778d1d8", icon: iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => {
      if (this.divElement) {
