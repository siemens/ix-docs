import { r as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-BTgWS9s6.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "05fdc1eb3f6a434211e126fb459e436c468476f8", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate,
      "label-less": this.isLabelLess
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "5744fe6dba111b58198ba38de30d376444721edb" }, h("input", { key: "45bd0ed2504a239e6ffe363d1129b3932eab9080", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("div", { key: "64a0a64c6852864c9fb740760998fd56fbd44f91", class: "checkbox-button" }, h("button", { key: "8d61df6001508ca11db0befd17e2e481f69645bf", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark())), h("ix-typography", { key: "20a3e1dee55ba2d6920450b7cb257588ebbc405d", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "2741ee937a1351059df0bcc0a5923053e771f01f", onSlotchange: () => this.updateDefaultSlotElements(), ref: (element) => this.defaultSlotElement = element }))));
  }
