...
import { M as iconChevronUpSmall, r as iconChevronDownSmall, N as iconChevronUp, j as iconChevronDown } from "./index-C0zeM1D4-b0cf2da8.js";
...
const TimePicker = class {
  ...
  render() {
    ...
    return h(Host, { key: "ca2ec790cf043c8b2feff5115c9232dfd72b97c2" }, h("ix-date-time-card", { key: "7b88267d09161302048127c8e02047011107e688", standaloneAppearance: this.standaloneAppearance, corners: this.corners }, h("div", { key: "69521e2715c1912ed0dc7075ab2b65ef39daabf7", class: "header", slot: "header" }, h("ix-typography", { key: "2788a3fa850490a2e3f8a0906220b619f43ef2df", format: "h5" }, this.textTime || "Time")), h("div", { key: "43a17674c67751b4e77df0261726ce89eb9bc7f8", class: "clock" }, timepickerInformation.map((descriptor, index) => h("div", { class: "flex" }, h("div", { class: { columns: true, hidden: descriptor.hidden } }, h("ix-icon-button", { size: "16", onClick: () => {
      var _a;
    ...
    } }, ":"))), h("div", { key: "1f15de8dfe83cd44c7100a8836189ded52c0ca1f", class: {
      columns: true,
      "default-space": true,
      hidden: this._timeRef === void 0
    } }, h("ix-icon-button", { key: "25643a6cb64f4279753dc9b2f9d539d671df5645", size: "16", onClick: () => this.changeTimeReference(), ghost: true, icon: iconChevronUp, variant: "primary", class: "arrows" }), h("div", { key: "4faa8d2ac7469671b7572c0ecccc69f926484b33", class: "time-reference" }, this._timeRef), h("ix-icon-button", { key: "ce678a5dd6983db6ae6ef1e624fcd23bbd77f246", size: "16", onClick: () => this.changeTimeReference(), ghost: true, icon: iconChevronDown, variant: "primary", class: "arrows" }))), h("div", { key: "81b7c028586af646dc658fc52776bd97de131f0a", class: {
      button: true,
      hidden: !this.standaloneAppearance,
      standalone: true
    } }, h("ix-button", { key: "0bf7396acad24b43a395dde23defc5d56bc4b11d", onClick: () => {
      var _a;
