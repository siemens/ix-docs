...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "7cbc0656b5c4c2ec4057733c7eb652004ebdc383", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "7c1ea7ef3cf622297ea4363908baf81a9db99dda", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "f6292f3f589efc59514c6998a2ccb7cce694e40e", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "8b1a984c693aae6838e0c502fa8002ca64d9ca45", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "794a1436c031004c6353bbaa0a6c232ac26fe173", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "ec37b0262e2c6b9111753e91388b82db166f7e4c", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "525da27f90b187e64800360a2e49ee3547ea23d6", class: "title-text-overflow" }, h("ix-typography", { key: "b11a3a538ffb8db6be4dee5f64d18f9d9e0b78a3", format: "h4" }, this.heading)), this.expanded && h("div", { key: "eee6ca859602eb76be791238ca93eda110a61fd9", class: "slot-header" }, h("slot", { key: "c494d88c9d5c58a2d69a6c95e520e1864a80a275", name: "header" })))), h("div", { key: "0ce9b176670c9493b900ef86e2d6f1ff0719910b", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "34491085f2d7ccacba88b177c7db695062e42b29" }))));
  }
  static get watchers() {
    return {
      "expanded": [{
