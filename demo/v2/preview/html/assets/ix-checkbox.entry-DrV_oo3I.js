import { a as registerInstance, c as createEvent, g as getElement, h, F as Fragment, H as Host } from "./global-DjWMysHf.js";
...
const Checkbox = class {
  ...
  render() {
    return h(Host, { key: "7cf9106ea2b83fcc4913a4552cf91c09f0a0ec16", "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
      disabled: this.disabled,
      checked: this.checked,
      indeterminate: this.indeterminate
    }, onFocus: () => this.touched = true, onBlur: () => this.ixBlur.emit() }, h("label", { key: "ea4e86f56eb29791d77991e31a95bc0e8958b943" }, h("input", { key: "59446931420ba7c117d6b8bc392cdcd5c99723ae", "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("button", { key: "842691bcb514facd3f0588b8d49e069ac6655866", disabled: this.disabled, class: {
      checked: this.checked
    }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark()), h("ix-typography", { key: "92c580ec9a1ffdb83b0d7dc5d0d8a5addfad7432", format: "label", textColor: this.disabled ? "weak" : "std" }, this.label, h("slot", { key: "ae78de9041287d4ea3ad3820be9ba6f4fc062b2e" }))));
  }
