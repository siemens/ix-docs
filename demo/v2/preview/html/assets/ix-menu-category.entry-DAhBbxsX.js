...
const MenuCategory = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "593b29c5f5cf2e63cc6c1492f6f90fc7bddb3bd8", class: {
    ...
    } }, h("ix-menu-item", { key: "35bfb38e90317bf2459bce59860ba0f74e8174f1", ...inheritedA11yWithoutRole, "aria-haspopup": "menu", "aria-expanded": this.showItems || this.showDropdown ? "true" : "false", id: this.categoryId, ref: this.categoryParentRef, class: "category-parent", active: this.isNestedItemActive(), notifications: this.notifications, icon: this.icon, onClick: (e) => this.onCategoryClick(e), onKeyDown: (event) => this.onKeyDown(event), tooltipText: this.tooltipText, isCategory: true, menuCategoryLabel: this.label }, h("span", { key: "2ea2e12dad87e97ebb8ebac718cae45309e42eb2", class: "category" }, h("span", { key: "9ffeb1f8b799f59228a43d1d5c8c850a45ce3c25", class: "category-text" }, this.label), h("ix-icon", { key: "47cceda4005228068e13a36addcd60c01a1d1efc", name: iconChevronDownSmall, class: {
      "category-chevron": true,
      "category-chevron--open": this.showItems
    }, "aria-hidden": "true" }))), h("div", { key: "5dff5d2e58da8af82e56d927cdec4c2d8d52ee67", ref: (ref) => this.menuItemsContainer = ref, class: {
      "menu-items": true,
      "menu-items--expanded": this.showItems,
      "menu-items--collapsed": !this.showItems
    }, role: "menu", "aria-labelledby": this.categoryId, onKeyDown: (e) => this.onMenuItemsKeyDown(e) }, this.showItems ? h("slot", null) : null), h("ix-dropdown", { key: "17963ff7cb90f56843d13b8d10a34d2efe56427d", ref: this.dropdownRef, hostRole: "menu", "aria-label": this.label, closeBehavior: "both", show: this.showDropdown, onShowChange: ({ detail }) => this.onDropdownShowChange(detail), onShowChanged: ({ detail }) => this.onDropdownShowChanged(detail), class: "category-dropdown", anchor: this.hostElement, placement: "right-start", offset: {
      mainAxis: 3
    ...
    }, onFocusout: () => this.onDropdownFocusOut() }, h("ix-dropdown-item", { key: "76a24a1e7fdaa4cb8263fd3fc2a0f65e3bdb9674", class: "category-dropdown-header", tabindex: -1, "aria-hidden": "true" }, h("ix-typography", { key: "5d11df71fc842c0968c9069340b0f208500e0d25", format: "label", bold: true, textColor: "std" }, this.label)), h("ix-divider", { key: "3bb9b931667a4ed2ee32a230ffe6a7f8bae8e2b7" }), h("slot", { key: "c37ca19af5209ec8129527e0c41c62f2b3f5d809" })));
  }
