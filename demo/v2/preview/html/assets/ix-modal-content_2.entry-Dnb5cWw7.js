import { a as registerInstance, h, H as Host, c as createEvent, g as getElement } from "./global-DjWMysHf.js";
...
const ModalHeader = class {
  ...
  render() {
    return h(Host, { key: "a0e2437fa84c933cb035e3f756f35c852a629411" }, this.icon ? h("ix-icon", { name: this.icon, color: this.iconColor, size: "32", "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "ed879eadde24489324a857524b2dcdda2daf553d", class: "modal-title" }, h("ix-typography", { key: "f6058f099376e581e2c9d34f880dca129cb83e04", format: "h5" }, h("slot", { key: "25d3602826270d81e5d8c423fc197bc0e5fa6209" }))), !this.hideClose ? h("ix-icon-button", { class: "modal-close", onClick: (event) => this.onCloseClick(event), variant: "tertiary", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseIconButton }) : null);
  }
