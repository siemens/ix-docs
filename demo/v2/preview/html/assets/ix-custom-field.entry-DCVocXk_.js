...
const CustomField = class {
  ...
  render() {
    return h(Host, { key: "3865a646510b0a6c599fdeb3adb29d58f311d8d4" }, h("ix-field-wrapper", { key: "bfaa5e15d46ce3328c072c1888ea3ca2a8f82521", label: this.label, helperText: this.helperText, infoText: this.infoText, warningText: this.warningText, invalidText: this.invalidText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, required: this.required }, h("slot", { key: "6fc00234329533b6876319d7a851f417a0e9a4d3" })));
  }
};
__decorate([
