...
const DropdownHeader = class {
  ...
  label;
  render() {
    return h(Host, { key: "a37577958aebbbdec0ccbc7b445813311eb8e615" }, h("ix-typography", { key: "2c564a3e854b143cac4299f6886f95fda961de3e", class: "category-text", format: "h5" }, this.label));
  }
};
