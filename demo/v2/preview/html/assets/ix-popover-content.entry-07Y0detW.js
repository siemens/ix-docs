...
const PopoverContent = class {
  ...
  noPadding = false;
  render() {
    return h(Host, { key: "2dc14073545f57f65c6901dc69d7f721df98f3b1", class: { "no-padding": this.noPadding }, [TRAP_FOCUS_INCLUDE_ATTRIBUTE]: true }, h("slot", { key: "aa44ae3c40f423be58fc5cb1d0f1b535175d8c7f" }));
  }
};
