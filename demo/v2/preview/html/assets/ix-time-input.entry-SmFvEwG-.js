...
import { f as createPickerValidityStateTracker, o as onEnterKeyChangeEmit, i as handleSubmitOnEnterKeydown, b as addDisposableChangesAndVisibilityObservers, c as adjustPaddingForStartAndEnd, S as SlotEnd, j as onInputBlurWithChange, a as SlotStart, g as emitPickerValidityState } from "./input.fc-DjE-oOZc-BEHk-Hap.js";
...
const TimeInput = class extends Mixin(...DefaultMixins, InputPickerMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "293a527e1b0337b962eb6c24680df978c9b1356d", class: {
      disabled: this.disabled,
      readonly: this.readonly
    }, onFocusout: () => {
      this.closeDropdown();
    } }, h("ix-field-wrapper", { key: "103566ac44e0dacb9f8e979c16c5ebb53cc144d9", label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: "7cdaaa66afbf87e052b8b2548e002b901c1879e5", "data-testid": "time-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", enableTopLayer: this.enableTopLayer, suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
      this.show = event.detail;
    }, focusTrapOptions: {
      targetElement: this.timePickerRef,
      trapFocusInShadowDom: true
    } }, h("ix-time-picker", { key: "6018c8f9c77ffb1f37f9ca3e4d8b789b28076323", ref: this.timePickerRef, format: this.format, time: this.time ?? "", minTime: this.minTime, maxTime: this.maxTime, hourInterval: this.hourInterval, minuteInterval: this.minuteInterval, secondInterval: this.secondInterval, millisecondInterval: this.millisecondInterval, embedded: true, hideHeader: this.hideHeader, i18nConfirmTime: this.i18nSelectTime, i18nHeader: this.i18nTime, i18nHourColumnHeader: this.i18nHourColumnHeader, i18nSecondColumnHeader: this.i18nSecondColumnHeader, i18nMinuteColumnHeader: this.i18nMinuteColumnHeader, i18nMillisecondColumnHeader: this.i18nMillisecondColumnHeader, onTimeSelect: (event) => {
