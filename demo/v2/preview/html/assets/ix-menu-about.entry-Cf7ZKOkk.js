import { r as registerInstance, c as createEvent, g as getElement, f as forceUpdate, h, H as Host } from "./global-DsITLPyL.js";
...
const MenuAbout = class {
  ...
  render() {
    return h(Host, { key: "4a505ef81bfc9d96cbff402d014f8b31e3a72957", slot: "ix-menu-about", class: {
      show: this.show,
      ["legacy-tabs"]: !this.suppressLegacyTabs
    } }, h("div", { key: "12702e8e4b905e2c7f7b4f25641a59df69fd595f", class: "about-header" }, h("h2", { key: "5277ff2507f0d623cce94150e680a3c4bbc844eb", class: "text-h2" }, this.label), h("ix-icon-button", { key: "8d27723ee3caacc43fc90e2dca417af2f5897e11", variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseButton, onClick: (e) => this.close.emit({
      name: "ix-menu-about",
      nativeEvent: e
