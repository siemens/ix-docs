import { r as registerInstance, h, H as Host, c as createEvent, g as getElement } from "./global-C4tOo1JZ.js";
...
const ModalContent = class {
  ...
  render() {
    return h(Host, { key: "bdcc31e92318ad5f9b10a5ece22fc01f2506e200" }, h("slot", { key: "a7af3070d7d9766ea450e4a75417b4ae0f1137d3" }));
  }
};
...
const ModalHeader = class {
  ...
  render() {
    return h(Host, { key: "2840ba385c7ad659786f48564bf307c2290049ca" }, this.icon ? h("ix-icon", { name: this.icon, color: this.iconColor, size: "32", "aria-label": this.ariaLabelIcon }) : null, h("div", { key: "5e6ce56e0e76e527a3e71e66ea2a4ec2d22a2ed7", class: "modal-title" }, h("ix-typography", { key: "cd8c3d8cdfbdfed8a1ab2285328c88985843a8b5", format: "h5" }, h("slot", { key: "1de70c68751fb8ece53890adf94b95c2bfcbd66d" }))), !this.hideClose ? h("ix-icon-button", { class: "modal-close", onClick: (event) => this.onCloseClick(event), variant: "tertiary", icon: iconClose, iconColor: "color-soft-text", "aria-label": this.ariaLabelCloseIconButton }) : null);
  }
