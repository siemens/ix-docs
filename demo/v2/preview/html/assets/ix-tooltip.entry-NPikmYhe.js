...
const Tooltip = class {
  ...
  render() {
    return h(Host, { key: "fe826b9faedc373c7ed059d063cc0f41fbfc6178", role: "tooltip", class: { visible: this.visible } }, h("dialog", { key: "4c3615e531e598ca3bfb71f5d96d0c510d14a18f", ref: this.dialogRef, id: "tooltip-" + this.instance, class: "dialog", popover: "manual", inert: !this.visible }, h("div", { key: "d9b77b657d7c96525f12bc0c357f37be745b0df2", class: "tooltip-container" }, h("div", { key: "3226301a8e9a91c6ca0d9e7a1268357c94885461", class: "content-wrapper" }, h("div", { key: "224fd0e67de09fc486e02bf2d1023d7ed0fce25a", class: "tooltip-title" }, h("slot", { key: "16c48a015cd22857dbe43ff941a6a380e14b89dc", name: "title-icon", onSlotchange: (e) => this.handleTitleIconSlotChange(e) }), h("ix-typography", { key: "ef2a7d59693e79d1a40ed44705841af6101e9949", format: "h5" }, this.titleContent, h("slot", { key: "64f1d0ab84cbbf75067447c123e6a970d2e06545", name: "title-content" }))), h("slot", { key: "fd235ecbcd9862169fb6f825d6260f817b30d073" }), h("div", { key: "be5d8640b05978f23a4ccab0271262dbbe712890", class: "arrow" })))));
  }
};
