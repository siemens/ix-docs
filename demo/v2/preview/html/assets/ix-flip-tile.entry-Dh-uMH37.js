...
const FlipTile = class {
  ...
  render() {
    return h(Host, { key: "7bc177cf90b779cb1bd62d6350ff54717d538d9d", class: {
    ...
    } }, h("div", { key: "eb5ef0d6d6eaa317bcf80883dd11ce25294fa421", class: "flip-tile-container" }, h("div", { key: "8e861ac9d55afff755a2bdc71f10ce190a2a8e9b", class: "flip-tile-header" }, h("div", { key: "02976c0cd61c9b4957e5d2e6ea4e9a9b21dc53cb", class: "header-slot-container text-l-title" }, h("slot", { key: "3ae486e56833ccabf4d03e5c2b5ca6c6823bc221", name: "header" })), h("ix-icon-button", { key: "61b1a2afbfed9fca1cd1ef2276b4d74554abb2af", icon: iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), h("div", { key: "f2b4b94a81ad12a02b182dcb95d03a67b9d89aa5", class: "content-container" }, h("slot", { key: "d9892f4613eb61ab72c73e69dd766002c3d1c173" })), h("div", { key: "8c0b61ce539b83a98df94c9b7ee656c09ef38818", class: {
      footer: true,
      "show-footer": this.hasFooterSlot
    } }, h("slot", { key: "6af34d8dddef92ac78d5a8772035ca380da4525a", name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) }))));
  }
  static get watchers() {
    return {
      "index": [{
