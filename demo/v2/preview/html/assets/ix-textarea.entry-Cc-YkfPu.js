...
import { m as mapValidationResult, g as checkInternalValidity, T as TextareaElement, o as onInputBlurWithChange, f as onInputFocus, i as getAriaAttributesForInput } from "./input.fc-CE3kP-L_-Djevl-Xp.js";
...
const Textarea = class {
  ...
  render() {
    return h(Host, { key: "25fd15e33b307ef6679fa4ecb743675e193b5c66", class: {
      disabled: this.disabled,
      readonly: this.readonly
    } }, h("ix-field-wrapper", { key: "e710567e5ad61faaaa6ca856371adec196c14811", required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.textAreaRef }, !!this.maxLength && this.maxLength > 0 && h("ix-typography", { key: "5971779593dae3517af5cd174000a7c5cb8c1cdc", class: "bottom-text", slot: "bottom-right", textColor: "soft" }, (this.value ?? "").length, "/", this.maxLength), h("div", { key: "73a09a125b0cdd366fa916071784290d1acff350", class: "input-wrapper" }, h(TextareaElement, { key: "d79416a34716bf036e0a8943904c1986793c3399", id: this.inputId, minLength: this.minLength, maxLength: this.maxLength, textareaCols: this.textareaCols, textareaRows: this.textareaRows, textareaHeight: this.getTextareaHeight(), textareaWidth: this.getTextareaWidth(), resizeBehavior: this.resizeBehavior, readonly: this.readonly, disabled: this.disabled, isInvalid: this.isInvalid, required: this.required, value: this.value, placeholder: this.placeholder, textAreaRef: this.textAreaRef, ariaAttributes: getAriaAttributesForInput(this), onFocus: () => onInputFocus(this, this.value), valueChange: (value) => this.valueChange.emit(value), updateFormInternalValue: (value) => this.updateFormInternalValue(value), onBlur: () => {
