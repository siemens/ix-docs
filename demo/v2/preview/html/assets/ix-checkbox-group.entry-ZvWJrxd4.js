...
const CheckboxGroup = class {
  ...
  render() {
    return h(Host, { key: "7ce000341dfbf0b447b05cf56eb0c0f0ce6ced71", ref: this.groupRef, onIxBlur: () => this.touched = true }, h("ix-field-wrapper", { key: "c993e1c79c87c4bf67937c1656c30959cc290f78", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, validText: this.validText, warningText: this.warningText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isInfo: this.isInfo, isValid: this.isValid, isWarning: this.isWarning, controlRef: this.groupRef }, h("div", { key: "78a0cfe64c2f3f2de8574282f36531e4c4aa9012", class: {
      "checkbox-container": true,
      "row-layout": this.direction === "row"
    } }, h("slot", { key: "1b90032207b05a058e5639e08c997269a683b504" }))));
  }
};
__decorate([
