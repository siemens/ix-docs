...
import { H as HookValidationLifecycle } from "./validation-DXpftrw5-DiHPxf5A.js";
...
const Slider = class {
  ...
  render() {
    ...
    return h(Host, { key: "bc904df57adc690f6a26d435f1c82d14755c6754", class: {
      disabled: this.disabled,
      invalid: this.isInvalid,
      info: this.isInfo,
      valid: this.isValid,
      warning: this.isWarning
    }, onPointerDown: () => setTimeout(() => this.showTooltip = true) }, h("ix-field-wrapper", { key: "e346c24bf005ec2aa06af0729f4af521f72ec2b9", label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, isInvalid: this.isInvalid, controlRef: this.controlRef }, h("div", { key: "3aa92608f9401f269cf8227e5ccede8439c1b678", class: "slider-container" }, h("div", { key: "cdd7636f0eddaa870f33bbb505fbdeedf808bfe9", class: "slider" }, h("div", { key: "154a03a58b01cb76e753c96c2f5bc87fa939b184", class: "track" }, h("div", { key: "baf3ff99733257bd3a7697a8f7dbe5626147d722", ref: this.thumbRef, class: "thumb", style: {
      left: `calc(${valueInPercentage} * (100% - 1rem))`
    } }), h("svg", { key: "1242b04782e64afeb3e4f7b3c735c1be96372923", class: "ticks", xmlns: "http://www.w3.org/2000/svg" }, this.marker?.filter((markerValue) => markerValue >= this.min && markerValue <= this.max).map((markerValue) => {
    ...
    }))), h("input", { key: "c10155a18c3f0c1edb8bd6f12214de818db74beb", id: "slider", ref: this.controlRef, type: "range", list: this.marker ? "markers" : void 0, step: this.step, min: this.min, max: this.max, value: this.rangeInput, tabindex: this.disabled ? -1 : 0, onInput: (event) => this.onInput(event), onFocus: () => {
    ...
    }, role: "slider", "aria-valuenow": this.rangeInput, "aria-valuemin": this.min, "aria-valuemax": this.max, ...this.a11yAttributes }), h("ix-tooltip", { key: "ace607a123ece9ce604f1ec2b6ce870fbbc2d20e", ref: this.tooltipRef, class: {
      "hide-tooltip": !this.showTooltip
    }, animationFrame: true, for: this.thumbRef.waitForCurrent() }, this.rangeInput)), this.hasLabels && h("div", { key: "0e59aadf74934ffc7067ad336c5a4156189b8ae8", class: "label" }, h("div", { key: "20af42d330da5d8b5e9888378d5f09b9591c054d" }, h("slot", { key: "e1c21828426fb53c2e5dffe2a4a305a114d83359", name: "label-start" })), h("div", { key: "27c5122383b81b204ffeed99a754d8275e77eb40" }, h("slot", { key: "d6766ea6f1f690423e55858a1866a0263749cc7f", name: "label-end" }))))));
  }
