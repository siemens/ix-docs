...
const Group = class {
  ...
  render() {
    return h(Host, { key: "c13fd65df4bb7ae59e242214a037dbb403264879" }, h("div", { key: "2c9daf5ca7335038e771aadafab3d11648739a8e", class: {
      "group-header": true,
      expand: this.expanded,
      selected: this.selected
    }, tabindex: "0" }, h("div", { key: "b5d1a6e9a478478909e2cd27bb8fe07ce5ae455f", class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, h("div", { key: "0304ea3dc12318458f710aa0c8e6747a5a945d7d", class: {
      "group-header-selection-indicator": true,
      "group-header-selection-indicator-item-selected": this.itemSelected
    } }), h("div", { key: "f414bf98c9d8f68217714476411286322005c984", class: "btn-expand-header" }, h("ix-icon", { key: "2c998a5aa350830b9ed3043aacfa236b1693197c", "data-testid": "expand-collapsed-icon", class: {
      hidden: !this.showExpandCollapsedIcon
    }, name: this.expanded ? iconChevronUpSmall : iconChevronDownSmall, onClick: (event) => this.onExpandClick(event) })), h("div", { key: "2787b0ed7d584400662f9794b8cfba82adec5837", class: "group-header-content" }, this.header ? h("div", { class: "group-header-props-container" }, h("div", { class: "group-header-title" }, h("span", { title: this.header }, this.header)), h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader)) : null, h("slot", { key: "03e99048ceabea07f229349919c0392df581f9e1", name: "header" }))), this.hasDropdown && h("ix-group-context-menu", { key: "0ba467c1ad8b9eb4a0406ac897a6cf84635721de" }, h("slot", { key: "b4dd2adc6c70c6b521abcceee495f323564cc371", name: "dropdown" }))), h("div", { key: "1d14d7a4a6dc617088282c0af07d6c95483878c8", class: {
      "group-content": true
    } }, h("div", { key: "cbf1f34edc7dac18cc5b63ef640ad2b720c267bb", style: {
      display: this.expanded ? "contents" : "none"
    } }, h("slot", { key: "98ea6459c1c434e5afcb8c420ef124f331bf0ff3", onSlotchange: () => {
      const slot = this.hostElement.shadowRoot?.querySelector("slot:not([name])");
      this.showExpandCollapsedIcon = hasSlottedElements(slot);
    } }), h("ix-group-item", { key: "55e1c11df531834d2b48b742b8081e669672d5fd", class: {
      footer: true,
      "footer-visible": this.footerVisible
    }, groupFooter: true, suppressSelection: true }, h("slot", { key: "1c1176b3a0e054e31db9999cce99bbc7e904ab33", name: "footer", onSlotchange: () => this.onSlotChange() })))));
  }
  static get watchers() {
    return {
      "selected": [{
