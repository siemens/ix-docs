import { r as registerInstance, f as forceUpdate, h, H as Host, c as createEvent, F as Fragment, g as getElement } from "./global-CTsFSACc.js";
...
import { D as DateTime, I as Info } from "./datetime-bDicGJUN-Rk09H-45.js";
...
const DatePicker = class {
  ...
  render() {
    return h(Host, { key: "ac385bc586d47db0ce5aeb9eab3e7e71e71fe7cf" }, h("ix-date-time-card", { key: "e1d11ba64aa8b1374c6ded705afa779a9b3966b1", corners: this.corners, embedded: this.embedded }, h("div", { key: "bc99b5e074709ee8599799814a3bc7fd5ab417a5", class: "header", slot: "header" }, h("ix-icon-button", { key: "6bc172523c9588a3bb1d200d5113b2533117c021", onClick: () => this.changeToAdjacentMonth(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "e3505b87752b9d763ba61286f1091e67e2ee3314", class: "selector" }, h("ix-button", { key: "f6740c7a4ea82875e876896ab0d311e56edf2c6d", variant: "tertiary", ref: this.dropdownButtonRef, "data-testid": "year-month-button" }, h("span", { key: "90701ae7a627b41129506f9fad3523a459493e1a", class: "fontSize capitalize" }, this.monthNames[this.selectedMonth], " ", this.selectedYear)), h("ix-dropdown", { key: "0d08063a316522be267f453e3c16221cf59ac5a6", "data-testid": "year-month-dropdown", class: "dropdown", trigger: this.dropdownButtonRef.waitForCurrent(), ignoreRelatedSubmenu: true, placement: "bottom-start" }, h("div", { key: "6d91caedadb78bad8b1e65d218b63c683d635641", class: "wrapper" }, h("div", { key: "dae4910fc59d7653693f8e6db81c3a2eaf6cecf4", "data-testid": "year-container", class: "overflow", onScroll: () => this.infiniteScrollYears(), ref: this.yearContainerRef }, this.renderYears()), h("div", { key: "3d953e9c9e587526f9b82bb573781a51c17a0dfb", class: "overflow", "data-testid": "month-container" }, this.monthNames.map((month, index) => h("div", { key: month, ref: (ref) => {
      ...
      checkPosition: true
    }, name: iconSingleCheck, size: "16" }), h("div", null, h("span", { class: "capitalize monthMargin" }, `${month} ${this.tempYear}`)))))))), h("ix-icon-button", { key: "5f6380b580a26ca63f1285090a51affeaf667df3", onClick: () => this.changeToAdjacentMonth(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "4f1c314d39956676a1cf055ac8f1bffe7f6027e7", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, this.showWeekNumbers && h("div", { key: "639a77b5bb12d1266145bb06777545b8807f7675", class: "calendar-item week-day" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day" }, h("div", { class: "overflow" }, name.slice(0, 3)))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "cabe525ef68e3a519d37a9f00684acaa70de03e7", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "25e5eac3ece688f38009fa3a0f15eab6fb56f3a4", onClick: () => this.onDone() }, this.i18nDone))));
  }
  get hostElement() {
...
const LayoutGrid = class {
  ...
  render() {
    return h(Host, { key: "9ce5af84b9a377a949b94778ead107a441c51a78", class: {
      "no-margin": this.noMargin
    }, style: {
      "--ix-layout-grid-columns": `${this.columns}`,
      "--ix-layout-grid-gutter": `${this.gap}px`
    } }, h("slot", { key: "0c3a2747d12aa57a97b45ba478d495fcb0ab47a8" }));
  }
};
