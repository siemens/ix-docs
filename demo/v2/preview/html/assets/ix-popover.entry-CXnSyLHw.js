...
const Popover = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin, ComponentIdMixin) {
  ...
  render() {
    return h(Host, { key: "800528be7326703a5fca61e0a03e90b3e6231905", class: { visible: this.show }, "data-ix-popover": this.popoverPanelId }, h("dialog", { key: "a7b501ed22173801f1820b2ae1e47edd50d3a596", ref: this.dialogRef, id: this.popoverPanelId, class: "dialog", popover: "manual", inert: !this.show, ...this.inheritAriaAttributes, role: this.inheritAriaAttributes["role"] ?? "dialog", onMouseEnter: () => this.onDialogMouseEnter(), onMouseLeave: () => this.onDialogMouseLeave() }, h("div", { key: "804589dd5243897bd9965abee685fcf0608b3398", class: "popover-container" }, h("div", { key: "0607a218729bd1715ee8eccf06f83cdd1938db8e", class: "popover-body" }, h("slot", { key: "481b1891c9a092597f2b483d3e8237821769d583" })), this.hasSpike ? h("div", { class: "spike" }) : null)));
  }
  static get watchers() {
    return {
      "trigger": [{
