...
const Pane = class {
  ...
  render() {
    ...
    return h(Host, { key: "721b37ecf81c48cf26977b3e2db0f76541632096", class: {
    ...
    }, "aria-expanded": a11yBoolean(this.expanded) }, h("aside", { key: "206a7094a94dcb5156b1ed407dd7db20838352bc", id: `pane-${this.composition}`, class: {
      "top-bottom-pane": this.isBottomTopPane && !this.isMobile,
      "left-right-pane": this.isLeftRightPane && !this.isMobile,
      "mobile-pane": this.isMobile,
      expanded: this.expanded
    } }, h("div", { key: "1ecb31589789658568a199f696876aac4dfdbd96", id: "title-div", class: {
    ...
    } }, h("ix-icon-button", { key: "bfa93a835e4920d11630a71c1a0b39f92df350ab", class: "title-icon", size: "24", icon: this.expanded ? this.isMobile || this.hideOnCollapse ? iconClose : this.expandIcon : this.minimizeIcon, iconColor: this.expanded && (this.isMobile || this.hideOnCollapse) ? "color-soft-text" : void 0, variant: "subtle-tertiary", onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}`, "aria-label": paneButtonAriaLabel }), h("div", { key: "3b44fd29336d3f5c101a5d686980b2393a1f2c40", class: {
      "title-text": true,
      rotate
    } }, this.icon && h("ix-icon", { key: "d34df615df28f1ae6914c0a857735116d77502bc", class: "pane-icon", size: "24", name: this.icon, "aria-label": this.ariaLabelIcon }), h("div", { key: "4d02fb8581426e62c241a2c1e6c5540831a367be", class: "title-text-overflow" }, h("ix-typography", { key: "203fa19a4972dc9c3ed8654c8c6d176fd168437d", format: "h4" }, this.heading)), this.expanded && h("div", { key: "d0aca67aed9c641414da008290ad12371561a569", class: "slot-header" }, h("slot", { key: "0ec16f51b61c80b66eb9e1b17045888db8be7d2c", name: "header" })))), h("div", { key: "fa06f41c546340e08a249774fbe9fea9aa8513b7", class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: "7cca7b8b2c9198fbd1921ab7ff58ef2d31548f1e" }))));
  }
  get hostElement() {
