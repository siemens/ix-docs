...
const EventList = class {
  ...
  render() {
    return h(Host, { key: "f602ce959b9c53486cff76b5b255b4d6cb375d42", class: {
      "item-size-s": this.itemHeight === "S",
      "item-size-l": this.itemHeight === "L",
      compact: this.compact
    } }, h("div", { key: "c629a73a1bbf45841613d21cc2f532e24a610622", role: "list" }, h("slot", { key: "b5c88152a26d6f1c576e0e47106abdaf739e1f53" })));
  }
  static get watchers() {
    return {
      "chevron": [{
