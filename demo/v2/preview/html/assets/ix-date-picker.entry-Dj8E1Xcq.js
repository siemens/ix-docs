import { M as Mixin, a as registerInstance, c as createEvent, g as getElement, h, H as Host } from "./global-DjWMysHf.js";
...
const DatePicker = class extends Mixin(...DefaultMixins) {
  ...
  render() {
    return h(Host, { key: "24023290f0be6f05b07f49a8dd4b4250691d4786", onKeyDown: (event) => this.onKeyDown(event), onFocusin: () => {
      if (hasKeyboardMode()) {
        this.changeFocusedDay();
      }
    } }, h("ix-date-time-card", { key: "8b027dc4451810fff9a6206494fd3a3929d06c88", corners: this.corners, embedded: this.embedded }, h("div", { key: "fdcce83484f260288adb734b499b51abb30a7caa", class: "header", slot: "header" }, h("ix-icon-button", { key: "c7a6149d7ccd508a6bde054894416dbb18c6980d", onClick: () => this.changeCalendarView(-1), icon: iconChevronLeftSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelPreviousMonthButton }), h("div", { key: "0615b2bca767f539a87aef439c63a4b71ccfa5a7", class: "selector" }, h("ix-dropdown-button", { key: "30ba87301cbf3beceb9ad1276f04f4980b615ef8", focusCheckedItem: true, "aria-label": this.ariaLabelMonthSelection, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
    } }, h("ix-typography", { key: "fe2144b20ce35fafcb481373880cea356b569a43", bold: true, class: "capitalize", slot: "button-label" }, this.monthNames[this.selectedMonth]), this.renderMonths()), h("ix-dropdown-button", { key: "b1da89f7258e6e19ff82a9aea226d546d1a765c8", focusCheckedItem: true, "aria-label": this.ariaLabelYearSelection, ref: this.yearDropdownButtonRef, variant: "tertiary", label: null, onShowChanged: (event) => {
      event.stopPropagation();
      if (event.detail) {
        requestAnimationFrameNoNgZone(() => {
    ...
    } }, h("div", { key: "c691f17e0b907711728489764a4ae194bb54da2c", class: "infinite-scrolling-spacer" }, h("div", { key: "c19074e1f348c3e900d44ba71afb1f2aee5fe863", class: "sentinel", "data-sentinel": "top" })), h("ix-typography", { key: "1c5ca1280e23bf1f8375495145fb9030cbbc0973", bold: true, class: "capitalize", slot: "button-label" }, this.selectedYear), this.renderYears(), h("div", { key: "1801c9bfe5d160d44ce4c3036877ddf7c0fd504b", class: "infinite-scrolling-spacer" }, h("div", { key: "4991dac359e092b5bed9b64527d72e4981471af0", class: "sentinel", "data-sentinel": "bottom" })))), h("ix-icon-button", { key: "ad36cae3ccbd6a03cffe61e082a3dd74ee08116c", onClick: () => this.changeCalendarView(1), icon: iconChevronRightSmall, variant: "tertiary", class: "arrows", "aria-label": this.ariaLabelNextMonthButton })), h("div", { key: "2c1c1ffdb2e58307661b8a65823994a135d51823", role: "grid", class: {
      grid: true,
      "grid--show-week-numbers": this.showWeekNumbers
    } }, h("div", { key: "32d6045a99385719068593f29ff1766727290546", role: "row" }, this.showWeekNumbers && h("div", { key: "5b8842263324526d660e7f96b3da2d86f5cdb0cc", class: "calendar-item week-day", role: "columnheader" }), this.dayNames.map((name) => h("div", { key: name, class: "calendar-item week-day", role: "columnheader" }, h("div", { class: "overflow" }, name.slice(0, 3))))), this.calendar.map((week) => {
    ...
    })), h("div", { key: "194191ba4ba4d80cea105eb3b1ec5bdda9f040a7", class: {
      button: true,
      hidden: this.singleSelection || this.embedded
    } }, h("ix-button", { key: "dcfeaf1772943b610a39aadaf6282c307913e020", hidden: this.singleSelection || this.embedded, onClick: () => this.onDone() }, this.i18nDone))));
  }
