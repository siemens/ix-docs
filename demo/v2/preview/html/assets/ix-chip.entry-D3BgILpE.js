...
const Chip = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "ce26e0d24d71d552acdd962c5b277319a9ad8440", role: this.getHostRole(needsGroupRole), class: {
      inactive: this.inactive
    } }, h("div", { key: "e0d71bc62636c5d592260b8b0db1ecae4692f451", ref: this.containerElementRef, class: wrapClasses, style: customWrapStyle }, h("button", { key: "e04d0c14e50d73655c0caf406373e3d678abfa69", type: "button", class: "chip-main", ...this.inheritAriaAttributes, disabled: this.inactive, style: customMainStyle }, h("div", { key: "73704c677c0d29106d9a17ed72713d35a73fca33", class: "content-wrapper" }, this.icon && h("ix-icon", { key: "1758dc64e728902d6c2fbf82913a66afb3a103e5", class: {
      "with-icon": true
    }, name: this.icon, size: "24", "aria-label": this.ariaLabelIcon, "aria-hidden": a11yBoolean(iconIsDecorative), style: this.getIconStyle(variant) }), h("span", { key: "fa4ad21840fab8b2d3a041c08a269f0311c20392", class: "slot-container" }, h("slot", { key: "c68dfc344ea985bc18dc29f4c3face2bd0238fc7" })))), showClose && h("button", { key: "3f084d56ec7b791aa89418dfe00efe66e4c673aa", type: "button", class: "chip-close", "aria-label": this.ariaLabelCloseButton, onClick: (event) => {
      this.closeChip.emit(event);
      event.stopPropagation();
    } }, h("ix-icon", { key: "f5a87d2fbc9bfb907b746219e65ec8d4e75f645c", class: "chip-close__icon", name: iconCloseSmall, size: "16", "aria-hidden": "true" }))), this.getTooltip());
  }
  static get watchers() {
    return {
      "role": [{
