import { M as Mixin, a as registerInstance, g as getElement, h, H as Host } from "./global-DjWMysHf.js";
import { B as BaseIconButton } from "./base-icon-button-_xVULsPr-BBGsllDH.js";
...
import "./base-button-hppF0uUM-BayQ2Iat.js";
...
const IconButton = class extends Mixin(...DefaultMixins, InheritAriaAttributesMixin) {
  ...
  render() {
    ...
    return h(Host, { key: "b1ad69ccd94cf290a88db0d5f9da8c5992bba336", class: {
      ...this.getIconSizeClass(),
      disabled: this.disabled || this.loading
    }, tabIndex: this.disabled ? -1 : 0 }, h(BaseIconButton, { key: "928bd44422d72964601e7311a4faa257df34e91b", ...baseButtonProps }));
  }
...
const Spinner = class {
  ...
  render() {
    ...
    return h(Host, { key: "835ff861b90c96a284b144cd4b7df3bd19c547be", ...ariaProperties }, h("div", { key: "0fd777eaca9341e38e0e19bd73b03af5bd188eb8", class: {
